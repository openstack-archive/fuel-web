...
* Jenkins master
* Jenkins slave with enabled slave function for ISO building and BVT testing. Hiera role for this
  server should contains at least variables from example, those variables are not enabled by default.
