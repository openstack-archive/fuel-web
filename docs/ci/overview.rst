...
* Jenkins master
* Jenkins slave with enabled slave function for ISO building and deployment testing. This can be done in
  ...
  .. note:: Every slave which will be used for ISO deployment testing, like BVT, requires additional preparation.
