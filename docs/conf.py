...
project = u'Fuel-Web API'
copyright = u'2012-2015, Mirantis'
...
# [howto/manual]).
latex_documents = [
    ('index', 'fuel.tex', u'Fuel-Web API Documentation', u'Mike Scherbakov', 'manual'),
]
...
man_pages = [
    ('index', 'fuel', u'Fuel-Web API Documentation', [u'Mike Scherbakov'], 1)
]
...
texinfo_documents = [(
    'index', 'fuel', u'Fuel-Web API Documentation', u'Mike Scherbakov',
