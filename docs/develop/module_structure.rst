...
As Puppet modules developers, we tend to collaborate with Puppet Openstack
community. As a result, we contribute to upstream modules all of improvements,
...
message the upstream commit SHA or link to github pull-request
