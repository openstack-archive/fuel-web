...
Restrictions consist of *condition*, *action* and *message*::
...
Expression DSL allows to efficiently write arbitrary complex conditions which
compare fields of models and scalar values.
