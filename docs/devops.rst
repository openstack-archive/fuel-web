...
visit `fuel-devops <https://github.com/stackforge/fuel-devops/tags>`_ repo. For
Fuel 6.0 and earlier, take the latest fuel-devops 2.5.x. For Fuel 6.1 and later,
use 2.9.x or newer:
