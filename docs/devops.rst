...
Depending on the version of Fuel you use, you may need a different repository. If case of 6.0 or earlier please use *fuel-main* repository. For 6.1 and below *fuel-qa*
...
You can find information bellow which will help you to migrate from older devops, follow these steps:
...
Be default, the network pool is configured as follows:
* 10.108.0.0/16 for devops 2.5.x 
* 10.109.0.0/16 for 2.9.x. 

Please check other settings in *devops.settings*.

Before using devops in Python venv, you need install system dependencies, see :ref:`Installation` for more details.
