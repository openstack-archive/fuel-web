...
class Manager(object):
    ...
    def do_bootloader(self):
        ...
        grub = self.driver.parse_grub_settings.grub
        ...
        if grub.version == 1:
            kernel = gu.guess_kernel(chroot=chroot, kernel_regex=grub.kernel_regex)
            initrd = gu.guess_initrd(chroot=chroot, initrd_regex=grub.initrd_regex)
