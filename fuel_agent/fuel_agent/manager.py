...
class Manager(object):
    ...
    def do_partitioning(self):
        ...
        for parted in self.partition_scheme.parteds:
            # wipe out the partition labels: both GPT and MBR
            utils.execute('sgdisk', '--zap-all', parted.name,
                          check_exit_code=[0, 2])
        ...
        # here udev's rules blacklisting to be done
