...
class Manager(object):
    ...
    def do_bootloader(self):
        ...
        # The reason for this hack to appear is to prevent nailgun-agent form
        ...
        utils.makedirs_if_not_exists(os.path.join(chroot, 'var/run'))
        with open(os.path.join(chroot, 'var/run/nodiscover'), 'w'):
            pass
