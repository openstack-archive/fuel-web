...
opts = [
    cfg.StrOpt(
        'partition_data_driver',
        default='ks_spaces',
        help='Parititoning data driver'
    ),
    cfg.StrOpt(
        'get_data_driver',
        default='read_file',
        help='Get data driver'
    ),
]
...
class PartitionManager(object):
    def __init__(self):
        ...
        self.scheme = stevedore.driver.DriverManager(
            namespace='fuel_agent.drivers',
            name=CONF.partition_parse_data_driver).driver(data).parse()
