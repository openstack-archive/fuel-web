...
class TestManager(test_base.BaseTestCase):
    ...
    def test_do_partitioning(self, mock_hu_lbd, mock_pu_ml, mock_pu_mp,
        ...
        mock_pu_mp_expected_calls = [
            mock.call('/dev/sda', 1, 30, 'primary'),
            mock.call('/dev/sda', 30, 235, 'primary'),
            mock.call('/dev/sda', 235, 440, 'primary'),
            mock.call('/dev/sda', 440, 645, 'primary'),
            mock.call('/dev/sda', 645, 20088, 'primary'),
            mock.call('/dev/sda', 20088, 65690, 'primary'),
            mock.call('/dev/sda', 65690, 65715, 'primary'),
            mock.call('/dev/sdb', 1, 30, 'primary'),
            mock.call('/dev/sdb', 30, 235, 'primary'),
            mock.call('/dev/sdb', 235, 440, 'primary'),
            mock.call('/dev/sdb', 440, 65416, 'primary'),
            mock.call('/dev/sdc', 1, 30, 'primary'),
            mock.call('/dev/sdc', 30, 235, 'primary'),
            mock.call('/dev/sdc', 235, 440, 'primary'),
            mock.call('/dev/sdc', 440, 65416, 'primary')]
        ...
        mock_lu_p_expected_calls = [
            mock.call('/dev/sda5', metadatasize=32, metadatacopies=2),
            mock.call('/dev/sda6', metadatasize=32, metadatacopies=2),
            mock.call('/dev/sdb4', metadatasize=32, metadatacopies=2),
            mock.call('/dev/sdc4', metadatasize=32, metadatacopies=2)]
