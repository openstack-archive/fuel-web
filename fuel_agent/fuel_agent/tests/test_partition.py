...
def check_objects_attrs(obj_a, obj_b, attrs):
    for attr in attrs:
...
class TestMultipleDevice(unittest2.TestCase):
    ...
    def test_conversion(self):
        ...
        check_objects_attrs(new_md, self.md, (
            'name',
            'level',
            'devices',
            'spares',
...
class TestPartition(unittest2.TestCase):
    ...
    def test_conversion(self):
        ...
        check_objects_attrs(new_pt, self.pt, (
            'begin',
            'configdrive',
            'count',
            'device',
...
class TestParted(unittest2.TestCase):
    ...
    def test_conversion(self):
        ...
        serialized['partitions'] = self.prtd.partitions = []
        new_prtd = partition.Parted.from_dict(serialized)
        check_objects_attrs(new_prtd, self.prtd, (
            'label',
            'name',
            'partitions',
        ))
