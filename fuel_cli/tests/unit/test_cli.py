...
class TestHandlers(BaseTestCase):
    def test_env_print(self):
        ...
        self.assertTrue(main_help.is_return_code_zero)
        node_listing = ns.run_cli_command(command_line="node")
        self.assertTrue(node_listing.is_return_code_zero)
        node_help = ns.run_cli_command(command_line="node -h")
        self.assertTrue(node_help.is_return_code_zero)
        relsease_help = ns.run_cli_command(command_line="rel -h")
        self.assertTrue(relsease_help.is_return_code_zero)
        ...
        self.assertTrue(release_list.is_return_code_zero)
        ...
        #ns.run_cli_command(
        #    command_line="rel config --rel 2 --user Misha --pass valid")
        ...
        #ns.run_cli_command(
        #    command_line="env create --name env_name --release 1")
        ## Renaming environment with id=1 to 'New_env_name'
        #ns.run_cli_command(
        #    command_line="env set --env 1 --name New_env_name")
        ## Get information about Nodes and check their attributes,
        ## assign to envs e.t.c
        ...
        #ns.run_cli_command(
        #    command_line="node set --node 1 --role controller --env 1")
        #ns.run_cli_command(
        #    command_line="node set --node 2,3,4 "
        #                 "--role compute,cinder --env 1"
        #)
        ...
        #ns.run_cli_command(
        #    command_line="deployment default --env 1 --dir some/dir/")
        ...
        #ns.run_cli_command(
        #    command_line="deployment upload --env 1 --dir some/dir/")
        ...
        ## To Download default environment
        ...
        ## --json output modifier, all most any request will
        ## return json of the request to stdout
        #ns.run_cli_command(command_line="env --env 1 --json")
        ## with --debug all HTTP request to Nailgun server
