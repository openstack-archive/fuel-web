...
from fuel_package_updates.repo_utils import repo_merge
from fuel_package_updates.utils import json_parse
...
class NailgunClient(object):
    ...
    def update_cluster_attributes(self, cluster_id, attrs):
        return self.client.put(
            "/api/clusters/{0}/attributes/".format(cluster_id), attrs)
