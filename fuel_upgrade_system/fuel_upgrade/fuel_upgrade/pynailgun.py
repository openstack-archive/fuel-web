...
from fuel_upgrade.errors import CannotAddInfoToNailgun
from fuel_upgrade.utils import post_request, delete_request
...
class PyNailgun(object):
    ...
    def create_release(self, release):
        ...
        response, status_code = post_request(resource_url, release)

        # if not created
        if status_code != 201:
            raise CannotAddInfoToNailgun(response)
    ...
    def remove_release(self, release_id):
        ...
        response, status_code = delete_request(resource_url)
        return response
    ...
    def create_notification(self, notification):
        ...
        response, status_code = post_request(resource_url, notification)
