...
class TestBaseChecker(BaseTestCase):
    ...
    def make_get_request(
        ...
        result = self.base_checker.save_get(url, auth=auth)

        return result

    @mock.patch('fuel_upgrade.checker.requests.get')
    def test_save_get_request_succeed(self, requests_get):
    ...
    @mock.patch('fuel_upgrade.checker.requests.get')
    def test_save_get_connection_error(self, requests_get):
    ...
    @mock.patch('fuel_upgrade.checker.requests.get')
    def test_save_get_timeout_error(self, requests_get):
    ...
    @mock.patch('fuel_upgrade.checker.requests.get')
    def test_save_get_non_json_response(self, requests_get):
        result = mock.MagicMock()
...
class TestCheckers(BaseTestCase):
    ...
    @mock.patch('fuel_upgrade.checker.BaseChecker.save_get')
