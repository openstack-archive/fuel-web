...
"""
        self.flag_func_map = (
            ("set", attrcheck(all)("node", "role", "env"), self.set),
            ("delete", attrcheck(any)("node", "env"), self.delete),
            (
                attrcheck(any)("network", "disk"),
                (
                    attrcheck(any)("node"),
                    attrcheck(any)("default", "download", "upload")
                ),
                self.attributes
            ),
            (
                attrcheck(any)("deploy", "provision"),
                attrcheck(all)("env", "node"),
                self.start
            ),
            (None, None, self.list)
        )
    ...
    def start(self, params):
        ...
        task = Environment(env_ids.pop()).install_selected_nodes(
