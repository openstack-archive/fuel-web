...
class EnvShow(lister.Lister):
    ...
    def take_action(self, parsed_args):
        data = objects.Environment(obj_id=parsed_args.id).data
        data = [data]  # to make data processing consistent
        data = utils.get_display_data(self.columns_names, data)
...
class EnvCreate(lister.Lister):
    ...
    def take_action(self, parsed_args):
        ...
        data = objects.Environment.create(data_to_send).data
        data = [data]
        data = utils.get_display_data(self.columns_names, data)
...
class EnvDelete(command.Command):
    ...
    def take_action(self, parsed_args):
        env = objects.Environment(obj_id=parsed_args.id)
        env.delete()
...
class EnvUpdate(lister.Lister):
    ...
    def take_action(self, parsed_args):
        ...
        data = utils.update_entity_attributes(env, self.attributes_to_update,
...
class EnvUpgrade(command.Command):
    ...
    def take_action(self, parsed_args):
        ...
        attributes_to_filter = parsed_args.__dict__
        utils.update_entity_attributes(env, self.attributes_to_update,
                                       attributes_to_filter)
