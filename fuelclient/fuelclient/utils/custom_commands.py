...
class HelpCommand(command.Command):
    """Custom cliff commands which print detailed help for
    any application subcommand either cliff implemented or
    old versioned. For later old versioned main parser is used.

    This class supposed to be removed when all commands will be
    moved to cliff codebase.
    """
