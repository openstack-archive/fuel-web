...
class TestHandlers(BaseTestCase):
    ...
    def test_env_action(self):
        ...
        h_msg = "usage: fuel [global optional args] " \
...
"""
        self.assertEqual(env_help.stdout, h_msg)
        #no clusters
        ...
        create_env_msg = "Environment 'TestEnv' with id=1, mode=multinode " \
                         "and network-mode=nova_network was created!\n"
