...
class TestEnvCreate(_EnvironmentTestMixin, unittest.TestCase):
...
class TestEnvDelete(_EnvironmentTestMixin, unittest.TestCase):
    cmd_args = ['1']
...
class TestEnvShow(_EnvironmentTestMixin, unittest.TestCase):
    cmd_args = ['1']
...
class TestEnvList(_EnvironmentTestMixin, unittest.TestCase):
    request_to_mock = 'get_request'
    return_data = [
...
class TestEnvUpdate(_EnvironmentTestMixin, unittest.TestCase):
...
class TestEnvUpgrade(_EnvironmentTestMixin, unittest.TestCase):
    cmd_args = ['1', '2']
    request_to_mock = 'put_request'
    return_value = {'id': 1}
