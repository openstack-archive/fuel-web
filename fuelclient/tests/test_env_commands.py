...
class TestEnvCreate(tests.BaseTestCommand):
    ...
    command_class = environment_command.EnvCreate
...
class TestEnvDelete(tests.BaseTestCommand):
    ...
    command_class = environment_command.EnvDelete
...
class TestEnvShow(tests.BaseTestCommand):
    ...
    command_class = environment_command.EnvShow
...
class TestEnvList(tests.BaseTestCommand):
    ...
    command_class = environment_command.EnvList
...
class TestEnvUpdate(tests.BaseTestCommand):
    ...
    command_class = environment_command.EnvUpdate
...
class TestEnvUpgrade(tests.BaseTestCommand):
    ...
    command_class = environment_command.EnvUpgrade
