...
def get_fake_node(cluster=None, hostname=None, node_id=None, cpu_model=None,
    ...
    """
    host_name = hostname or tests.utils.random_string(10, prefix='fake-node-')

    return {"name": node_name or "cmpt1",
            "error_type": None,
