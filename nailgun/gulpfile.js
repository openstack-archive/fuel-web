...
var rjsConfig = _.merge(rjs('static/config.js'), {
    ...
    paths: {
        react: 'libs/bower/react/react-with-addons.min'
    },
    stubModules: ['jsx'],
    modules: [
        {
...
var buildResultFilter = filter([
    ...
    'libs/bower/requirejs/require.js.map',
    'css/styles.css',
    'favicon.ico',
    'img/**',
...
gulp.task('bower:copy-main', function() {
    var bowerDir = 'static/libs/bower/';
...
var jsFiles = ['static/**/*.js', 'static/**/*.jsx', '!static/libs/**', '!static/expression/parser.js'];
