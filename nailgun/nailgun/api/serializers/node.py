...
class NodeInterfacesSerializer(BasicSerializer):
    ...
    def serialize_nic_interface(cls, instance, fields=None):
        ...
        if instance.bond:
            data_dict['bond'] = {'id': instance.bond.id,
                                 'name': instance.bond.name}
        return data_dict
