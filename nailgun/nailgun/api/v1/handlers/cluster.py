...
from nailgun.api.v1.validators.cluster import ClusterDeploymentGraphValidator
...
class ClusterDeploymentGraphHandler(SingleHandler):
    """Cluster Handler for deployment graph serialization
    """

    single = objects.Cluster
    validator = ClusterDeploymentGraphValidator

    @content_json
    def GET(self, obj_id):
        """Read cluster deployment graph configuration
