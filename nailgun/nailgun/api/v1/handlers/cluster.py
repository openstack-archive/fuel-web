        ...
        if cluster.is_locked:
            ...
            for attr_name, attr_request in six.iteritems(editable_request):
                ...
                if PluginManager.is_plugin_data(attr_cluster):
                    if attr_request['metadata']['enabled']:
                        always_editable = False
                        chosen_id = attr_request['metadata']['chosen_id']
                        for plugin in attr_cluster['metadata']['versions']:
                    ...
                    always_editable = attr_cluster.get('metadata', {})\
                        .get('always_editable', False)
