...
from nailgun.api.v1.handlers.tag import NodeTagUnassignmentHandler
...
urls = (
    ...
    r'/nodes/(?P<node_id>\d+)/tags/assign/?$',
    NodeTagAssignmentHandler,
    r'/nodes/(?P<node_id>\d+)/tags/unassign/?$',
    NodeTagUnassignmentHandler,
    r'/tags/?$',
