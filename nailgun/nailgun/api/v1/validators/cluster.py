...
class VmwareAttributesValidator(BasicValidator):
    ...
    def _validate_nova_computes(cls, instance, input_nova_computes):
        ...
        for nova_compute_data in input_nova_computes:
            for attr, values_set in nova_compute_attributes_sets.items():
        ...
        for node in compute_vmware_nodes:
            ...
            if not (node.pending_deletion or node.pending_addition):
                ...
                for attr, db_value in db_nova_compute.items():
    ...
    def validate(cls, data, instance):
        ...
        # TODO(ekosareva): validate editable value settings of deployed
        #                  cluster: shouldn't be changed for deployed cluster
