...
class ClusterValidator(BasicValidator):
    ...
    def validate_update(cls, data, instance):
        ...
        if 'nodes' in d:
            cls._validate_nodes(d, instance)
    ...
    @classmethod
    def _validate_nodes(cls, data, instance):
        new_nodes = set(data.get("nodes"))
        set_old_node_ids = set([n.id for n in instance.nodes])
        nodes_to_add = new_nodes - set_old_node_ids
        nodes_to_remove = set_old_node_ids - new_nodes
        duplicated = []
        ...
        if duplicated:
            raise errors.InvalidData(
                ...
                .format(",".join(duplicated), str(instance.id))
            )
