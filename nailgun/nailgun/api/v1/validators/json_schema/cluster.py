...
# Schema with a structure of file setting value
file_value_schema = {
    'type': ['string', 'object'],
    'properties': {
...
attribute_type_schemas = {
    ...
    'text_list': multiple_text_value_schema,
    'password_list': multiple_text_value_schema,
    'textarea_list': multiple_text_value_schema,
    'file': {'value': file_value_schema},
    'file_list': {
        'value': {
            'type': 'array',
            'minItems': 1,
            'items': [file_value_schema],
        },
    },
}
