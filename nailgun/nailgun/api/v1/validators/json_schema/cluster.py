...
# Schema with a structure of multiple fields setting value
multiple_value_schema = {
    'value': {
        'type': 'array',
        'minItems': 1,
        'items': [{'type': 'string'}],
...
attribute_type_schemas = {
    ...
    'text_list': multiple_value_schema,
    'password_list': multiple_value_schema,
    'textarea_list': multiple_value_schema,
    'file_list': multiple_value_schema,
}
