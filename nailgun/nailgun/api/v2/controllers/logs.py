...
from nailgun.api.v2.handlers.base import BaseController
...
class LogSourceByNodeCollectionController(BaseController):
...
class LogSourceCollectionController(BaseController):
    """Log source collection handler
    """

    nodes = LogSourceByNodeCollectionController()
...
class LogEntryCollectionController(BaseController):
    """Log entry collection handler
    """

    package = LogPackageController()
    sources = LogSourceCollectionController()
