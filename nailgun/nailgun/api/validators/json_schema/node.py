...
node_format_schema = {
    ...
    'properties': {
        ...
        # Unfortunately, this field sometimes received as `null`, so we have to
        # either fix our discovery agent or to comment the string below.
