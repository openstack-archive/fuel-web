...
Revision ID: 229423d4f2a6
Revises: None
Create Date: 2014-04-28 19:08:13.390831

"""

# revision identifiers, used by Alembic.
revision = '229423d4f2a6'
down_revision = None
...
def upgrade():
    ...
    op.create_table('nova_network_config',
                    ...
                    sa.Column(
                        ...
                        nullable=True),
                    sa.Column(
                        'fixed_network_size', sa.Integer(),
                        nullable=False),
                    sa.Column(
                        'fixed_networks_amount', sa.Integer(),
                        nullable=False),
    ...
    op.create_table('neutron_config',
                    ...
                    sa.Column(
                        'internal_cidr', sa.String(length=25),
                        nullable=True),
                    sa.Column(
