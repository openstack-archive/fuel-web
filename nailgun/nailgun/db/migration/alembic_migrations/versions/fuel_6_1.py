...
_limits_to_update = {
        ...
        'overrides': [
            {
                ...
                'max': 1,
                'message': ("Multi-node environment can not have more than "
                    "one controller node.")
            },
            {
                'condition': "cluster:mode == 'ha_compact'",
                'recommended': 3,
                'message': ("At least 3 controller nodes are recommended for "
                    "HA deployment.")
            }
        ]
    },
        ...
        'overrides': [
            {
                ...
                'recommended': 1,
                'message': ("At least 1 Cinder node is recommended when "
    ...
    'mongo': {
        'overrides': [
            {
                'condition': ("cluster:mode != 'ha_compact' and "
                    "settings:additional_components.mongo.value == false"),
                'max': 1,
                'message': ("At most 1 MongoDB node can be added for non-HA "
                    "deployment")
            },
            {
                'condition': ("cluster:mode == 'ha_compact' and "
                    "settings:additional_components.mongo.value == false"),
                'recommended': 3,
                'message': ("At least 3 MongoDB nodes are recommended for HA "
                    "deployment.")
            },
            {
                'condition': ("settings:additional_components.ceilometer.value == "
                    "true and settings:additional_components.mongo.value == "
                    "false"),
                'min': 1,
                'message': ("When Ceilometer is enabled, the environment should "
                    "have Telemetry - MongoDB node or external MongoDB should be "
                    "chosen")
            }
        ]
    },
    ...
    'compute': [
        {
            ...
            'message': ("Computes cannot be added to environment with "
                "vCenter hypervisor")
        }
    ],
    'cinder': [
        {
            'condition': ("settings:storage.volumes_lvm.value == false and "
    ...
    'mongo': [
        {
            ...
            'message': ("MongoDB node can not be added to an operational "
                "environment.")
        },
        {
            'condition': ("settings:additional_components.ceilometer.value == "
