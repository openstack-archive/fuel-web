...
class MutableDict(MutableDictBase):
    # TODO: delete this class after methods pop and popitem
    ...
    def pop(self, *args):
        ...
        :return: element or raises KeyError if dict is empty or
        element with specified 'key' not found.
        """
    ...
    def popitem(self):
        ...
        :return: (key, value) or raises KeyError if dict is empty.
        """
