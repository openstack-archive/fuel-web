...
class Node(Base):
    ...
    roles = Column(JSON, default=[], server_default='[]', nullable=False)
    pending_roles = Column(JSON, default=[], server_default='[]',
                           nullable=False)
    primary_roles = Column(JSON, default=[], server_default='[]',
                           nullable=False)
