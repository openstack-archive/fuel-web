...
from nailgun.extensions.bareon_notifier.adapters import BareonAPIAdapter


class BareonNotifierExtension(BaseExtension):
    name = 'bareon_notifier'
    version = '1.0.0'
    ...
    @classmethod
    def on_node_collections_delete(cls, node_ids):
