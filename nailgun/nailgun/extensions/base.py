    ...
    def __new__(mcls, name, bases, namespace):
        ...
        for base in bases:
            for name in dir(base):
                ...
                # if method from base class has attribute '__deprectated__' and
                # method from current class does not have, that means method was
                # overridden in current class and it needs to inform user that method was removed
                if (
