...
class ClusterCloneIPsHandler(base.BaseHandler):
    ...
    def POST(self, cluster_id):
        ...
        Set IPs to new controllers for all networks except admin, public,
        private according controllers IPs from original cluster.
        ...
        upgrade.UpgradeHelper.clone_ips(cluster_id, seed_cluster_id)
