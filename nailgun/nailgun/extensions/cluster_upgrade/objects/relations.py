...
class UpgradeRelationObject(object):
    ...
    @classmethod
    def delete_relation(cls, cluster):
        cls._query_cluster_relations(cluster).delete()

    @classmethod
    def is_cluster_in_upgrade(cls, cluster):
        relation = cls._query_cluster_relations(cluster).first()
        return bool(relation)

    @classmethod
    def create_relation(cls, orig_cluster, seed_cluster):
