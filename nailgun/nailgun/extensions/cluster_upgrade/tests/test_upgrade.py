...
class TestUpgradeHelperCloneCluster(base_tests.BaseCloneClusterTest):
    ...
    def test_move_vips_after_node_reassignment(self):
        new_cluster = self.helper.create_cluster_clone(self.cluster_61,
                                                       self.data)
        ...
        self.orig_net_manager.update(nets)
        self.orig_net_manager.assign_vips_for_net_groups()
        ...
        orig_env_version = self.cluster_61.release.environment_version
        self.helper.move_vips(self.orig_net_manager,
                              new_cluster.get_network_manager(),
                              orig_env_version)
