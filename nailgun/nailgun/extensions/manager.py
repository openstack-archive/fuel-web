...
def get_all_extensions(**manager_kwargs):
    """Retrieves all available extensions for Nailgun

    :param manager_kwargs: might be used for additional options for stevedore
    ...
    if _EXTENSION_MANAGER is None:
        _EXTENSION_MANAGER = ExtensionManager(
            namespace=consts.EXTENSIONS_NAMESPACE, manager_kwargs)
