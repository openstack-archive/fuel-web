...
class NIC(DPDKMixin, NailgunObject):
    ...
    def dpdk_available(cls, instance, dpdk_drivers):
        ...
        return (cls.get_dpdk_driver(instance, dpdk_drivers) is not None and
                cls.dpdk_supported_for_segmentation(instance.node.cluster))

    @staticmethod
    def dpdk_supported_for_segmentation(cluster):
        return (cluster.network_config.segmentation_type in
