...
def get_node_spaces(node):
    ...
    """
    # TODO(apopovych): ugly hack to avoid circular dependency
    from nailgun import objects

    node_spaces = []
    volumes = objects.Cluster.get_volumes_metadata(node.cluster)
    role_mapping = volumes['role_mapping']
    all_spaces = volumes['volumes_info']
    # TODO(dshulyak)
