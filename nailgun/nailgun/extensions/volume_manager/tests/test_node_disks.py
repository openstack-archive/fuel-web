...
class TestVolumeManager(BaseIntegrationTest):
    ...
    def test_allocates_all_free_space_for_os_for_controller_role(self):
        ...
        home_sum_size = self.home_size(disks)
        audit_sum_size = self.audit_size(disks)
        var_sum_size = self.var_size(disks)
        tmp_sum_size = self.tmp_size(disks)
        ...
        self.assertEqual(disks_size_sum - reserved_size,
                         ...
                         horizon_sum_size + home_sum_size +
                         audit_sum_size + var_sum_size + 
                         tmp_sum_size)
