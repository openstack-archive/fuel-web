...
class Context(object):
    ...
    def get_yaql_interpreter(self, node_id):
        ...
        def evaluate(expression):
            ...
            return parsed_exp.evaluate(
                data=context['$new'], context=context
            )
        return evaluate
    ...
    def get_legacy_interpreter(self, node_id):
        ...
        def evaluate(condition):
            return Expression(condition, context).evaluate()
        return evaluate
...
class DefaultTaskSerializer(NoopTaskSerializer):
    ...
    def should_execute(self, node_id):
        ...
        return interpreter(
            self.transform_legacy_condition(self.task_template['condition'])
        )
