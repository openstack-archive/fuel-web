...
def _initialize_factory(serializers_factory, context):
    globals()['factory'] = serializers_factory(context)
...
def _serialize_task_for_node_in_worker(node_and_task):
    return _serialize_task_for_node(globals()['factory'], node_and_task)
...
class MultiProcessingConcurrencyPolicy(object):
    ...
    def execute(self, context, serializers_factory, tasks):
        ...
        pool = multiprocessing.Pool(
            ...
            initializer=_initialize_factory,
            initargs=(serializers_factory, context)
        )
        return pool.imap_unordered(_serialize_task_for_node_in_worker, tasks)
