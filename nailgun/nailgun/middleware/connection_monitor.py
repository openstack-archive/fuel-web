...
class ConnectionMonitorMiddleware(object):
    ...
    def __call__(self, env, start_response):
        if env['REQUEST_METHOD'] in self.methods_to_analize:
            ...
            if url_matcher:
                ...
                create_kwargs['action_type'] = 'http_request'
                ...
                create_kwargs['cluster_id'] = self.cluster_id
    ...
    def _get_additional_info(self, env, request_body, response_to_analyse):
        additional_info = {
            'request_data': self.__get_request_data(env, request_body),
            'response_data': self.__get_response_data(response_to_analyse)
        }
        return additional_info

    def __get_request_data(self, env, request_body):
        request_data = {
