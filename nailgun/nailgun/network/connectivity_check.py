...
def check_received_data(cached, received):
    ...
    def built_vlan_ifaces_mapping(networks):
    ...
    cached_vlans = built_vlan_ifaces_mapping(cached['networks'])
    received_vlans = built_vlan_ifaces_mapping(received.get('networks', []))
