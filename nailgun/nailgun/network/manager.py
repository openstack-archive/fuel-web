...
class NetworkManager(object):
    ...
    def get_assigned_vip(cls, nodegroup, network_name,
        ...
        """Vip with type which is in network with specified name and nodegroup

        If no vip matches the criteria, the method returns None.
        If there is no network which matches the criteria,
        raise CanNotFindNetworkForNodeGroup
        (handled by get_network_by_name_and_nodegroup).
        """
