...
class NetworkManager(object):
    ...
    def assign_admin_ips(cls, nodes):
        ...
        for node in nodes:
            node_id = node.id
            admin_net = objects.NetworkGroup.get_admin_network_group(node=node)
    ...
    def _remap_admin_network(cls, node):
        ...
        iface_pxe.assigned_networks_list.append(
            objects.NetworkGroup.get_admin_network_group(node=node))
    ...
    def get_admin_ip_for_node(cls, node_id, node=None):
        ...
        return objects.Node.get_admin_ip(node_id, node=node)
    ...
    def get_default_gateway(cls, node_id):
        ...
        """
        net = objects.NetworkGroup.get_admin_network_group(node_id=node_id)
