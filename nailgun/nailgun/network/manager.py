...
class NetworkManager(object):
    ...
    def _update_attrs(cls, node_data):
        ...
        for iface in interfaces:
            ...
            if 'interface_properties' in iface:
                current_iface.interface_properties = dict_merge(
    ...
    def __set_interface_attributes(cls, interface, interface_attrs,
        ...
        if update_by_agent and 'sriov' in interface_attrs:
            interface.interface_properties['sriov'] = dict_merge(
                interface.interface_properties['sriov'],
                interface_attrs['sriov']
            )
