...
class NetworkManager(object):
    ...
    def _update_attrs(cls, node_data):
        ...
        for iface in interfaces:
            ...
            if 'offload_modes' in iface:
                current_iface.offload_modes = \
                    iface['offload_modes']
    ...
    def __set_interface_attributes(cls, interface, interface_attrs, update_by_agent=False):
        ...
        old_modes_states = interface.offload_modes_as_flat_dict(interface.offload_modes)
    ...
    def get_iface_properties(cls, iface):
        ...
        if iface.offload_modes:
            modified_offload_modes = \
                cls._get_modified_offload_modes(iface.offload_modes)
