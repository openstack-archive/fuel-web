...
class NetworkManager(object):
    ...
    @classmethod
    def _get_admin_node_network(cls, node, admin_net=None):
        net = objects.NetworkGroup.get_admin_network_group(node, admin_net)
    ...
    @classmethod
    def get_node_networks(cls, node, admin_net=None):
        ...
        network_data.append(cls._get_admin_node_network(node, admin_net))
    ...
    @classmethod
    def is_ip_belongs_to_admin_subnet(cls, ip_addr, node=None, admin_net=None):
        ng = objects.NetworkGroup.get_admin_network_group(node, admin_net)
    ...
    def get_admin_ip_for_node(cls, node=None, admin_net=None):
        ...
        return objects.Node.get_admin_ip(node,
            admin_net.id if admin_net else None)
