...
class NeutronManager70(AllocateVIPs70Mixin, NeutronManager):
    ...
    def get_interfaces_from_template(cls, node):
        """Parses transformations for all node role templates and
        creates a list of bare interfaces and bonds.
        """
        transformations = \
    ...
    def assign_networks_by_template(cls, node):
        """Configures a node's network-to-nic mapping based on its
        template.
