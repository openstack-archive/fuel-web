...
class Cluster(NailgunObject):
    ...
    @classmethod
    def get_all_node_roles(cls, instance):
    ...
    @classmethod
    def get_enabled_node_roles(cls, instance):
        roles = []
        for node in instance.nodes:
    ...
    def set_primary_role(cls, instance, nodes, role_name):
        ...
        """
        if role_name not in cls.get_all_node_roles(instance):
            logger.warning(
    ...
    def set_primary_roles(cls, instance, nodes):
        ...
        if not instance.is_ha_mode:
            return
        roles_metadata = cls.get_all_node_roles(instance)
