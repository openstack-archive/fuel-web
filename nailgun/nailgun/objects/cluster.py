...
class Cluster(NailgunObject):
    ...
    def get_default_group(cls, instance):
        return next(g for g in instance.node_groups if g.name == consts.NODE_GROUPS.default)
    ...
    @classmethod
    def get_network_roles(cls, instance, merge_policy=NetworkRoleMergePolicy()):
