...
class Cluster(NailgunObject):
    ...
    @classmethod
    def _get_nodes_by_role(cls, instance, role_name):
        return db().query(models.Node).filter_by(
            cluster_id=instance.id
        ).filter(sa.or_(
    ...
    def get_nodes_by_role(cls, instance, role_name):
        ...
        return cls._get_nodes_by_role(instance, role_name).all()

    @classmethod
    def get_node_by_role(cls, instance, role_name):
        return cls._get_nodes_by_role(instance, role_name).first()
