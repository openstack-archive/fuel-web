...
class Cluster(NailgunObject):
    ...
    @classmethod
    def get_deployment_graph(self, instance):
        ...
        elif instance.deployment_graph:
            return instance.deployment_graph
        else:
            return Release.get_deployment_graph(instance.release)
