...
class Cluster(NailgunObject):
    ...
    @classmethod
    def get_attributes(cls, instance, plugin_versions=False):
        """Get attributes for current Cluster instance.

        :param instance: Cluster instance
        :param plugin_versions: Get attributes of all versions of plugin
        :returns: dict
        """
        try:
        ...
        plugin_attrs = PluginManager.get_plugins_attributes(
            instance, all_versions=plugin_versions)
    ...
    @classmethod
    def get_editable_attributes(cls, instance, plugin_versions=False):
        ...
        :return: dict
        """
        return cls.get_attributes(instance, plugin_versions)['editable']
