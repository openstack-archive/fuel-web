...
class DeploymentHistoryCollection(NailgunCollection):
    ...
    def get_history(cls, transaction, nodes_ids=None, statuses=None,
        ...
        for history_record in cls.filter_by(None, task_id=transaction.id):
            ...
            if nodes_ids and history_record.node_id not in nodes_ids:
                continue
            ...
            record.pop('deployment_graph_task_name')
