...
class Node(NailgunObject):
    ...
    @classmethod
    def _check_discover(cls, instance, data):
    ...
    @classmethod
    def _update_ip(cls, instance, data):
    ...
    @classmethod
    def _update_disk_meta(cls, instance, data):
        meta = data.get('meta', {})
    ...
    def update_by_agent(cls, instance, data):
        ...
        * don't update volume information if disks arrays is empty
        ...
        """
        # don't update provisioning and error back to discover
        cls._check_discover(instance, data)
        cls._update_disk_meta(instance, data)
        cls._update_ip(instance, data)
