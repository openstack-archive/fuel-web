...
class Node(NailgunObject):
    ...
    def update(cls, instance, data):
        ...
        * creating default Node attributes (see :func:`create_attributes`)
        ...
        if "cluster_id" in data:
            ...
            if instance.cluster_id:
                ...
                if new_cluster_id is not None:
                    ...
                    cluster_changed = True
                    add_to_cluster = True
                    cls.assign_to_cluster(instance, new_cluster_id)
        ...
        if "group_id" in data:
            ...
            add_to_cluster = True
            cls.assign_to_cluster(instance, instance.cluster_id)
    ...
    @classmethod
    def assign_to_cluster(cls, instance, cluster_id):
    ...
    def add_into_cluster(cls, instance, cluster_id):
        ...
        if instance.cluster_id != cluster_id:
            cls.assign_to_cluster(instance, cluster_id)
        cls.assign_group(instance)
        network_manager = Cluster.get_network_manager(instance.cluster)
