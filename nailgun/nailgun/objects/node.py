...
class Node(NailgunObject):
    ...
    def should_have_public_with_ip(cls, instance):
        ...
        return bool(TagCollection.should_have_public_with_ip(instance))
    ...
    def should_have_public(cls, instance):
        ...
        if dvr_enabled:
            return bool(TagCollection.should_have_public_for_dvr(instance))
    ...
    def update_tags(cls, instance, new_roles):
        ...
        q_new_role_tags = TagCollection.get_cluster_nm_tags(
            instance.cluster
