...
from nailgun.objects import NailgunCollection, DeploymentGraph
...
class Plugin(NailgunObject):
    ...
    def create(cls, data):
        ...
        accidental_deployemnt_tasks = data.pop('deployment_tasks', None)
        new_plugin = super(Plugin, cls).create(data)
        if accidental_deployemnt_tasks is not None:
            deployment_graph = DeploymentGraph.create(
                accidental_deployemnt_tasks)
