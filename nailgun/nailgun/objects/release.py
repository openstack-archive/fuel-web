...
class Release(NailgunObject):
    ...
    def create(cls, data):
        ...
        if data.get("attributes_metadata", None) is None:
            data["attributes_metadata"] = {"editable": {}}

        if data.get("networks_metadata", None) is None:
            data["networks_metadata"] = {}

        if data["networks_metadata"].get("neutron", None) is None:
            data["networks_metadata"]["neutron"] = {}

        if data["networks_metadata"]["neutron"].get("networks", None) is None:
            data["networks_metadata"]["neutron"]["networks"] = [
                {
                    "name": "public",
                    "cidr": "172.16.0.0/24",
                    "ip_range": [
        ...
        if data["networks_metadata"]["neutron"].get("config", None) is None:
            data["networks_metadata"]["neutron"]["config"] = {
                "vlan_range": [
                    1000,
                    1030
                ],
