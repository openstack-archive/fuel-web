...
from nailgun.objects import Cluster, Node
...
class Task(NailgunObject):
    ...
    @classmethod
    def update_verify_networks(cls, task, status,
                               progress, msg, result):
    ...
    @classmethod
    def __updates_nodes_to_error(cls, q_nodes_to_error, error_type):
    ...
    def _update_cluster_data(cls, instance):
        ...
        if instance.name == 'deploy':
            ...
            cls.__updates_nodes_to_error(q_nodes_to_error,
                                         error_type='deploy')
