...
class DeploymentMultinodeSerializer(object):
    ...
    def get_common_attrs(self, cluster):
        ...
        self.inject_list_of_plugins(attrs, cluster.id)
    ...
    def inject_list_of_plugins(self, attributes, cluster_id):
        plugins = objects.ClusterPlugins.get_enabled(cluster_id)
