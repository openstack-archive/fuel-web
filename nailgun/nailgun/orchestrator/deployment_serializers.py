...
def set_node_name(data, node):
    """Helper which sets node name for provided dictionary

    :param dict data: dictionary with attributes
    :param node: node model
    """
    data['user_node_name'] = node.name
    return data
...
class DeploymentMultinodeSerializer61(DeploymentMultinodeSerializer):
    ...
    def serialize_node(self, node, role):
        ...
        set_node_name(serialized_node, node)
