            ...
            for config_dest in node_configs[node_id]:
                yield templates.make_upload_task(
                    ...
                    path=os.path.join(consts.OVERRIDE_CONFIG_BASE_PATH,
                                      config_dest),
                    data=node_configs[node_id][config_dest])
