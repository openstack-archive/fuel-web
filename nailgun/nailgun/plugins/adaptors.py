...
class PluginAdaptorBase(object):
...
class PluginAdaptorV1(PluginAdaptorBase):
...
class PluginAdaptorV2(PluginAdaptorBase):
...
class PluginAdaptorV3(PluginAdaptorV2):
    ...
    def sync_metadata_to_db(self):
        super(PluginAdaptorV3, self).sync_metadata_to_db()
