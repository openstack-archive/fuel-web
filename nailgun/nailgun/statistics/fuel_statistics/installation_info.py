...
class InstallationInfo(object):
    ...
    attributes_white_list = (
        ...
        WhiteListRule(('repo_setup', 'repos',
                       'debian_trusty_openstack_release', 'value'),
                      'debian_trusty_openstack_release', None),
        WhiteListRule(('repo_setup', 'repos', 'debian_trusty_repo_url',
                       'value'), 'debian_trusty_repo_url', None),
