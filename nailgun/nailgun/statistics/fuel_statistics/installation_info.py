...
class InstallationInfo(object):
    ...
    plugin_info_white_list = (
        ...
        WhiteListRule(('attributes_metadata',), 'attributes_metadata', dict),
        WhiteListRule(('volumes_metadata',), 'volumes_metadata', None),
        WhiteListRule(('roles_metadata',), 'roles_metadata', dict),
        WhiteListRule(('network_roles_metadata',),
                      'network_roles_metadata', list),
        WhiteListRule(('components_metadata',), 'components_metadata', list),
        WhiteListRule(('deployment_tasks',), 'deployment_tasks', list),
        WhiteListRule(('tasks',), 'tasks', list),
    )
