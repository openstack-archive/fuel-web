...
from nailgun.objects import ClusterCollection, NodeCollection
...
class InstallationInfo(object):
    ...
    def get_installation_info(self):
        ...
        unallocated_nodes_num = NodeCollection.filter_by(None, cluster_id=None).count()
    ...
    def get_aid(self):
        #TODO: aid should be fetched from MasterNode settigns
