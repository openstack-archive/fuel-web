...
def prepare_logger_for_resource(logger, resource_type):
    log_file = os.path.join(settings.STATS_LOGS_PATH,
                            "oswl_" + resource_type + "_collectord" + ".log")
    utils.prepare_logger(log_file)
...
def run():
    ...
    prepare_logger_for_resource(logger, resource_type)
