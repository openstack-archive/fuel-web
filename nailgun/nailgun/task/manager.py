...
class ResetEnvironmentTaskManager(TaskManager):
    ...
    def execute(self):
        ...
        if self.cluster.attributes.generated['deployed_before']['value']:
            ...
            generated_attrs = copy.deepcopy(self.cluster.attributes.generated)
            generated_attrs['deployed_before']['value'] = False
            self.cluster.attributes.generated = generated_attrs
