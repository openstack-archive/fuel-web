...
class CreateStatsUserTaskManager(BaseStatsUserTaskManager):
    ...
    def __init__(self, *args, **kwargs):
        super(CreateStatsUserTaskManager, self).__init__(*args, **kwargs)
        self.task_name = consts.TASK_NAMES.create_stats_user
        self.task_cls = tasks.CreateStatsUserTask


class RemoveStatsUserTaskManager(BaseStatsUserTaskManager):

    def __init__(self, *args, **kwargs):
        super(RemoveStatsUserTaskManager, self).__init__(*args, **kwargs)
        self.task_name = consts.TASK_NAMES.remove_stats_user
        self.task_cls = tasks.RemoveStatsUserTask
