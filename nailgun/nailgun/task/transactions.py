...
class transaction_section(object):
    def __init__(self, transaction, supress_exception=False):
...
class TransactionsManager(object):
    ...
    def _execute_async_safe(self, transaction_id, **kwargs):
        ...
        with transaction_section(transaction, supress_exception=True):
    ...
    def _execute_async(self, transaction, node_ids, graph_names, **kwargs):
        ...
        for graph_type, tasks in tasks_per_graph.items():
            ...
            with transaction_section(sub_transaction):
    ...
    @classmethod
    def _get_tasks(cls, cluster, role_resolver, names, graph_type):
