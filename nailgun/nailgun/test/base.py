...
class Environment(object):
    ...
    def _networks_get(self, method, cluster_id, expect_errors=False):
        return self.app.get(
            reverse(method,
    ...
    def _networks_put(self, method, cluster_id, networks, expect_errors=False):
        return self.app.put(
            reverse(method,
                    kwargs={'cluster_id': cluster_id}),
            json.dumps(networks),
    ...
    def nova_networks_get(self, cluster_id, expect_errors=False):
        return self._networks_get('NovaNetworkConfigurationHandler',
                                  cluster_id,
                                  expect_errors)

    def nova_networks_put(self, cluster_id, networks, expect_errors=False):
        return self._networks_put('NovaNetworkConfigurationHandler',
                                  cluster_id,
                                  networks,
                                  expect_errors)

    def neutron_networks_get(self, cluster_id, expect_errors=False):
        return self._networks_get('NeutronNetworkConfigurationHandler',
                                  cluster_id,
                                  expect_errors)

    def neutron_networks_put(self, cluster_id, networks, expect_errors=False):
        return self._networks_put('NeutronNetworkConfigurationHandler',
                                  cluster_id,
                                  networks,
                                  expect_errors)
