...
class EnvironmentManager(object):
    ...
    def wait_until_received_by_orchestrator(self, task, timeout=60):
        wait_until_in_statuses = (consts.TASK_STATUSES.sent_to_orchestrator,)
        self._wait_task_status(task, timeout,
                               wait_until_in_statuses=wait_until_in_statuses)
        self.tester.assertNotEqual(task.status,
                                   consts.TASK_STATUSES.sent_to_orchestrator)
