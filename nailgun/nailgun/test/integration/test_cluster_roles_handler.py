...
class TestClusterRolesHandler(base.BaseTestCase):
    ...
    def test_put_is_not_allowed(self):
        ...
        self.assertEquals(roles_resp.status_code, 405)
        self.assertIn("Method Not Allowed", roles_resp.status)
    ...
    def test_put_is_not_allowed_for_single_role(self):
        role_resp = self.app.put(
            url=base.reverse(
                'ClusterRolesHandler',
                {'cluster_id': self.cluster.id, 'role_name': self.role_name}
            ),
        ...
        self.assertEquals(role_resp.status_code, 405)
        self.assertIn("Method Not Allowed", role_resp.status)
