...
from nailgun.test.base import BaseIntegrationTest, BaseDeploymentTasksTest
...
class TestReleaseGraphHandler(BaseGraphTasksTests, BaseDeploymentTasksTest):
...
class TestClusterGraphHandler(BaseGraphTasksTests, BaseDeploymentTasksTest):
