...
class BaseIPAddrTest(BaseNetworkManagerTest):
    def setUp(self):
        ...
        self.expected_vips = [
            {'vip_name': 'haproxy', 'node': None, 'ip_addr': '172.16.0.2',
             'is_user_defined': False},
            {'vip_name': 'vrouter', 'node': None, 'ip_addr': '172.16.0.3',
             'is_user_defined': False},
            {'vip_name': 'haproxy', 'node': None, 'ip_addr': '192.168.0.1',
             'is_user_defined': False},
            {'vip_name': 'vrouter', 'node': None, 'ip_addr': '192.168.0.2',
             'is_user_defined': False},
        ]
        ...
        update_data = [
            {
                ...
                'vip_name': 'should-not-be-changed',
