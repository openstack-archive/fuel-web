...
class TestNetworkManager(BaseNetworkManagerTest):
    ...
    def test_update_networks_meta(self):
        ...
        # Check where ranges had been changed after gateway was set.
        # Lower values of range is changed from "192.168.0.1" to "192.168.0.2".
        self.assertEqual(management_ng['ip_ranges'][0][0], '192.168.0.2')
