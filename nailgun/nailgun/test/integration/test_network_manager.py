...
class TestNeutronManager70(BaseIntegrationTest):
    ...
    def test_check_unique_vip_names_for_cluster(self):
        with mock.patch('nailgun.objects.Cluster.get_network_roles') \
                as get_nr_mock:
            fake_role_errorneous_data = [
                {
                    'properties': {
                        'vip': [
                            {
            ...
            get_nr_mock.return_value = fake_role_errorneous_data
            self.assertRaises(
