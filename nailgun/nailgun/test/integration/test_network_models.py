    ...
    def test_networks_update_after_deployment(self):
        self.env.create(
            cluster_kwargs={
                ...
                'status': CLUSTER_STATUSES.operational
            },
            nodes_kwargs=[
        ...
        # it's confusing but status will be 200 OK
        self.assertEqual(200, resp_neutron_net.status_code)
        self.assertEqual(TASK_STATUSES.error,
        ...
        self.assertEqual(200, resp_neutron_net.status_code)
        self.assertEqual(TASK_STATUSES.ready,
                         resp_neutron_net.json_body['status'],
