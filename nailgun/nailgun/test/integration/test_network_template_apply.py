...
class TestNetTemplateMalformedNICMappingApplyFail(base.BaseIntegrationTest):

    def setUp(self):
        super(TestNetTemplateMalformedNICMappingApplyFail, self).setUp()

        self.cluster = self.env.create(
            release_kwargs={'api': False, 'version': '11111-9.0'},
    ...
    def test_net_template_upload_for_cluster_w_nodes(self):
    ...
    def test_net_template_apply_when_set_node_via_node_handler(self):
    ...
    def test_net_template_apply_when_node_set_via_node_collct_handler(self):
    ...
    def test_net_template_apply_when_node_set_via_cluster_handler(self):
