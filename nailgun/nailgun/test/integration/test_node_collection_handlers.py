...
class TestHandlers(BaseIntegrationTest):
    ...
    def test_node_get_by_wrong_cluster_id(self):
        ...
        self.assertEqual(
            resp.json_body['message'],
            'Invalid \'cluster_id\' value: {0}'.format(wrong_cluster_id))
    ...
    def test_node_get_by_wrong_group_id(self):
        ...
        self.assertEqual(
            resp.json_body['message'],
            'Invalid \'group_id\' value: {0}'.format(wrong_group_id))
    ...
    def test_node_get_by_none_status(self):
        ...
        self.assertEqual(400, resp.status_code)
        self.assertEqual(
            resp.json_body['message'], u"Invalid 'status' value: None")
    ...
    def test_node_get_by_wrong_status(self):
        ...
        self.assertEqual(
            resp.json_body['message'],
            'Invalid \'status\' value: {0}'.format(wrong_status_value))
    ...
    def test_node_get_by_wrong_online_value(self):
        ...
        self.assertEqual(
            resp.json_body['message'],
            'Invalid \'online\' value: {0}'.format(wrong_online_value))
