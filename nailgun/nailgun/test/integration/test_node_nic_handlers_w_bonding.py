...
class TestNodeNICsBonding(BaseIntegrationTest):
    ...
    def test_nics_bond_create_failed_admin_net_w_lacp(self):
        for mode in [BOND_MODES.l_802_3ad, BOND_MODES.lacp_balance_tcp]:
            self.setUp()
            ...
            self.node_nics_put_check_error(
                "Node '{0}': interface 'bond0' belongs to admin network "
