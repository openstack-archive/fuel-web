...
class OrchestratorSerializerTestBase(BaseIntegrationTest):
    ...
    def serializer(self):
        ...
        graph.add_tasks(yaml.load(graph_configuration.DEPLOYMENT_50))
        return DeploymentHASerializer(graph)
...
class TestNovaOrchestratorSerializer(OrchestratorSerializerTestBase):
    ...
    def test_set_deployment_priorities(self):
        ...
        graph = deployment_graph.DeploymentGraph()
        graph.add_tasks(yaml.load(graph_configuration.DEPLOYMENT_50))
        serializer = DeploymentMultinodeSerializer(graph)
...
class TestNovaOrchestratorHASerializer51(TestNovaOrchestratorHASerializer):
    ...
    def serializer(self):
        graph = deployment_graph.DeploymentGraph()
        graph.add_tasks(yaml.load(graph_configuration.DEPLOYMENT_51))
        return DeploymentHASerializer(graph)
...
class TestHASerializerPatching(TestNovaOrchestratorHASerializer):
    ...
    def serializer(self):
        graph = deployment_graph.DeploymentGraph()
        graph.add_tasks(yaml.load(graph_configuration.PATCHING))
        return DeploymentHASerializer(graph)
...
class TestMongoNodesSerialization(OrchestratorSerializerTestBase):
    ...
    def serializer_mn(self):
        graph = deployment_graph.DeploymentGraph()
        graph.add_tasks(yaml.load(graph_configuration.DEPLOYMENT_50))
        return DeploymentMultinodeSerializer(graph)
