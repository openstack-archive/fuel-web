...
class TestDeploymentAttributesSerialization70(
    ...
    def test_non_default_bridge_mapping(self):
        expected_mapping = {
            u'test': u'br-test',
            u'testnetwork1': u'br-testnetwork2',
            u'testnetwork13': u'br-testnetwork1',
            u'my-super-network': u'br-my-super-net',
            u'uplink-network-east': u'br-uplink-netwo',
            u'uplink-network-west': u'br-uplink-netw1',
            u'uplink-network-south': u'br-uplink-netw2',
