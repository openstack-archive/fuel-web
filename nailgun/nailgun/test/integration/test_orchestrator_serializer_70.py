...
class TestNetworkTemplateSerializer70(BaseDeploymentSerializer):
    ...
    def setUp(self, *args):
        ...
        with open(fxtr_path) as f:
            self.net_template = jsonutils.loads(f.read())
    ...
    def test_get_net_provider_serializer(self, _):
        ...
        self.assertEqual(net_serializer, NeutronNetworkDeploymentSerializer70)

        self.cluster.network_config.configuration_template = \
            self.net_template
        net_serializer = serializer.get_net_provider_serializer(self.cluster)
        self.assertEqual(net_serializer, NeutronNetworkTemplateSerializer70)
