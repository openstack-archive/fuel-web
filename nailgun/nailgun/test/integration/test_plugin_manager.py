...
class TestPluginManager(base.BaseIntegrationTest):
    ...
    def test_enable_plugins_by_component(self):
        ...
        enabled_plugins = objects.PluginCollection.get_enabled(cluster.id)
...
class TestClusterPluginIntegration(base.BaseTestCase):
    ...
    def test_get_enabled_plugins(self):
        ...
        objects.PluginCollection.set_attributes(
            plugin_a.id, self.cluster.id, enabled=True)

        compat_plugins = PluginManager.get_compatible_plugins(self.cluster)
        self.assertItemsEqual(compat_plugins, [plugin_a, plugin_b])

        enabled_plugins = objects.PluginCollection.get_enabled(self.cluster.id)
