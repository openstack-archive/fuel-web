...
class TestRoleApi(BaseRoleTest):
    ...
    def test_get_all_release_roles(self):
        owner_type, owner_id = self.OWNER_MAP['release'], self.release.id
    ...
    def test_get_all_cluster_roles(self):
        owner_type, owner_id = self.OWNER_MAP['cluster'], self.cluster.id
        self.env.create_role(owner_type, owner_id, self.role_data)
    ...
    def test_delete_release_assigned_role(self):
        owner_type, owner_id = self.OWNER_MAP['release'], self.release.id
        ...
        self.env.create(
            ...
            cluster_kwargs={'release_id': self.cluster.release.id},
        )
    ...
    def test_delete_release_pending_assigned_role(self):
        owner_type, owner_id = self.OWNER_MAP['release'], self.release.id
        role = self.env.create_role(owner_type, owner_id, self.role_data).json
        self.env.create(
            nodes_kwargs=[
