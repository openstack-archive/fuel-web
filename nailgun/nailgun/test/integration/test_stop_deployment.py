...
class TestStopDeployment(BaseIntegrationTest):
    ...
    def test_stop_deployment(self):
        ...
        self.env.mark_child_tasks_received_by_orchestrator(supertask)
    ...
    def test_admin_ip_in_args(self, mocked_rpc):
        ...
        self.env.mark_child_tasks_received_by_orchestrator(deploy_task)
    ...
    def test_stop_provisioning(self):
        ...
        provision_task.is_in_orchestrator = True
        self.db.flush()
