...
class TestTaskDeploy(BaseIntegrationTest):
    ...
    def test_task_deploy_with_plugins(self, load_tasks, *_):
        ...
        compute_tasks = message['args']['tasks_links'][compute_uid]
    ...
    def test_task_deploy_specified_tasks(self, rpc_cast, *_):
        ...
        links = rpc_cast.call_args[0][1]['args']['tasks_links']
        self.assertItemsEqual(
            ["deploy_legacy"],
    ...
    def test_task_deploy_all_tasks(self, rpc_cast, *_):
        ...
        message = self.get_deploy_message()
        deploy_tasks = message['args']['tasks_links']
        self.assertIn(
            "netconfig",
