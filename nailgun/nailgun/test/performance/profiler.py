...
class Profiler(object):
    ...
    def __init__(self, method='', handler_name=''):
        ...
        if not os.path.exists(settings.LOAD_TESTS_PATHS['last_load_test']):
            os.makedirs(settings.LOAD_TESTS_PATHS['last_load_test'])
    ...
    def save_data(self):
        ...
        pref_filename = os.path.join(
            settings.LOAD_TESTS_PATHS['last_load_test'],
