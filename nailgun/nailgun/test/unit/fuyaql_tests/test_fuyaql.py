...
class TestFuyaqlController(base.BaseUnitTest):
    ...
    def test_set_cluster(self, obj_mock):
        ...
        obj_mock.deployment_serializers.serialize_for_lcm.assert_called()
    ...
    def test_get_tasks(self, obj_mock):
        ...
        obj_mock.TransactionCollection.filter_by.assert_called_once()
        obj_mock.TransactionCollection.filter_by_not.return_value = 'requery'
        obj_mock.TransactionCollection.filter_by_not.assert_called_once()
        obj_mock.TransactionCollection.order_by.return_value = 'tasks'
        obj_mock.TransactionCollection.order_by.assert_called_once()
