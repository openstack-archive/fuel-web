...
class CheckRepositoryConnectionFromMasterNodeTaskTest(BaseTestCase):
    ...
    def test_execute_fail(self, _, __):
        ...
        self.assertEqual(
            ...
            'Connection to the following repositories could not be established: '
            '<url1 [500]>')
    ...
    def test_execute_fail_with_connection_error(self, m_error, _, __):
        ...
        test_message = "Connection to the repositories could not be "\
                       "established: {}.".format(self._connection_error)
        m_error.assert_called_once_with(test_message)
        self.assertEqual(
            cm.exception.message,
