...
class TestExtensionValidator(BaseTestCase):
    ...
    def test_validate_delete_extensions(self):
        ...
        with mock.patch(
            ...
            ExtensionValidator.validate_delete(
                jsonutils.dumps(global_exts[:2]), cluster)
    ...
    def test_invalid_delete_extensions(self):
        ...
        with mock.patch(
            ...
            with self.assertRaisesRegexp(errors.CannotFindExtension,
                                         'No such extensions: invalid'):
                    ExtensionValidator.validate_delete(jsonutils.dumps(data),
                                                       cluster)
