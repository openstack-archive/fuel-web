...
class TestGraphDependencies(base.BaseTestCase):
    ...
    def setUp(self):
        ...
        self.graph = orchestrator_graph.OrchestratorGraph()
...
class TestOrdered(base.BaseTestCase):
    ...
    def test_always_same_order(self):
        ...
        graph = orchestrator_graph.OrchestratorGraph(tasks=self.tasks)
...
class TestIncludeSkipped(base.BaseTestCase):
    ...
    def setUp(self):
        ...
        self.tasks = yaml.load(self.TASKS)
        self.graph = orchestrator_graph.OrchestratorGraph(tasks=self.tasks)
...
class TestOrchestratorGraphValidator(base.BaseTestCase):
    ...
    def test_validation_pass_with_existing_dependencies(self):
        ...
        graph_validator = orchestrator_graph.OrchestratorGraphValidator(tasks)
    ...
    def test_validation_failed_with_not_existing_dependencies(self):
        ...
        for dependency_type in dependencies_types:
            ...
            tasks = yaml.load(yaml_tasks)
            graph_validator = orchestrator_graph.OrchestratorGraphValidator(
                tasks)
