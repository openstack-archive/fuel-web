...
from nailgun.api.v1.handlers.base import BaseHandler, CollectionHandler
...
class TestHandlers(BaseIntegrationTest):
    ...
    def test_nailgun_collection_handler(self):
        urls = ("/collection_test", "collection_test")
        app = web.application(urls, {'collection_test': CollectionHandler})
        resp = app.request('/collection_test')
        resp = self.app.get(url, expect_errors=False)
