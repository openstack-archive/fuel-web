...
def prepare():
    ...
    attrs_1 = deepcopy(ATTRIBUTES_METADATA)
    attrs_2 = deepcopy(ATTRIBUTES_METADATA)
    attrs_2.setdefault('editable', {}).setdefault('common', {}).setdefault(
