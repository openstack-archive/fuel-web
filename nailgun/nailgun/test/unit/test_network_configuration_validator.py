...
class TestNovaNetworkConfigurationValidatorProtocol(
    ...
    def test_management_vip_invalid_type(self):
        self.nc['management_vip'] = {}
        self.assertRaisesInvalidAnyOf(self.nc, "{}", "['management_vip']")

    def test_management_vrouter_vip_invalid_type(self):
        self.nc['management_vrouter_vip'] = {}
        self.assertRaisesInvalidAnyOf(
            self.nc, "{}", "['management_vrouter_vip']")

    def test_public_vip_invalid_type(self):
        self.nc['public_vip'] = {}
        self.assertRaisesInvalidAnyOf(self.nc, "{}", "['public_vip']")

    def test_public_vrouter_vip_invalid_type(self):
        self.nc['public_vrouter_vip'] = {}
        self.assertRaisesInvalidAnyOf(self.nc, "{}", "['public_vrouter_vip']")
