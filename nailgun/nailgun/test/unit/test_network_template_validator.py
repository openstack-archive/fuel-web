...
class TestNetworkTemplateValidator(BaseValidatorTest):
    ...
    def test_node_group_required_property_templates_for_node_role(self):
        self.nt['adv_net_template']['node_group_1'].pop('templates_for_node_role')
    ...
    def test_node_group_invalid_type_templates_for_node_role(self):
        self.nt['adv_net_template']['node_group_1']['templates_for_node_role'] = 1
        self.assertRaisesInvalidType(self.nt, 1, 'object')
