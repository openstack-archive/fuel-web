...
class TestHandlers(BaseIntegrationTest):
    ...
    def test_get_notification_status(self):
        ...
        self.assertEqual({'total': 0, 'unread': 0}, resp.json_body)
        self.assertEqual(200, resp.status_code)
        ...
        self.assertEqual({'total': 1, 'unread': 1}, resp.json_body)
        ...
        self.assertEqual({'total': 3, 'unread': 1, 'read': 2}, resp.json_body)
