...
class TestTransactionObject(BaseIntegrationTest):
    ...
    def test_get_succeed_transactions_per_task(self):
        ...
        transactions = transaction_collection.get_succeed_transactions_per_task(
            self.cluster.id, ['dns-client']).all()
        ...
        transactions = transaction_collection.get_succeed_transactions_per_task(
            self.cluster.id, ['dns-client', 'test']).all()
