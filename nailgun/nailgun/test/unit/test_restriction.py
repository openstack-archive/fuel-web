...
from nailgun.utils.restrictions import PluginComponentsRestrictions
...
class TestPluginComponentsRestrictions(base.BaseTestCase):

    def setUp(self):
        super(TestPluginComponentsRestrictions, self).setUp()
    ...
    def test_components_not_in_release(self):
        self._validate_with_expected_errors(
            ...
            "release \"release_name_2015.1-8.0\"."
        )
    ...
    def test_not_all_mandatory_types_components(self):
        ...
        PluginComponentsRestrictions.validate_components(
            self.release.id, selected_components_list)
    ...
    def test_incompatible_components_found(self):
        self._validate_with_expected_errors(
            ...
            "Incompatible components were found: 'hypervisor:test_hypervisor' "
            "incompatible with ['network:core:test_network_1']."
        )
    ...
    def test_requires_one_of_predicate(self):
        ...
        self._validate_with_expected_errors(
            selected_components_list,
            "Require one_of(['network:core:test_network_1', "
            "'network:core:test_network_2']) for "
            "'additional_service:test_service' component was not satisfied."
        )
    ...
    def test_requires_none_of_predicate(self):
        ...
        self._validate_with_expected_errors(
            selected_components_list,
            "Require none_of(['network:core:test_network_1', "
    ...
    def test_requires_all_of_predicate(self):
        ...
        self._validate_with_expected_errors(
            ...
            "'network:core:test_network_2', 'storage:test_storage']) for "
            "'additional_service:test_service' component was not satisfied."
        )

        PluginComponentsRestrictions.validate_components(
            self.release.id,
            ['additional_service:test_service', 'storage:test_storage',
    ...
    def _validate_with_expected_errors(self, components_list, error_msg):
        with self.assertRaises(errors.InvalidData) as exc_cm:
            PluginComponentsRestrictions.validate_components(
                self.release.id, components_list)
