...
class TestComponentsRestrictions(base.BaseTestCase):
    ...
    def test_incompatibles_mixed_format(self):
        self.components_metadata.append({
            'name': 'storage:wrong_storage',
            'incompatible': [
                {'all_of': {
        ...
        self._validate_with_expected_errors(
            ['storage:wrong_storage'],
            "Component 'storage:wrong_storage' has mixed format of "
            "incompatibilities."
        )
    ...
    def test_incompatibles_one_of_predicate(self):
        ...
        self._validate_with_expected_errors(
            selected_components_list,
            "Incompatible requirement was satisfied for component "
            "'additional_service:test_service': one_of(['storage:*'])"
        )
    ...
    def test_incompatibles_none_of_predicate(self):
        ...
        self._validate_with_expected_errors(
            selected_components_list,
            "Incompatible requirement was satisfied for component "
            "'additional_service:test_service': none_of(['network:core:*'])"
        )
    ...
    def test_incompatibles_all_of_predicate(self):
        ...
        self._validate_with_expected_errors(
            selected_components_list,
            "Incompatible requirement was satisfied for component "
            "'additional_service:test_service': all_of(['network:core:*'])"
        )
