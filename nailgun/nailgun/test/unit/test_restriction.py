...
class TestRestriction(base.BaseUnitTest):
    ...
    def test_process_restrictions(self):
        attributes = self.data.get('attributes_1')
        RestrictionMixin.process_restrictions(attributes, 'attributes_1')
    ...
    def test_process_without_path_key(self):
        RestrictionMixin.process_restrictions(self.data)
        print(RestrictionMixin.expanded_restrictions)
