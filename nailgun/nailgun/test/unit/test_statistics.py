...
class TestOpenStackClientProvider(BaseTestCase):
    ...
    def test_fail_if_no_online_controllers(self):
        ...
        def helper():
            """One of the way to test exception rising by
            code inside of property is to wrap it in outer helper
            function which will be passed as callable to
            assertRaises
            """
            client_provider.credentials

        self.assertRaises(errors.NoOnlineControllers, helper)
