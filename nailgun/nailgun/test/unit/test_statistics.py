...
class TestOpenStackInfoCollector(BaseTestCase):
    def test_get_info(self):
        ...
        client_provider_prop_mock = PropertyMock(
            return_value=client_provider_mock)
        ...
        # same for 'client_provider' attr
        client_provider_prop_path = \
            ("nailgun.statistics.openstack_info_collector."
             "OpenStackInfoCollector.client_provider")

        with patch(client_provider_prop_path,
                   client_provider_prop_mock):
            with patch(proxy_prop_path, PropertyMock()):
                collector = \
                    openstack_info_collector.OpenStackInfoCollector(None)
