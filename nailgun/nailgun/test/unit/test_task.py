...
class TestCheckBeforeDeploymentTask(BaseTestCase):
    ...
    def test_check_public_networks(self):
        ...
        self.assertFalse(objects.Cluster.assign_public_to_all_nodes(cluster))
        ...
        self.assertNotRaises(
            ...
            CheckBeforeDeploymentTask._check_network,
            self.task)
        ...
        self.assertTrue(objects.Cluster.assign_public_to_all_nodes(cluster))
