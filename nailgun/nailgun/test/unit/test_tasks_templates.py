        ...
        self.assertEqual(
            ...
            {'parameters': {
                'data': (
                    ...
                    'Acquire::https::Proxy::repo-1 "http://proxy-1:1233";\n'
                    'Acquire::ftp::Proxy::repo-1 "http://proxy-1:1233";\n'
                    'Acquire::http::Proxy::repo-2 "ftp://proxy-2:1233";\n'
                    'Acquire::https::Proxy::repo-2 "ftp://proxy-2:1233";\n'
                    'Acquire::ftp::Proxy::repo-2 "ftp://proxy-2:1233";\n'
                    'Acquire::http::Proxy::repo-3 "https://proxy-3:1233";\n'
                    'Acquire::https::Proxy::repo-3 "https://proxy-3:1233";\n'
                    'Acquire::ftp::Proxy::repo-3 "https://proxy-3:1233";'),
