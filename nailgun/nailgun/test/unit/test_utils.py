...
class TestFakeNodeGenerator(base.BaseUnitTest):
    ...
    def test_generate_fake_node_disks_meta(self):
        ...
        disks_meta = self.generator._generate_disks_meta(28)
        self.assertEqual(len(disks_meta), 28)
        self.assertEqual(disks_meta[27]['name'], 'sdbb')
