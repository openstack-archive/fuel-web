...
from nailgun.utils import get_apt_preferences_line
from nailgun.utils import get_fuel_release_versions
from nailgun.utils import grouper
from nailgun.utils import parse_debian_release_info
...
class TestParseDebianReleaseInfo(base.BaseUnitTest):
    ...
    def test_parse(self):
        deb_release = parse_debian_release_info(self._deb_release_info)
