...
class TestAttributesValidator(BaseTestCase):
    ...
    def test_remove_controllers_nova_compute_setting(self, lock_mock):
        ...
        self.validate_nova_compute_raises_regexp(
            new_nova_computes,
            "The following nova compute instance with target 'controllers' "
            "couldn't be deleted from operational environment: nova compute "
            "with vSphere cluster name '{0}' ".format("Cluster0")
        )
