...
class AttributesRestriction(RestrictionBase):
    ...
    @classmethod
    def group_attribute(cls, data):
        return 'metadata' in data

    @classmethod
    def get_label(cls, data):
        if cls.group_attribute(data):
    ...
    def check_data(cls, models, data):
        ...
        def find_errors(data=data):
            ...
            group_attribute = cls.group_attribute(data)
            value = cls.get_value(data)
            label = cls.get_label(data)
            restrictions = cls.get_restrictions(data)
