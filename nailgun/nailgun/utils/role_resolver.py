...
class RoleResolver(BaseRoleResolver):
    ...
    # None - it is special null node, that is used to run tasks
    # that is not associated with any node, for example
    # points of synchronisations
    ...
    def resolve(self, roles, policy=None):
        ...
        # to distribute load select random node from pool
