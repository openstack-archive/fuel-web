    ...
    return {
        ...
        noLeaveCheckMixin: {
            onLeave: function(e) {
                ...
                if (!options.redirect) options.redirect = function() {app.navigate(href, {trigger: true});};
            ...
            componentWillMount: function() {
                ...
                $('body').on('click.' + this.props.eventNamespace, 'a[href^=#]:not(.no-leave-check)', _.bind(this.onLeave, this));
            },
            componentWillUnmount: function() {
