        ...
        onLeaveCheckMixin: {
            onLeave: function(e) {
                var dialogs = require('jsx!views/dialogs'),
                    ...
                    onLeaveOptions = this.state.onLeaveCheckOptions || {},
                    verification = onLeaveOptions.verification ? onLeaveOptions.verification() : false,
                    options = {
                        redirect: function() {app.navigate(href, {trigger: true});},
                        cb: onLeaveOptions.cb,
                        message: verification ? i18n('dialog.dismiss_settings.verify_message') : null,
                        hideLeaveButton: verification
                    };
