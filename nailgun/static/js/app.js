...
function(React, utils, layoutComponents, Coccyx, coccyxMixins, models, KeystoneClient, commonViews, LoginPage, ClusterPage, NodesTab, ClustersPage, ReleasesPage, NotificationsPage, SupportPage, CapacityPage) {
    ...
    var AppRouter = Backbone.Router.extend({
        ...
        renderLayout: function() {
            ...
            this.navbar = React.render(new layoutComponents.Navbar({
                elements: [
            ...
            this.breadcrumbs = React.render(new layoutComponents.Breadcrumbs(), $('#breadcrumbs')[0]);
            this.footer = React.render(new layoutComponents.Footer({version: this.version}), $('#footer')[0]);
