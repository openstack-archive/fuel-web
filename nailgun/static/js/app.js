...
function(Coccyx, coccyxMixins, models, KeystoneClient, commonViews, LoginPage, ClusterPage, NodesTab, ClustersPage, ReleasesPage, NotificationsPage, SupportPage, CapacityPage) {
    ...
    var AppRouter = Backbone.Router.extend({
        ...
        setPage: function(NewPage, options) {
            ...
            this.footer.$el.toggle(!options.footerHidden);
            this.breadcrumbs.$el.toggle(!options.breadcrumbsHidded);
            this.navbar.$el.toggle(!options.navbarHidden);
        },
        // routes
        login: function() {
            this.setPage(LoginPage, {
                footerHidden: true,
                breadcrumbsHidded: true,
                navbarHidden: true
            });
        },
        logout: function() {
