...
define(['react', 'backbone', 'utils'], function(React, Backbone, utils) {
    ...
    var BackboneViewWrapperClass = React.createClass({
        ...
        componentWillUpdate: function() {
            this.state.view.$el.detach();
        },
        componentDidUpdate: function() {
            this.state.view.$el.appendTo(this.refs.wrapper.getDOMNode());
        },
        ...
        registerSubView: function() {
            return this.state.view.registerSubView.apply(this.state.view, arguments);
        }
    });
    ...
    function BackboneViewWrapper(View) {
        return React.createClass({
            ...
            registerSubView: function() {
                return this.refs.wrapper.registerSubView.apply(this.refs.wrapper, arguments);
            }
        });
    }
