 ...
 * under the License.
**/
define(['react', 'backbone', 'jquery', 'utils'], function(React, Backbone, $, utils) {
    'use strict';
    ...
    var BackboneViewWrapperClass = React.createClass({
        ...
        componentDidUpdate: function() {
            $(this.refs.wrapper.getDOMNode()).append(this.state.view.$el);
        },
    ...
    function BackboneViewWrapper(View) {
        return React.createClass({
            render: function() {
                return <BackboneViewWrapperClass {...this.props} View={View} />;
            }
        });
    }
