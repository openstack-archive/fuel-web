    ...
    models.Settings = Backbone.DeepModel.extend({
        ...
        validate: function(attrs, options) {
            ...
            _.each(attrs, function(group, groupName) {
                if (this.checkRestrictions(options.configModels, group.metadata).result) { return; }
                _.each(group, function(setting, settingName) {
                    if (!(setting.regex && setting.regex.source) || this.checkRestrictions(options.configModels, setting).result) { return; }
