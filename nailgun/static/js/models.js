...
define([
    ...
    models.Interface = BaseModel.extend({
        ...
        linuxBondingModes: ['balance-rr', 'active-backup', 'balance-xor', 'broadcast', '802_3ad', 'balance-tlb', 'balance-alb'],
        ...
        isHashPolicyNeeded: function() {
            return _.contains(models.Interface.prototype.hashPolicyNeeded, this.getBondMode());
        },
    ...
    models.Interfaces = BaseCollection.extend({
        ...
        generateBondName: function() {
            var index, proposedName,
                base = app.version.get('release') == LINUX_BONDING_RELEASE ? 'bond' : 'ovs-bond';
