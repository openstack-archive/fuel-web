...
define([
    ...
    var BaseModel = models.BaseModel = Backbone.Model;
    ...
    models.Settings = Backbone.DeepModel.extend(cacheMixin).extend(restrictionMixin).extend({
        ...
        toJSON: function(options) {
            var data = {};
            data[this.root] = this._super.apply(this, arguments);
            return data;
        },
