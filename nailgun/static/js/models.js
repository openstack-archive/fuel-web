        ...
        checkLimits: function(models, checkLimitIsReached, limitTypes) {
            ...
            **/
            ...
            var checkedLimitTypes = {},
                ...
                limitValues = {
                    max: utils.evaluateExpressionNow(limits.max, models).value,
                    min: utils.evaluateExpressionNow(limits.min, models).value,
                    recommended: utils.evaluateExpressionNow(limits.recommended, models).value
                },
            ...
            var checkOneLimit = function(obj, limitType) {
                ...
                limitValue = utils.evaluateExpressionNow(obj[limitType], models).value;
                ...
                if (comparator(count, limitValue)) {
                    ...
                    return obj.message || i18n('common.role_limits.' + limitType, {limitValue: limitValue, count: count, roleName: name});
                }
            };
            ...
            messages = _.chain(overrides)
                .map(function(override) {
                    var exp = utils.evaluateExpressionNow(override.condition, models).value;
