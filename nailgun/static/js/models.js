...
define(['utils', 'deepModel'], function(utils) {
    ...
    models.Tasks = Backbone.Collection.extend({
        ...
        filterTasks: function(filters) {
            return _.compact(_.map(this.constructor.prototype.model.prototype.extendGroups(filters), function(name) {
                return this.filter(function(task) {
                    return task.match(_.extend(filters, {name: name, group: ''}));
                })[0];
            }, this));
        },
