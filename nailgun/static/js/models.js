            ...
            attrs.networks.each(function(network) {
                ...
                _.each(network.getAttributes(netProvider), function(attr) {
                    if (attr == 'ip_ranges') {
                        ...
                        var vlanEnd = fixedNetwork.get('vlan_start') + fixedNetwork.get('amount') - 1;
                        ...
                        } else if (netProvider == 'nova_network' && network.get('name') != 'fixed' && utils.validateVlanRange(fixedNetwork.get('vlan_start'), vlanEnd, vlan)) {
