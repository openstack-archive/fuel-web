            ...
            attrs.networks.each(function(network) {
                ...
                _.each(network.getAttributes(netProvider), function(attr) {
                    if (attr == 'ip_ranges') {
                        ...
                        var forbiddenVlans = _.compact(_.pluck(attrs.networks.reject({id: network.id, name: 'floating'}), 'vlan_start'));
                        ...
                        } else if (network.get('name') == 'public' && !utils.validateIpCorrespondsToCIDR(publicCidr, network.get('gateway'))) {
