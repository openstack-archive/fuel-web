...
define(['require'], function(require) {
    ...
    var utils = {
        ...
        showBandwidth: function(bandwidth) {
            ...
            if (!_.isNumber(bandwidth) || _.isNaN(bandwidth)) {return $.t('dialog.show_node.undefined');}
            return (bandwidth / 1000).toFixed(1) + ' Gbps';
        },
        showFrequency: function(frequency) {
            frequency = parseInt(frequency, 10);
            if (!_.isNumber(frequency) || _.isNaN(frequency)) {return $.t('dialog.show_node.undefined');}
            var base = 1000;
            var treshold = 1000;
        ...
        showSize: function(bytes, treshold) {
            ...
            if (!_.isNumber(bytes) || _.isNaN(bytes)) {return $.t('dialog.show_node.undefined');}
            var base = 1024;
