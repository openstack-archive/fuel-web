...
define(['require'], function(require) {
    ...
    var utils = {
        ...
        validateNetmask: function(netmask) {
            console.log(netmask);
            console.log(this.ipIntRepresentation(netmask));
            console.log(this.ipIntRepresentation(netmask).toString(2));
            return !this.ipIntRepresentation(netmask).toString(2).match(/^1+00+$/);
        },
