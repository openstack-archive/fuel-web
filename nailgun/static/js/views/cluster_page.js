    ...
    var ClusterPage = commonViews.Page.extend({
        ...
        onBeforeunloadEvent: function() {
            if (_.result(this.tab, 'hasChanges')) {
                // FIXME: This fires warning "Something is calling a React component directly. Use a factory or JSX instead."
                return dialogs.DiscardSettingsChangesDialog().props.defaultMessage;
            }
        },
