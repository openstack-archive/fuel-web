...
function($, _, i18n, Backbone, React, utils, models, componentMixins, BackboneViewWrapper, dialogs, NodesTab, NetworkTab, SettingsTab, LogsTab, ActionsTab, HealthCheckTab, vmWare) {
    'use strict';
