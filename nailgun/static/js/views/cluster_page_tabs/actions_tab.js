...
function(models, commonViews, dialogViews, actionsTabTemplate, renameEnvironmentTemplate, resetEnvironmentTemplate, deleteEnvironmentTemplate, updateEnvironmentTemplate, rollbackEnvironmentTemplate) {
    ...
    var ActionsTab, RenameEnvironmentAction, ResetEnvironmentAction, DeleteEnvironmentAction, UpdateEnvironmentAction, RollbackEnvironmentAction;
    ...
    ActionsTab = commonViews.Tab.extend({
        ...
        render: function() {
            ...
            if (this.model.get('status') == 'update_error') {
                actions.push(RollbackEnvironmentAction);
            } else {
                actions.push(UpdateEnvironmentAction);
            }
    ...
    RollbackEnvironmentAction = Backbone.View.extend({
        className: 'span12 action-item-placeholder action-update',
        ...
        render: function() {
            this.$el.html(this.template({isRollbackDisabled: this.tab.isLocked()}));
            return this;
        }
    });
