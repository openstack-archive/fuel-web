...
function(React, utils, models, dialogViews) {
    ...
    var UpdateEnvironmentAction = React.createClass({
        ...
        applyAction: function() {
            var cluster = this.props.cluster,
                isDowngrade = _.contains(cluster.get('release').get('can_update_from_versions'), this.props.releases.findWhere({id: this.state.pendingReleaseId || cluster.get('release_id')}).get('version'));
