...
function(React, utils, models, dialogViews) {
    ...
    var UpdateEnvironmentAction = React.createClass({
        ...
        getDescriptionKey: function() {
            ...
            switch (true) {
                case action == 'update' && status == 'operational' && !this.state.pendingReleaseId:
                    return 'no_releases_to_update_message';
                    break;
                case action == 'rollback':
                    return 'rollback_message';
                    break;
                case task && _.contains(task.get('name'), action):
                    return 'repeated_' + action + '_disabled';
                    break;
                case task:
                    return action + '_disabled_for_deploying_cluster';
                    break;
                case (action == 'reset' && status == 'new') || (action == 'update' && status != 'operational'):
