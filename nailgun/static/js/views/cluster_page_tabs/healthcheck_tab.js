            ...
            var credentialsWrapperBindings = {
                '.toggle-credentials' : {
                    ...
                    update: function($el, value) {
                        if (!value) {
                            $el.html('<i class="icon-plus-circle"></i><div>' + $.t('cluster_page.healthcheck_tab.show_credentials') + '</div>');
                        } else {
                            $el.html('<i class="icon-minus-circle"></i><div>' + $.t('cluster_page.healthcheck_tab.hide_credentials') + '</div>');
                        }
                    }
                },
                '.credentials': {
