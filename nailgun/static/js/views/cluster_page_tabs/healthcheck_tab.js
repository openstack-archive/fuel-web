...
function(utils, models, commonViews, dialogViews, healthcheckTabTemplate, healthcheckTestSetTemplate, healthcheckTestsTemplate) {
    ...
    HealthCheckTab = commonViews.Tab.extend({
        ...
        calculateSelectAllTumblerState: function() {
            this.selectAllTumbler.set({'checked': this.$('input.testset-select:checked').length == this.$('input.testset-select').length});
        },
        ...
        render: function() {
            ...
            this.selectAllTumbler = new Backbone.Model(_.extend({}, defaultButtonModelsData, {
                'disabled': false,
                'checked': false
            }));
            ...
            this.stickit(this.selectAllTumbler, {'.select-all-tumbler': checkedDisabledBindings});
