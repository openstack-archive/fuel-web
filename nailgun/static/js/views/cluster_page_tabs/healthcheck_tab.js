            ...
            var credentialsWrapperBindings = {
                '.toggle-credentials' : {
                    ...
                    update: function($el, value) {
                        $el.html('<i class="icon-' + (value ? 'minus' : 'plus') + '-circle"></i><div>' + (value ?  $.t('cluster_page.healthcheck_tab.hide_credentials') : $.t('cluster_page.healthcheck_tab.show_credentials')) + '</div>');
                    }
                },
                '.credentials': {
                    observe: 'visible',
