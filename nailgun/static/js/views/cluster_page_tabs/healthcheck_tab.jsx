            ...
            return (
                <div>
                    <div className='healthcheck-controls row well well-sm'>
                        ...
                        {hasRunningTests ?
                            (<button className='btn btn-danger action-btn stop-tests-btn pull-right col-xs-1'
                            ...
                            :
                            (<button className='btn btn-success action-btn run-tests-btn pull-right col-xs-1'
                        ...
                        {shouldControlsBeShown &&
                            <div className='toggle-credentials col-xs-4 col-xs-offset-5' data-toggle='collapse' data-target='.credentials' onClick={this.toggleCredentials}>
                                ...
                                <div className='col-xs-10 btn-link provide-credentials'>{i18n('cluster_page.healthcheck_tab.provide_credentials')}</div>
                            </div>
                        }
