...
function($, _, i18n, Backbone, React, models, utils, componentMixins, controls) {
        ...
        render: function() {
            ...
            return (
                <div className='wrapper healthcheck-tab'>
                    <h3 className='col-xs-4 healthcheck-title'>{i18n('cluster_page.healthcheck_tab.title')}</h3>
    ...
    var HealthcheckTabContent = React.createClass({
        ...
        render: function() {
            ...
            return (
                <div>
                    <div className='page-sub-title col-xs-8'>
                        <div className='ostf-controls col-xs-5'>
                            {!disabledState &&
                        ...
                        <controls.Input
                            ...
                            wrapperClassName='col-xs-4 ostf-controls select-all'
                        />
