...
function($, _, i18n, Backbone, React, models, utils, componentMixins, controls) {
                ...
                <div className='wrapper'>
                    <div>
                        ...
                        <div className='col-xs-12'>
                            ...
                            : !this.state.loaded ?
                                <div className='col-xs-12'><controls.ProgressBar /></div>
                            :
    ...
    var HealthcheckTabContent = React.createClass({
        ...
        render: function() {
            ...
            return (
                <div>
                    <div className='healthcheck-controls'>
                        {!disabledState && !this.state.loadingFailure &&
                            <div className='col-xs-10'>
                                <div className='toggle-credentials col-xs-3 col-xs-offset-8' data-toggle='collapse' data-target='.credentials' onClick={this.toggleCredentials}>
                                    <div className='col-xs-1 btn-link'>
                                        <span
                                    ...
                                    <div className='col-xs-10'>{i18n('cluster_page.healthcheck_tab.provide_credentials')}</div>
                                </div>
                            </div>
                        }
                        {hasRunningTests ?
                            (<button className='btn btn-danger action-btn stop-tests-btn col-xs-1'
                            ...
                            :
                            (<button className='btn btn-success action-btn run-tests-btn col-xs-1'
                    ...
                    <div className='col-xs-12'>
                        ...
                        <HealthcheckCredentials
                            ...
                            disabled={disabledState || hasRunningTests}
                        />
                        <div className='col-xs-12' key='testsets'>
                            <div>
