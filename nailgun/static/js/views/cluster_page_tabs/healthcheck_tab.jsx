...
function (React, models, utils, componentMixins) {
    ...
    var HealthCheckTab = React.createClass({
        ...
        componentDidMount: function() {
            ...
            .fail(_.bind(function() {
                this.errorMessageShouldBeShown = true;
                this.forceUpdate();
            }, this));
        },
        render: function () {
            var errorMessageClasses = 'alert error-message alert-error';
                errorMessageClasses += !!this.errorMessageShouldBeShown ? '' : ' hide';
            return (
                <div className='wrapper'>
                    ...
                    />
                    <div className={errorMessageClasses}>{$.t('cluster_page.healthcheck_tab.not_available_alert')}</div>
                </div>
            );
        }
    });
    ...
    var HealthcheckTabContent = React.createClass({
        mixins: [
            ...
            React.BackboneMixin('cluster', 'change'),
        ...
        stopTests: function() {
            ...
            if (testruns.length) {
                ...
                Backbone.sync('update', testruns)
                    .done(_.bind(this.stopPolling, this))
        ...
        render: function () {
            ...
            var stopTestsClasses = 'btn btn-danger pull-right action-btn stop-tests-btn';
            stopTestsClasses += !hasRunningTests ? ' hide' : '';
            var runTestsClasses = 'btn btn-success pull-right action-btn run-tests-btn';
            runTestsClasses  += hasRunningTests ? ' hide' : '';
