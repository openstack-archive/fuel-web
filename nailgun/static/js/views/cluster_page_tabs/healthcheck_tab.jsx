...
define(
    ...
    function (React, models, utils, componentMixins) {
        ...
        var HealthCheckTab = React.createClass({
            mixins: [componentMixins.pollingMixin(0.1)],
            shouldDataBeFetched: function() {
                return !this.state.ostf.testsets.length;
            },
            fetchData: function() {
                return (
        ...
        var HealthcheckTabContent = React.createClass({
            ...
            fetchData: function() {
                ...
                this.props.testruns = testruns;
                this.props.testruns.add(oldTestruns);
                this.forceUpdate();
