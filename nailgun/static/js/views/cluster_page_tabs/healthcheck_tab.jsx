                ...
                <div className='healthcheck credentials collapse'>
                    <div className='fieldset-group wrapper'>
                        <div className='settings-group' >
                            ...
                            <controls.TextField
                                label={$.t('cluster_page.healthcheck_tab.username_label')}
                                name={'user'}
                                value={this.props.credentials.user.value}
                                onChange={this.handleInputChange}
                                description={$.t('cluster_page.healthcheck_tab.username_description')}
                                cs={{
                            ...
                            <controls.PasswordField
                                label={$.t('cluster_page.healthcheck_tab.password_label')}
                                name={'password'}
                                value={this.props.credentials.password.value}
                                onChange={this.handleInputChange}
                                description={$.t('cluster_page.healthcheck_tab.password_description')}
                                cs={{
                                    label: 'openstack-sub-title parameter-name',
                                    description: 'parameter-description description'
                                }}
                            />
                            <controls.TextField
                                label= {$.t('cluster_page.healthcheck_tab.tenant_label')}
                                name={'tenant'}
                                value={this.props.credentials.tenant.value}
                                onChange={this.handleInputChange}
                                description={$.t('cluster_page.healthcheck_tab.tenant_description')}
                                cs={{
                                    label: 'openstack-sub-title parameter-name',
                                    description: 'parameter-description description'
                                }}
