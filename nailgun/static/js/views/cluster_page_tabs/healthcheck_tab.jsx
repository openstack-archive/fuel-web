                ...
                return (
                    <div className='wrapper'>
                        <div className='row-fluid page-sub-title'>
                            ...
                            <div className='span2 ostf-controls'>
                                <label className='checkbox pull-right select-all'>
                                    <input type='checkbox' className='select-all-tumbler'
                                        disabled={disabledState || hasRunningTests} value=
                                    {this.getNumberOfCheckedTests() ==
                                        this.state.ostf.tests.where({'checked': true}).length} />
                            ...
                            <HealthcheckCredentials visible={this.state.credentialsVisible} />
                        ...
                        <div className='fieldset-group wrapper'>
                            <div className="settings-group" >
                               ...
                               <div className="parameter-box clearfix">
                                 ...
                                 <div className="parameter-control">
                                   <input type="text" name="tenant" className="" />
                                 </div>
                                 <div className="parameter-description description">
                                ...
                                <th className='healthcheck-col-select'>
                                    <div className='custom-tumbler'>
                                        <controls.Checkbox
                                            ...
                                            handleChange={_.bind(this.handleTestSetCheck, this)}
                    ...
                    <td className='healthcheck-col-select'>
                        <div className='custom-tumbler'>
                                <controls.Checkbox
                                    name={test.get('name')}
                                    disabled={this.props.disabled}
                                    handleChange={_.bind(this.handleTestCheck, this)}
                                    cs={{common: 'toggleable'}}
                                    initialState={this.props.test.get('checked')}
                                />
