...
function(React, utils, models, common) {
    ...
    var LogsTab = React.createClass({
        ...
        handleSourceUpdate: function(value) {this.setState({chosenSource: value});},
        handleLevelUpdate: function(value) {this.setState({chosenLevel: value});},
        render: function() {
            ...
            return (
                <div className='wrapper'>
                        ...
                        <div className='filter-bar'>
                            ...
                            <div className='filter-bar-item'>
                                 <button 
                                    ...
                                    disabled={this.state.chosenSource ? '' : 'disabled'}>
                    ...
                    {this.state.logEntries &&
                        <LogsTable logEntries={this.state.logEntries} logEntriesHasMore={this.state.logEntriesHasMore} />
                    }
                </div>
            );
        }
    ...
    var LogsTable = React.createClass({
        render: function() {
            ...
            if (logEntries && logEntries.length) {
                tabRows = logEntries.map(function(entry){
                          ...
                          <tr>
                            <td colSpan='3'>
                                <span>{$.t('cluster_page.logs_tab.bottom_text')}
                                    ...
                                    return <span className='show-more-entries'> {count} </span>
                                })}
