...
function(React, utils, models, componentMixins, controls) {
    ...
    var LogFilterBar = React.createClass({
        getInitialState: function() {
            var options = this.props.tabOptions[0] ? utils.deserializeTabOptions(this.props.tabOptions.join('/')) : this.props.cluster.get('log_options') ? this.props.cluster.get('log_options') : {};
            return {
