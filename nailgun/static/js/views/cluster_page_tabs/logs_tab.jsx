...
function($, _, i18n, React, utils, models, componentMixins, controls) {
    ...
    var LogFilterBar = React.createClass({
        ...
        render: function() {
            var is_remote = this.state.chosenType == 'remote';
            return (
                <div className='row'>
                    <div className='sticker'>
                        {this.renderTypeSelect()}
                        {is_remote && this.renderNodeSelect()}
                        {this.renderSourceSelect()}
                        {this.renderLevelSelect()}
                        {this.renderFilterButton(is_remote)}
                    </div>
        ...
        renderFilterButton: function(is_remote) {
            return <div className={'form-group ' + (is_remote ? 'col-lg-4 col-md-4 col-sm-12' : 'col-lg-6 col-md-6 col-sm-3')}>
                <label />
                <button
