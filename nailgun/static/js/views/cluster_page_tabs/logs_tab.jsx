        ...
        render: function() {
            ...
            return logsEntries.length ?
                <table className='table log-entries'>
                    <thead>
                        <tr>
                            <th class='col-date'>{i18n('cluster_page.logs_tab.date')}</th>
                            <th class='col-level'>{i18n('cluster_page.logs_tab.level')}</th>
                            <th class='col-message'>{i18n('cluster_page.logs_tab.message')}</th>
                        </tr>
                    </thead>
                    <tbody>
                        {tabRows}
