...
function($, _, i18n, Backbone, React, models, utils, componentMixins, controls) {
    ...
    var NetworkModelManipulationMixin = {
        setValue: function(options, attribute, value) {
    ...
    var Range = React.createClass({
        ...
        onRangeChange: function(hasManyRanges, rowIndex, attribute, name, newValue) {
            ...
            this.setValue({isInteger: this.props.integerValue}, attribute, valuesToSet);
        },
    ...
    var VlanTagInput = React.createClass({
        ...
        onInputChange: function(attribute, value) {
            this.setValue({isInteger: true}, attribute, value);
        },
        render: function() {
            return (
