...
function($, _, i18n, Backbone, React, models, dispatcher, utils, componentMixins, controls) {
    ...
    var NetworkTab = React.createClass({
        mixins: [
            ...
            componentMixins.dispatcherMixin('hideNetworkVerificationResult', 'hideNetworkVerificationResult'),
            componentMixins.dispatcherMixin('showNetworkVerificationResult', 'showNetworkVerificationResult')
        ],
        getInitialState: function() {
            return {
                loading: true,
        ...
        hideNetworkVerificationResult: function() {
            this.setState({hideVerificationResult: true});
        },
        showNetworkVerificationResult: function() {
    ...
    var NetworkTabContent = React.createClass({
        ...
        startVerification: function() {
            ...
            dispatcher.trigger('showNetworkVerificationResult');
            task.save({}, options)
                .fail(function() {
