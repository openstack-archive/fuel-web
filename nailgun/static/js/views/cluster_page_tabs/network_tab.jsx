    ...
    function(React, models, utils, componentMixins, controls) {
        ...
        var NetworkMixin = {
            ...
            getParameterError: function(errors, attribute) {
                if (errors && _.contains(attribute, 'start')) {
                    ...
                    return _.isEmpty(compactErrors) ? undefined : compactErrors;
                }
        ...
        var Range = React.createClass({
            ...
            render: function() {
                var currentError = {},
                    ...
                    ranges = this.props.autoIncreaseWith ? [attribute, attribute + this.props.autoIncreaseWith - 1] : attribute,
                    wrapperClasses = {
        ...
        var NetworkTab = React.createClass({
            mixins: [
                ...
                React.BackboneMixin({
                    modelOrCollection: function(props) {
                        props.model.get('networkConfiguration').get('networks');
                    },
                    renderOn: 'change'
                }),
                React.BackboneMixin({
