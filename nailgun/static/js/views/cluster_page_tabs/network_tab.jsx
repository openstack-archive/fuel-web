...
function($, _, i18n, Backbone, React, models, utils, componentMixins, controls) {
    ...
    var NetworkTab  = React.createClass({
        ...
        componentWillReceiveProps: function(options) {
            this.props.networkConfiguration = options.cluster.get('networkConfiguration');
        },
        getInitialState: function() {
            return {
                loading: true
        ...
        componentDidMount: function() {
            ...
            $.when(this.props.cluster.get('settings').fetch({cache: true}), networkConfiguration.fetch({cache: true})).done(_.bind(function() {
                this.initialConfiguration = _.cloneDeep(this.props.cluster.get('networkConfiguration').toJSON());
