    ...
    function(React, models, utils, componentMixins, controls) {
        ...
        var Range = React.createClass({
            ...
            render: function() {
                var currentError = {},
                    ...
                    ranges = _.isNumber(this.props.autoIncreaseWith) ?
        ...
        var NetworkTab = React.createClass({
            ...
            loadInitialConfiguration: function() {
                ...
                networkConfiguration.get('networks').reset(_.cloneDeep(this.initialConfiguration.networks));
                networkConfiguration.get('networking_parameters').set(_.cloneDeep(this.initialConfiguration.networking_parameters));
            },

            updateInitialConfiguration: function() {
                this.initialConfiguration = _.cloneDeep(this.props.model.get('networkConfiguration').toJSON());
            },
            ...
            hasChanges: function() {
                return !_.isEqual(this.initialConfiguration, this.props.model.get('networkConfiguration').toJSON());
            },
                                    ...
                                    {(manager == 'VlanManager') ?
                                        <div>
                                            ...
                                            <Range
                                                ...
                                                disabled={this.props.disabled}
                                                autoIncreaseWith={this.props.model.get('fixed_networks_amount') || 0}
                                                networkConfiguration={this.props.networkConfiguration}
                                            />
                                        </div>
                                    :
