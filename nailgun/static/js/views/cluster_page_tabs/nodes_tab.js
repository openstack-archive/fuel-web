    ...
    AssignRolesPanel = Backbone.View.extend({
        ...
        checkRolesAvailability: function() {
            this.collection.each(function(role) {
                ...
                // FIXME(vk): hack for vCenter, has to be removed when we describe it in role metadata
                if (role.get('name') == 'compute' && this.settings.get('common.libvirt_type.value') == 'vcenter') {
                    unavailable = true;
