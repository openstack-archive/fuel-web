        ...
        stickitRole: function (role) {
            ...
            bindings['.role-conflict.' + role.get('name')] = {
                ...
                attributes: [{
                   ...
                   stickitChange: role,
                   onGet: _.bind(function(value, options) {
                       var roleName = options.stickitChange.get('name');
                       if (value && (roleName == "controller")) {
                           $('.role-conflict.' + roleName).text($.t('cluster_page.nodes_tab.max_controllers_in_ha_mode_restriction', {count: this.maxAvailableControllersCountInHA}));
                       }
                   }, this)
                }]
            };
