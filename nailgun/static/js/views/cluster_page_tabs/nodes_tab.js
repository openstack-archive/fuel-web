...
function(utils, models, commonViews, dialogViews, nodesManagementPanelTemplate, assignRolesPanelTemplate, nodeListTemplate, nodeGroupTemplate, nodeTemplate, editNodeDisksScreenTemplate, nodeDisksTemplate, volumeStylesTemplate, editNodeInterfacesScreenTemplate, nodeInterfaceTemplate) {
    ...
    NodeListScreen = Screen.extend({
        ...
        updateBatchActionsButtons: function() {
            ...
            this.editRolesHref.set('link', '#cluster/' + this.model.id + '/nodes/edit/' + utils.serializeTabOptions({nodes: _.pluck(notDeployedSelectedNodes, 'id')}));
        ...
        setupButtonsBindings: function() {
            ...
            this.stickit(this.addNodesButton, {'.btn-add-nodes' : visibleBindings});
            this.stickit(this.deleteNodesButton, {'.btn-delete-nodes': visibleBindings});
            this.stickit(this.editRolesButton, {'.btn-edit-nodes': visibleBindings});
            ...
            this.stickit(this.editRolesHref, {'.btn-edit-nodes': {
                attributes: [{
                    name: 'href',
                    observe: 'link',
                    onGet: function(value) {
        ...
        initialize: function() {
            ...
            this.editRolesHref = new Backbone.Model({
               'link': ''
            });
        },
        render: function() {
    ...
    NodeDisk = Backbone.View.extend({
        ...
        diskFormBindings: {
            '.disk-form': {
                observe: 'visible',
                visible: true,
                visibleFn: function($el, visible, options) {
                    $el.collapse(visible ? 'show' : 'hide');
                }
            }
        },
