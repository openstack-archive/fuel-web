        ...
        stickitRole: function (role) {
            ...
            bindings['.role-conflict.' + role.get('name')] = {
                ...
                onGet: _.bind(function(value, options) {
                    return value ? this.isControllerSelectable(options.stickitChange) ? $.t('cluster_page.nodes_tab.one_controller_restriction') : $.t('cluster_page.nodes_tab.incompatible_roles_warning') : '';
                }, this)
            };
