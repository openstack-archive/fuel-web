    ...
    NodeDisk = Backbone.View.extend({
        ...
        checkForGroupsDeletionAvailability: function() {
            this.disk.get('volumes').each(function(volume) {
                ...
                this.$('.disk-visual .' + name + ' .close-btn').toggle(!this.screen.isLocked() && this.disk.get('visible') && volume.getMinimalSize(this.getVolumeMinimum(name)) <= 0);
            }, this);
        },
        updateDisk: function() {
        ...
        initialize: function(options) {
            ...
            this.disk.on('change:visible', this.checkForGroupsDeletionAvailability, this);
        ...
        setupVolumesBindings: function() {
            this.disk.get('volumes').each(function(volume) {
                ...
                bindings['input[name=' + volume.get('name') + ']'] = {
                    ...
                    setOptions: {
                        validate: true,
                        minimum: this.getVolumeMinimum(volume.get('name'))
                    }
                };
        ...
        render: function() {
            ...
            this.stickit(this.disk, this.diskBindings);
