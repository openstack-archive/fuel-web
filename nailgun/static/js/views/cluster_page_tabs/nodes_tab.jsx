...
function($, _, React, BackboneViewWrapper, ClusterNodesScreen, AddNodesScreen, EditNodesScreen, EditNodeDisksScreen, EditNodeInterfacesScreen) {
    ...
    var NodesTab = React.createClass({
        ...
        changeScreen: function(newProps) {
            var newScreen = newProps.tabOptions[0] || 'list',
                NewScreenView = this.getAvailableScreens()[newScreen];
            if (!NewScreenView) return;
            var screenOptions = newProps.tabOptions.slice(1),
                options = {cluster: newProps.cluster, screenOptions: screenOptions};
        ...
        componentWillReceiveProps: function(newProps) {
            this.checkScreen(newProps);
            this.changeScreen(newProps);
        },
        render: function() {
