    ...
    var NodesTab = React.createClass({
        getInitialState: function() {
            return {
                ...
                screenOprions: this.props.tabOptions.slice(1)
            };
        },
        hasChanges: function() {
        ...
        routeScreen: function(options) {
            this.setState({
                screen: options[0] || 'list',
                screenOprions: options.slice(1)
            });
        },
        render: function() {
            var Screen = {
                ...
                screenView = <Screen ref='screen' key={'screen' + this.state.screen} cluster={this.props.cluster} screenOptions={this.state.screenOprions} />;
            return (
