    ...
    EditNodeInterfacesScreen = EditNodeScreen.extend({
            ...
            this.interfaces.fetch({url: _.result(this.nodes.at(0), 'url') + '/interfaces/default_assignment', reset: true})
                .fail(_.bind(function() {
                    utils.showErrorDialog({
                        title: i18n.t('cluster_page.nodes_tab.configure_interfaces.configuration_error.title'),
                        message: i18n.t('cluster_page.nodes_tab.configure_interfaces.configuration_error.load_defaults_warning')
                    });
                }, this));
        },
        ...
        applyChanges: function() {
            ...
            .fail(function() {
                utils.showErrorDialog({
                    title: i18n.t('cluster_page.nodes_tab.configure_interfaces.configuration_error.title'),
                    message: i18n.t('cluster_page.nodes_tab.configure_interfaces.configuration_error.saving_warning')
                });
            });
        },
        initialize: function() {
                ...
                selectOptions: {
                    collection: function() {
                        return _.map(models.Interface.prototype.bondingModes, function(mode) {
                            return {value: mode, label: i18n.t('cluster_page.nodes_tab.configure_interfaces.bonding_modes.' + mode, {defaultValue: mode})};
                        });
                    }
                }
            }
