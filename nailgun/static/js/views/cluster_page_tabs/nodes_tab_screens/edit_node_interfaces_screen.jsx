...
function($, _, Backbone, React, i18n, utils, models, dispatcher, dialogs, controls, ComponentMixins) {
    ...
    NodeInterface = React.createClass({
        ...
        componentDidMount: function() {
            $(this.refs['ifc-networks'].getDOMNode()).sortable({
        ...
        dragStart: function(e, ui) {
            ...
            if (e.type == 'sortremove') {
                $(this.refs['ifc-networks'].getDOMNode()).sortable('cancel');
        ...
        render: function() {
            ...
            return (
                <div className='ifc-container clearfix'>
                    <div className={utils.classNames({'ifc-inner-container col-xs-12 clearfix': true, nodrag: this.props.errors})}>
                        ...
                        <div className='networks-block col-xs-12 row'>
                            ...
                            <div className='ifc-networks col-xs-8 clearfix' ref='ifc-networks'>
                    ...
                    {this.props.errors &&
                        <div className='ifc-error col-xs-12'>{this.props.errors}</div>
                    }
                </div>
            );
        }
