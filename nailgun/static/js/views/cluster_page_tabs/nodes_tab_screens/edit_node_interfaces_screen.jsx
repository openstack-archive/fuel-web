...
function($, _, Backbone, React, i18n, utils, models, controls, ComponentMixins) {
    ...
    var cx = React.addons.classSet,
        ScreenMixin, EditNodeInterfacesScreen, NodeInterface, fetchData;
    ...
    EditNodeInterfacesScreen = React.createClass({
        mixins: [
            ...
            ComponentMixins.backboneMixin('model', 'change:status change:networkConfiguration change:nodes sync'),
    ...
    return {
        screen: EditNodeInterfacesScreen,
        fetchData: fetchData
    };
});
