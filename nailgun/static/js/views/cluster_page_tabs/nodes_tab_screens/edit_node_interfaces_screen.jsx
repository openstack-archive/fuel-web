...
function($, _, Backbone, React, i18n, utils, models, controls, ComponentMixins) {
    ...
    NodeInterface = React.createClass({
        ...
        dragStart: function(e, ui) {
            ...
            console.log('dragStart', e.type, this.props.interface.get('name'), this.props.interface.get('assigned_networks').pluck('name'));
        },
        dragStop: function(e) {
            ...
            console.log('dragStop', e.type, this.props.interface.get('name'), this.props.interface.get('assigned_networks').pluck('name'));
        },
        ...
        render: function() {
            ...
            console.log('rendering', ifc.get('name'), assignedNetworks.pluck('name'));
