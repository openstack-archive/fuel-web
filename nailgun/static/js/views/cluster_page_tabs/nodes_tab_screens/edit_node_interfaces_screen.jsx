...
function($, _, Backbone, React, i18n, utils, models, controls, ComponentMixins) {
    ...
    EditNodeInterfacesScreen = React.createClass({
        ...
        componentWillMount: function() {
            ...
            $.when.apply($, this.nodes.map(function(node) {
                ...
                .done(_.bind(function() {
                    ...
                    this.interfaces.set(_.cloneDeep(this.nodes.at(0).interfaces.toJSON()), {parse: true});
        ...
        setInterfacesEvents: function() {
            this.interfaces.on('change:checked change:slaves reset sync', function() { this.forceUpdate(); }, this);
        },
        ...
        bondInterfaces: function() {
            ...
            var bonds = this.interfaces.find(function(ifc) {return ifc.get('checked') && ifc.isBond();});
            if (!bonds) {
                ...
                this.interfaces.remove(bonds, {silent: true});
            }
        ...
        render: function() {
            ...
            var configureInterfacesTransNS = 'cluster_page.nodes_tab.configure_interfaces.',
                ...
                isEnabled = !this.state.loading && !this.state.actionInProgress,
                returnEnabled = isEnabled,
                loadDefaultsEnabled = isEnabled,
                revertChangesEnabled = isEnabled && hasChanges,
                applyEnabled = !hasErrors && isEnabled && hasChanges;
