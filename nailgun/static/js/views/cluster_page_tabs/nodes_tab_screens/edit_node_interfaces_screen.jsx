...
function($, _, React, utils, models, dialogs, controls) {
    ...
    var NodeInterfaces = React.createClass({
        ...
        propTypes: {
            ...
            bondingChanged: React.PropTypes.func,
        ...
        render: function() {
            ...
            var selectOptions = _.map(models.Interface.prototype.bondingModes, function(mode) {
            ...
            var assignedNetworks = this.props.interface.get('assigned_networks');
            var bondable = this.props.bondingAvailable && assignedNetworks && !assignedNetworks.find(function(interfaceNetwork) {
                        ...
                        { this.props.interface.isBond() ?
                            <div className="network-box-name">
                                        ...
                                        <label>
                                            <div className="pull-left">
                                                <div className="custom-tumbler network-bond-name-checkbox">
                                                    <input type="checkbox" onChange={this.bondingChanged} />
                                ...
                                <div className="network-bond-mode pull-right">
                                    ...
                                    <span>
                                        <select name="mode" value={this.props.interface.get('mode')} disabled={this.props.bondingAvailable ? '' : 'disabled'} onChange={this.bondingModeChanged}>
    ...
    var EditNodeInterfacesScreen = React.createClass({
        ...
        applyChanges: function() {
             ...
             */
            this.setState({loading: true});
            return $.when(Backbone.sync('update', node.interfaces, {url: _.result(node, 'url') + '/interfaces'}))
                                    ...
                                    if (!_.contains(slaveInterfaceNames, ifc.get('name'))) {
                                        return this.transferPropsTo(
                                                <NodeInterfaces
                                                    ...
                                                    bondingChanged={this.bondingChanged}
