...
function($, _, Backbone, React, i18n, utils, models, dispatcher, dialogs, controls, ComponentMixins) {
    ...
    NodeInterface = React.createClass({
        ...
        render: function() {
            ...
            return (
                <div className='ifc-container clearfix'>
                    <div className={utils.classNames({'ifc-inner-container col-xs-12': true, nodrag: this.props.errors})}>

                        {ifc.isBond() &&
                            <div className='bond-properties col-xs-12 forms-box clearfix'>
                        ...
                        <div className='networks-block col-xs-12 row'>
                            <div className='col-xs-1 ifc-checkbox'>
                                {!ifc.isBond() && bondable &&
                                    <controls.Input
                                        type='checkbox'
                                        onChange={this.bondingChanged}
                            ...
                            <div className='col-xs-3'>
                                {_.map(slaveInterfaces, function(slaveInterface, index) {
                                    ...
                                    return (
                                        <div key={'info-' + ifcName} className='ifc-info-block'>
                                            <div className='ifc-connection pull-left'>
                                                <div className={utils.classNames(slaveOnlineClass(slaveInterface))} />
                            ...
                            <div className='col-xs-8 clearfix' ref='logicalNetworkBox'>
                                {assignedNetworks.length ?
                                    _.map(assignedNetworksGrouped, function(networkGroup) {
                                        ...
                                        return _.map(networkGroup, function(interfaceNetwork) {
                                            var networkName = interfaceNetwork.get('name');
                                            return (
                                                <div key={'network-' + networkName} className={utils.classNames(classes)} data-name={networkName}>
                        ...
                        {interfaceProperties &&
                            <div className='ifc-properties col-xs-12 forms-box clearfix'>
                                <controls.Input
                                    type='checkbox'
                    ...
                    {this.props.errors &&
                        <div className='ifc-error col-xs-12'>ewrfew{this.props.errors}</div>
                    }
                </div>
            );
        }
