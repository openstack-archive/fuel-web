...
function($, _, React, utils, models, dialogs, controls) {
    ...
    var NodeInterfaces = React.createClass({
        ...
        validate: function() {
            var validationResult = this.props.interface.validate();
        ...
        render: function() {
            ...
            var movable = this.props.bondingAvailable && !cluster.get('assigned_networks').find(function(interfaceNetwork) {return interfaceNetwork.getFullNetwork().get('meta').unmovable;});
    ...
    var EditNodeInterfacesScreen = React.createClass({
        ...
        render: function() {
            ...
            revertChangesEnabled = !this.state.loading;
            applyEnabled = !hasErrors && !this.state.loading;
