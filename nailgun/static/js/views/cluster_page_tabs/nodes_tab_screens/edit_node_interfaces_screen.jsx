...
function($, _, Backbone, React, i18n, utils, models, controls) {
    ...
    var EditNodeInterfacesScreen = React.createClass({
        ...
        setInitialData: function() {
            this.initialInterfaces = this.interfaces.toJSON();
        },
        hasChanges: function() {
            return !_.isEqual(this.initialInterfaces, this.interfaces.toJSON());
        },
        ...
        applyChanges: function() {
            ...
            this.setState({loading: true});
            return $.when.apply($, nodes.map(function(node, idx) {
