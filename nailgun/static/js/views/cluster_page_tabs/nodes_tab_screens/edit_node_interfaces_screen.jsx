...
function($, _, React, utils, models, dialogs, controls) {
    ...
    var NodeInterfaces = React.createClass({
        ...
        render: function() {
            ...
            var bondingAvailable = this.props.bondingAvailable;
            var movable = bondingAvailable && !cluster.get('assigned_networks').find(function(interfaceNetwork) {return getFullNetwork(interfaceNetwork).get('meta').unmovable;});
            ...
            var showHelpMessage = this.state.showHelpMessage;
                ...
                <div className="physical-network-box" data-name="{this.props.interface.get('name')}">
                    <div className="network-box-item">
                        ...
                        <div className="logical-network-box">
                            ...
                            { showHelpMessage ?
                                <div class="network-help-message">{$.t("cluster_page.nodes_tab.configure_interfaces.drag_and_drop_description")}</div>
                            : null
                            }
                        </div>
