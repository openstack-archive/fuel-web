...
function(React, utils, models, controls, dialogs, componentMixins) {
    ...
    NodeListScreen = React.createClass({
        ...
        changeFilter: _.debounce(function(value) {
            this.setState({filter: value, filtering: false});
        }, 200),
                ...
                <div className='node-management-panel'>
                    ...
                    <div className='node-filter'>
                        <controls.Input
                            ...
                            onChange={this.props.startFiltering}
                        />
                        {(this.props.filtering || !!this.props.filter) &&
                            <button className='close btn-clear-filter' onClick={this.props.clearFilter} >&times;</button>
                        }
                    </div>
