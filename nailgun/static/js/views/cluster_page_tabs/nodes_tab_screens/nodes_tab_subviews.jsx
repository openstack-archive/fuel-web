                    ...
                    {roles.map(function(role) {
                        ...
                        if (!role.checkRestrictions(configModels, 'hide').result) {
                            var restrictionsCheck = role.checkRestrictions(configModels, 'disable'),
                                ...
                                warning = (restrictionsCheck.warnings && restrictionsCheck.warnings.join(' ')) || (_.contains(conflicts, name) ? $.t(ns + 'role_conflict') : !isAvailable ? $.t('cluster_page.nodes_tab.' + name + '_restriction') : null);
                            return (
                                <controls.Input
                                    key={name}
                                    ref={name}
