...
function(utils, models, commonViews, dialogViews, settingsTabTemplate, settingsGroupTemplate) {
    ...
    SettingsTab = commonViews.Tab.extend({
        ...
        setInitialData: function() {
            this.previousSettings = _.cloneDeep(this.settings.attributes);
            this.settings.set(this.previousSettings);
        },
        ...
        initialize: function(options) {
            ...
            if (!this.model.get('settings')) {
                ...
                this.model.set({settings: this.settings}, {silent: true});
                this.settings.url = _.result(this.model, 'url') + '/attributes';
                this.loading = this.settings.fetch().done(_.bind(function() {
                    this.setInitialData();
                    this.render();
                }, this));
            } else {
