...
function(utils, models, viewMixins, commonViews, dialogViews, settingsTabTemplate, settingsGroupTemplate) {
    ...
    SettingsTab = commonViews.Tab.extend({
        ...
        hasChanges: function() {
            return !_.isEqual(this.settings.toJSON().editable, this.settings.get('initialAttributes'));
        },
        events: {
        ...
        updateInitialSettings: function() {
            this.settings.set('initialAttributes', _.omit(this.settings.attributes, 'initialAttributes'));
        },
        loadInitialSettings: function() {
            this.settings.set(this.settings.get('initialAttributes'));
        },
        ...
        checkChangedDependentSettings: function(groupName, settingName) {
            ...
            var result = _.any(this.settings.attributes, function(group, groupName) {
                if (groupName == 'initialAttributes' || !group.metadata.visible) { return false; }
        ...
        initialize: function(options) {
            ...
            this.settings.set('initialAttributes', _.cloneDeep(this.model.get('settings').attributes));
