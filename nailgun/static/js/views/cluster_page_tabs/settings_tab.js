...
function(utils, models, viewMixins, commonViews, dialogViews, settingsTabTemplate, settingsGroupTemplate) {
    ...
    SettingsTab = commonViews.Tab.extend({
        ...
        loadInitialSettings: function() {
            var initialAttributes = _.cloneDeep(this.settings.initialAttributes);
            this.expandRestrictions(initialAttributes);
            this.settings.set(initialAttributes);
        },
        ...
        expandRestrictions: function(attributes) {
            attributes = attributes || this.settings.attributes;
