        ...
        checkDependentSettings: function(path) {
            ...
            _.each(this.settings.attributes, function(group, groupName) {
                ...
                _.each(group, function(setting, settingName) {
                    ...
                    if (activeOption) pathToCheck = this.settings.makePath(pathToCheck, setting.value);
                    var value = settingName == 'metadata' ? 'enabled' : 'value';
                    if (setting[value] == true || activeOption) dependentSettings[setting.label] = _.union(dependentSettings[setting.label], getDependentRestrictions(pathToCheck));
                }, this);
            }, this);
