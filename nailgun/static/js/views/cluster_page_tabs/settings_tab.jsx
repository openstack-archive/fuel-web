...
function($, _, i18n, React, utils, models, Expression, controls) {
    ...
    var dependenciesMixin = {
        ...
        processRestrictions: function(path) {
            ...
            if (dependentRoles.length) messages.push(i18n.t('cluster_page.settings_tab.dependent_role_warning', {roles: dependentRoles.join(', '), count: dependentRoles.length}));
            if (dependentSettings.length) messages.push(i18n.t('cluster_page.settings_tab.dependent_settings_warning', {settings: dependentSettings.join(', '), count: dependentSettings.length}));
            return {
                ...
                deferred
                    ...
                    .fail(function() {
                        utils.showErrorDialog({
                            title: i18n.t('cluster_page.settings_tab.settings_error.title'),
                            message: i18n.t('cluster_page.settings_tab.settings_error.saving_warning')
                        });
                    });
            }
            return deferred;
            ...
            if (deferred) {
                ...
                deferred
                    ...
                    .fail(function() {
                        utils.showErrorDialog({
                            title: i18n.t('cluster_page.settings_tab.settings_error.title'),
                            message: i18n.t('cluster_page.settings_tab.settings_error.load_defaults_warning')
                        });
                    });
            }
        },
        ...
        render: function() {
            ...
            return (
                <div className={React.addons.classSet({'openstack-settings wrapper': true, 'changes-locked': locked})}>
                    <h3>{i18n.t('cluster_page.settings_tab.title')}</h3>
                    {this.state.loading ?
                                ...
                                <div className='page-control-box'>
                                    <div className='page-control-button-placeholder'>
                                        ...
                                        <button key='applyChanges' className='btn btn-success btn-apply-changes' onClick={this.applyChanges} disabled={locked || !hasChanges || this.settings.validationError}>
                                            {i18n.t('common.save_settings_button')}
                                        </button>
                                    </div>
                                </div>
                            </div>
