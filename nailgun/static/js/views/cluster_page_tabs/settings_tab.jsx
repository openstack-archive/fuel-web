                                ...
                                if (!this.checkRestrictions('hide', path).result) {
                                    ...
                                    return this.transferPropsTo(
                                        <SettingGroup
                                            ...
                                            warnings={processedRestrictions.warnings && processedRestrictions.warnings.join(' ')}
                                        />
                                    );
                                }
                            }, this)}
                                    ...
                                    var values = _.chain(_.cloneDeep(setting.values))
                                        .map(function(value) {
                                            ...
                                            if (!this.checkRestrictions('hide', valuePath).result) {
                                                ...
                                                value.tooltipText = processedValueRestrictions.warnings && processedValueRestrictions.warnings.join(' ');
                                                return value;
                                            }
                                        }, this)
                                        .compact()
