                    ...
                    <div className='row'>
                        <div className='col-xs-12 col-md-9'>
                            <div className='page-title'>
                                <div className='title'>{i18n('clusters_page.title')}</div>
                            </div>
                        </div>
                    </div>
        ...
        render: function() {
            ...
            return (
                <div className='col-xs-3'>
                    {/* TODO: implement 'disabled-cluster' style */}
                    <a className={utils.classNames({clusterbox: true, 'disabled-cluster': !!deletionTask})} href={!deletionTask ? '#cluster/' + cluster.id + '/nodes' : 'javascript:void 0'}>
                        ...
                        <div className='status text-blue'>
                            {deploymentTask ?
                                <div class="progress">
                                    {/* TODO(vkramskikh): implement progress bar colors */}
                                    <div class="progress-bar" style={{width: (deploymentTask.get('progress') > 3 ? deploymentTask.get('progress') : 3) + '%'}}></div>
                                </div>
                            :
