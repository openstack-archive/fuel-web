...
define(['jquery', 'underscore', 'react'], function($, _, React) {
    ...
    var InputMixin = {
        ...
        getInitialState: function() {
            ...
            return {value: radioButton ? radioButton.data : this.props.value};
        },
        getError: function() {
        ...
        onChange: function() {
            ...
            if (_.contains(['text', 'password'], input.type)) this.delayedModelUpdate(value); else this.updateModel(value);
        },
        delayedModelUpdate: _.debounce(function(value) {
        ...
        renderLabel: function() {
            var radioButton = this.isRadioButton(),
                labelClass = this.props.cs.label + (this.props.type == 'radio' && !radioButton ? '' : ' parameter-name');
            return (
    ...
    controls.PasswordField = React.createClass({
        ...
        render: function() {
            var type = this.state.visible ? 'text' : 'password';
            return (
                <div className={this.props.cs.common + ' parameter-box clearfix'}>
                    {this.renderLabel()}
