                ...
                <div>
                    ...
                    {this.state.confirmation &&
                        <div className='confirm-deletion-form'>
                            {i18n('dialog.remove_cluster.enter_environment_name')}
                            <controls.Input
                                type='text'
                                disabled={this.state.actionInProgress}
                                onChange={_.bind(function(name, value) {
                                    this.setState({
                                        confirmationError: value != this.props.cluster.get('name')
                                    });
                                }, this)}
                            />
                        </div>
        ...
        renderFooter: function() {
            return ([
                ...
                <button
                    ...
                    onClick={this.state.confirmation || !this.props.cluster.get('nodes').length ? this.removeCluster : this.showConfirmationForm}
                >
