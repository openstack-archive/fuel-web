    ...
    dialogs.UploadISODialog = React.createClass({
        ...
        renderBody: function() {
            ...
            return (
                <div className='upload-iso-dialog'>
                    ...
                    {this.state.request ?
                        <controls.ProgressBar progress={this.state.progressAvailable && this.state.progress || null} />
                    :
        ...
        renderFooter: function() {
            ...
            if (this.state.request) {
                ...
                button = <button key='upload' className='btn btn-success' onClick={this.uploadISO}>{i18n('dialog.upload_iso.upload_button')}</button>;
            }
            buttons.push(button);
            return buttons;
        }
