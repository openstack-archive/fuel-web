...
function($, _, i18n, Backbone, React, utils, models, dispatcher, controls) {
    ...
    dialogs.ForgetNodeConfirmDialog = React.createClass({
        mixins: [dialogMixin],
        ...
        renderFooter: function() {
            return [
                <button key='stay' className='btn btn-return' onClick={this.close}>{i18n('dialog.remove_node.cancel_button')}</button>,
