...
function($, _, i18n, Backbone, React, utils, models, controls) {
    ...
    dialogs.UploadISODialog = React.createClass({
        ...
        componentWillUnmount: function() {
            // FIXME(ja): exception is raised here when upload request failed
        ...
        uploadISO: function() {
            ...
            if (file) {
                ...
                var request = (new models.Task()).save({}, {
                ...
                request.fail(_.bind(function() {
                    ...
                    this.close();
                // FIXME(ja): request returns 202 Accepted but fail callback triggered
