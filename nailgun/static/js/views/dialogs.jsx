...
function($, _, i18n, Backbone, React, utils, models, dispatcher, controls, componentMixins) {
    ...
    dialogs.ShowNodeInfoDialog = React.createClass({
        ...
        getInitialState: function() {
            return {
                title: this.getNodeName() || i18n('dialog.show_node.default_dialog_title')
            };
        },
        ...
        getNodeName: function() {
            return this.props.node && this.props.node.get('name');
        },
        toggle: function(groupIndex) {
            $(this.refs['togglable_' + groupIndex].getDOMNode())
