...
function($, _, i18n, i18next, Backbone, React, utils, models, componentMixins, dialogs) {
                        ...
                        <nav className='navbar navbar-default' role='navigation'>
                            <div className='container-fluid'>
                                ...
                                <ul className='nav navbar-icons navbar-right'>
                                    ...
                                    <li className={'usage-icon ' + (this.props.statistics.get('unallocated') ? '' : 'no-unallocated')}>
    ...
    var NotificationsPopover = React.createClass({
        ...
        renderNotification: function(notification) {
            ...
            return (
                <div className={'notification ' + utils.classNames(notificationClasses)} onClick={this.onNotificationClick}>
            ...
            return (
                <div
                    ...
                    className={utils.classNames({new: unread, clickable: nodeId}) + ' ' + notification.get('topic')}
                    ...
                    <div className='popover-content'>
                        {_.map(notifications, function(notification, index) {
                            return [
                                ...
                                (showMore || index < (notifications.length - 1)) && <hr key={'divider' + notification.id} />
                            ];
                        }, this)}
                    </div>
                </div>
