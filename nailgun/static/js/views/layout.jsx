...
function(React, utils, models, componentMixins, dialogViews) {
            ...
            return (
                <div>
                    ...
                    <div className="notification-wrapper">
                        {this.state.popoverVisible && <NotificationsPopover ref="popover" notifications={this.props.notifications} displayCount={this.props.notificationsDisplayCount} />}
                    </div>
                </div>
            );
        }
    ...
    var NotificationsPopover = React.createClass({
        ...
        toggle: function(visible) {
            this._owner.togglePopover(visible);
        },
