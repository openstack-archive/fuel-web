                ...
                <form className='form-horizontal' onSubmit={this.onSubmit}>
                    <div className='form-group'>
                        ...
                        <div className='col-xs-8'>
                            <input className='form-control' type='text' name='username' ref='username' placeholder={i18n('login_page.username')} onChange={this.onChange} />
                        </div>
                    </div>
                    <div className='form-group'>
                        <label className='control-label col-xs-2'>
                        ...
                        <div className='col-xs-8'>
                            <input className='form-control' type='password' name='password' ref='password' placeholder={i18n('login_page.password')} onChange={this.onChange} />
                        </div>
                    </div>
                    {this.state.hasError &&
                        <p className='text-center text-red'>{i18n('login_page.login_error')}</p>
                    }
                    <div className='form-group'>
