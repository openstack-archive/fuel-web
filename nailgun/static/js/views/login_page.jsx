...
function($, React, controls) {
    ...
    LoginMixin = {
        ...
        toggleElements: function(state) {
            this.props.app.footer.setState({hidden: !state});
            this.props.app.breadcrumbs.setState({hidden: !state});
            this.props.app.navbar.setState({hidden: !state});
        }
    };
                ...
                <div className="login-placeholder">
                    <div className="login-box">
                        ...
                        <div className="login-fields-box">
                            {this.transferPropsTo(<LoginForm />)}
                        </div>
                    </div>
        ...
        render: function() {
            ...
            return (
                <div className="login-copyrights">
                    ...
                    <p className="text-center">{$.t('common.version')}: {release}</p>
                </div>
            );
        }
    });
