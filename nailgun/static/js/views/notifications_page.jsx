...
function(React, utils, models, dialogViews) {
    ...
    Notification = React.createClass({
        ...
        render: function() {
            var notification = this.props.notification,
                notificationClass = notification.get('topic') + ' ' + notification.get('status') + ' ' + (notification.get('node_id') ? 'clickable' : ''),
                iconClass = {'error': 'icon-attention', 'discover': 'icon-bell'}[notification.get('topic')] || 'icon-info-circled';
            return (
