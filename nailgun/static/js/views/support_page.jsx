...
function(React, componentMixins, models) {
                ...
                <div>
                    ...
                    <div className='support-page page-wrapper'>
                        {_.contains(app.version.get('feature_groups'), 'mirantis') &&
                            <div>
                                <RegistrationLink fuelKey={new models.FuelKey()}/><hr/>
                                <SupportContacts/><hr/>
                            </div>
                        }
                        <DiagnosticSnapshot tasks={this.props.tasks} task={this.props.tasks.findTask({name: 'dump'})} /><hr/>
                        <CapacityAudit/>
                    </div>
                </div>
            );
    ...
    var DiagnosticSnapshot = React.createClass({
        ...
        downloadLogs: function() {
            ...
            task.save({}, {method: 'PUT'}).always(_.bind(this.props.tasks.fetch, this.props.tasks));
        },
        render: function() {
