            ...
            return (
                ...
                >
                    <p className='snapshot'>
                        <button className='btn' disabled={this.state.generating} onClick={this.downloadLogs}>
                            {this.state.generating ? $.t('support_page.gen_logs_snapshot_text') : $.t('support_page.gen_diagnostic_snapshot_text')}
                        </button>
                        {!this.state.generating && task &&
