                        ...
                        <form className='form-horizontal'>
                            ...
                            <div className='welcome-button-box'>
                                <button autoFocus className='btn btn-large btn-success' disabled={this.state.actionInProgress} onClick={this.onStartButtonClick}>
                                    {i18n.t(ns + 'start_fuel')}
                                </button>
                            </div>
                        </form>
                        {isMirantisIso && <div className='welcome-text-box'>{i18n.t(ns + 'change_settings')}</div>}
            ...
            if (this.shouldShowMessage()) {
                ...
                return (
                    <div className='register-trial'>
                        <p>{i18n.t(ns + 'register_installation')}</p>
                        <p>{i18n.t(ns + 'register_now')}</p>
                        <p>
                            <a target="_blank" className="btn btn-info" href={!_.isUndefined(key) ? 'http://fuel.mirantis.com/create-subscriber/?key=' + key : '/'}>{i18n.t(ns + 'link_text')}</a>
                        </p>
                    </div>
                );
            }
