    ...
    var WelcomePage = React.createClass({
        ...
        saveStats: function(response) {
            ...
            _.each(values, function(name) {
                settings[name].value = response[name];
            });
            this.saveSettings()
            ...
            return (
                <div className='welcome-page'>
                    <div>
                        ...
                        <RegisterTrial
                            {... _.pick(this.state, 'isConnected', 'actionInProgress', 'error', 'userName')}
                    ...
                    <div className='register-trial'>
                        {this.props.isConnected ?
                            <div className='happy-cloud'>
                                ...
                                <div>Thanks {this.props.userName || 'Eugene'}, you’re all set!</div>
                            </div>
                        :
                            <div>
