            ...
            return (
                <div className='welcome-page'>
                    <div>
                        ...
                        {_.contains(app.version.get('feature_groups'), 'mirantis') && <div className='welcome-text-box center'>{$.t(ns + 'support')}</div>}
                        {this.renderInput('send_user_info', null, 'welcome-checkbox-box')}
                        <form className='form-horizontal'>
                            {this.props.settings.get('statistics').send_user_info.value && <div className='welcome-text-box center'>{$.t(ns + 'provide_contacts')}</div>}
