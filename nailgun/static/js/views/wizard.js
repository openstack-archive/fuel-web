    ...
    views.WizardPane = Backbone.View.extend({
        ...
        composeDisabledBindings: function(restrictions, attributeName, elementName) {
            if (restrictions.conflicts) {
                this.createDisabledBindings(restrictions.conflicts, attributeName, elementName, true);
            }
            else if (restrictions.depends) {
                this.createDisabledBindings(restrictions.depends, attributeName, elementName, false);
            }
        },
        createDisabledBindings: function(restrictedAttributes, attributeName, elementName, isConflict) {
            ...
            this.bindings['[' + attributeName + '=' + elementName +']'] = {
                ...
                attributes: [{
                    ...
                    onGet: function(values) {
                        ...
                        return !_.contains(values[0], restrictedValues);
                    }
                }]
            };
        },
