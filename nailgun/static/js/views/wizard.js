    ...
    views.CreateClusterWizard = dialogs.Dialog.extend({
        ...
        composeStickitBindings: function() {
            ...
            bindings['.next-pane-btn'] = {
                ...
                attributes: [{
                    name: 'disabled',
                    observe: 'maxAvailablePaneIndex',
                    onGet: function(value, options) {
                        return (value == _.indexOf(this.panesConstructors, this.activePane.constructor) - 1);
                    }
                }]
            };
            bindings['.finish-btn'] = {
            ...
            _.each(this.config, function(attributeConfig, attribute) {
                ...
                if (attributeConfig.type == 'radio') {
                    ...
                    if (attributeConfig.restrictions) {
                        ...
                        this.handleWarningMessages(attributeConfig.restrictions);
                    }
                }
            }, this);
    ...
    clusterWizardPanes.NameAndRelease = views.WizardPane.extend({
        ...
        createCluster: function() {
            ...
            this.wizard.cluster.on('invalid', function(model, error) {
                ...
                this.wizard.panesModel.set('maxAvailablePaneIndex', _.indexOf(this.wizard.panesConstructors, this.wizard.activePane.constructor) - 1);
            }, this);
        ...
        onInputKeydown: function(e) {
            ...
            this.wizard.panesModel.set('maxAvailablePaneIndex',  _.indexOf(this.wizard.panesConstructors, this.wizard.activePane.constructor));
        },
        composePaneBindings: function() {
