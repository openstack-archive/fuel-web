...
function(require, utils, models, dialogs, createClusterWizardTemplate, clusterNameAndReleasePaneTemplate, commonWizardTemplate, modePaneTemplate, storagePaneTemplate, clusterReadyPaneTemplate, controlTemplate, warningTemplate, wizardInfo) {
    ...
    views.CreateClusterWizard = dialogs.Dialog.extend({
        ...
        attachModelListeners: function() {
            _.each(this.restrictionsObject, function(paneConfig) {
        ...
        handleRestrictions: function (config, paneKey, paneName) {
            this.restrictionsObject[paneName][paneKey] = [];
            this.warningsObject[paneName][paneKey] = [];
            _.each(config.restrictions, function(warning, restriction) {
                this.processRestrictions(warning, restriction, this.restrictionsObject[paneName][paneKey]);
            }, this);
            _.each(config.warnings, function(warning, condition) {
                this.processRestrictions(warning, condition, this.warningsObject[paneName][paneKey]);
            }, this);
        },
        ...
        calculateDependencies: function() {
            this.restrictionsObject = {};
            this.warningsObject = {};
            _.each(this.config, function(paneConfig, paneName) {
                this.restrictionsObject[paneName] = {};
                this.warningsObject[paneName] = {};
        ...
        handleWarnings: function() {
            if (_.contains(_.keys(this.warningsObject), this.activePane.constructorName)) {
                _.each(this.warningsObject[this.activePane.constructorName], function (attributeWithWarning) {
                     _.each(attributeWithWarning, function(attributeConfig) {
                         _.each(attributeConfig, function(warning, condition) {
        ...
        renderPane: function(Pane) {
            ...
            if (_.contains(_.keys(this.warningsObject), Pane.prototype.constructorName)) {
