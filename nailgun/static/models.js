        ...
        getGroupList: function() {
            ...
            _.each(this.attributes, function(section) {
                if (section.metadata.group) {
                    groups.push(this.sanitizesGroup(section.metadata.group));
                } else {
                    _.each(section, function(setting, settingName) {
                        if (settingName != 'metadata') groups.push(this.sanitizesGroup(setting.group));
                    }, this);
                }
            }, this);
