        ...
        validate: function(attrs) {
            ...
            if (novaNetManager) {
                ...
                floatingRangesErrors = utils.validateIPRanges(
                    ...
                    {
                        'ip-ranges-intersection': i18n(ns + 'floating_and_public_ip_ranges_intersection', networkToCheckFloatingRangeData),
                        'ip-range-is-not-in-any-cidr': i18n(ns + 'floating_range_is_not_in_any_cidr')
                    }
                );
