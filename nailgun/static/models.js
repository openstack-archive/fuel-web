...
models.ComponentModel = BaseModel.extend({
  ...
  predicates: {
    one_of: (processedComponents = [], forthcomingComponents = []) => {
      //console.log(processedComponents, forthcomingComponents);
      var enabledLength =
    ...
    none_of: (processedComponents, forthcomingComponents) => {
      // TODO Implement this
      return processedComponents + forthcomingComponents;
    },
  ...
  processRequires(currentPaneIndex, paneMap) {
    //var currentPaneIndex = paneIndex[this.get('type')];
    //console.log('processRequires pane=', currentPaneIndex);
