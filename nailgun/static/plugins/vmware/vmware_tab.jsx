...
[
    ...
    var AvailabilityZone = React.createClass({
        ...
        render: function() {
            ...
            console.log('!!!',restrictActions,  this.props.model.expandedRestrictions);
    ...
    var VCenter = React.createClass({
        componentDidMount: function() {
            ...
            this.models = { cluster: this.props.cluster, settings: this.props.cluster.get('settings') };
        ...
        readData: function() {
            this.model.fetch().done(_.bind(function() {
                ...
                this.actions = this.model.testRestrictions({cluster: cluster, settings: cluster.get('settings')});
                console.log('VCenter readData',this.actions);
