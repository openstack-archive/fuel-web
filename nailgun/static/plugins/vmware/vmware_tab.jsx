                ...
                <div className="vmware">
                    ...
                    <div className="page-control-box">
                        <div className="page-control-button-placeholder">
                            <button className="btn btn-load-defaults" onClick={this.onLoadDefaults} disabled={!this.hasDefaultsChanges}>
                                {$.t('vmware.reset_to_defaults')}
                            </button>
                            <button className="btn btn-revert-changes"  onClick={this.onCancel} disabled={!this.hasChanges}>
                                {$.t('vmware.cancel')}
                            </button>
                            <button className="btn btn-success btn-apply-changes" onClick={this.onSave} disabled={!this.hasChanges}>
                                {$.t('vmware.apply')}
                            </button>
                        </div>
                    </div>
