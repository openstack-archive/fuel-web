...
[
    ...
    var Field = React.createClass({
        onChange: function(name, value) {
            //console.log('change', arguments, this.props.model);
    ...
    var AvailabilityZone = React.createClass({
        ...
        renderComputes: function() {
            ...
            var isSingleInstance = nova_computes.length==1;
            return (
    ...
    var VCenter = React.createClass({
        ...
        render: function() {
            ...
            var hasChanges = (this.json != currentJson);
            var hasDefaultsChanges = (this.defaultsJson != currentJson);
            console.log('=== RENDER VCenter ===', this.props);
            console.log('hasChanges',hasChanges, 'hasDefaultsChanges', hasDefaultsChanges);
            return (
                <div className="vmware">
                    ...
                    <div className="page-control-box">
                        <div className="page-control-button-placeholder">
                            <button className="btn btn-load-defaults" onClick={this.onLoadDefaults} disabled={!hasDefaultsChanges}>
                                {$.t('vmware.reset_to_defaults')}
                            </button>
                            <button className="btn btn-revert-changes"  onClick={this.onCancel} disabled={!hasChanges}>
                                {$.t('vmware.cancel')}
                            </button>
                            <button className="btn btn-success btn-apply-changes" onClick={this.onSave} disabled={!hasChanges}>
                                {$.t('vmware.apply')}
                            </button>
                        </div>
                    </div>
