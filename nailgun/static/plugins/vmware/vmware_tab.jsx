...
[
    ...
    var VCenter = React.createClass({
        ...
        saveData: function() {
            ...
            //console.log(xhr, this.model.isNew());
        },
                ...
                <div className="vmware">
                    ...
                    <div className="page-control-box">
                        <div className="page-control-button-placeholder">
                            <button className="btn btn-load-defaults" onClick={this.onLoadDefaults}>{$.t('vmware.reset_to_defaults')}</button>
                            <button className="btn btn-revert-changes"  onClick={this.onCancel}>{$.t('vmware.cancel')}</button>
                            <button className="btn btn-success btn-apply-changes" onClick={this.onSave}>{$.t('vmware.apply')}</button>
                        </div>
                    </div>
                </div>
