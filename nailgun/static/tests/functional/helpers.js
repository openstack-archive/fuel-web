...
define([
    ...
    _.defaults(Command.prototype, {
        ...
        isElementVisibleByClass: function(cssSelector) {
            var elmnt = document.getElementsByClassName(cssSelector);
            if (!elmnt || elmnt.length == 0) return null;
            return (elmnt[0].offsetWidth > 0 && elmnt[0].offsetHeight > 0) ? elmnt : null;
        }
    });
