    ...
    return {
      ...
      'Node network group deletion': function() {
        return this.remote
          ...
          .assertElementTextEquals('.network-group-name .btn-link', 'default',
            'Node network group name "link" disappers');
      },
      ...
      'Switching between node network groups without saved changes': function() {
        return this.remote
          ...
          .assertElementPropertyEquals('div.public div.ip_ranges input[name*="range-start"]',
            'value', '172.16.0.2', 'Public "Start IP Range" textfield  has default value')
          .assertElementEnabled('button.apply-btn', '"Save Settings" button is enabled')
          .clickByCssSelector('.subtab-link-default')
          .assertElementNotExists('div.modal-dialog', 'No new dialogs are appears')
          .assertElementNotExists('div.has-error', 'No errors are observed')
      ...
      'User can add and cannot rename new network group after deployment': function() {
        ...
        return this.remote
          ...
          .assertElementTextEquals('.network-group-name .btn-link', 'Network_Group_1',
