    ...
    DeploymentPage.prototype = {
        ...
        startDeployment: function() {
            ...
            return this.remote
                ...
                .then(function() {
                    return that.modal.checkTitle('Deploy Changes');
                })
                .then(function() {
                    return that.modal.clickFooterButton('Deploy');
                })
                .then(function() {
        ...
        stopDeployment: function() {
            ...
            return this.remote
                ...
                .then(function() {
                    return that.modal.checkTitle('Stop Deployment');
                })
                .then(function() {
                    return that.modal.clickFooterButton('Stop');
                })
                .then(function() {
                    return that.modal.waitToClose();
                });
