...
define(function() {
    ...
    function NodeDisks(remote) {
        this.remote = remote;
        this.sdaDisk = '.disk-box[data-disk=sda]';
        this.sdaDiskOS = this.sdaDisk + ' .disk-utility-box [data-volume=os] input';
        this.sdaDiskImage = this.sdaDisk + ' .disk-utility-box [data-volume=image] input';
    }
