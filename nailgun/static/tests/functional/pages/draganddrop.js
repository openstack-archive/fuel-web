define(['intern/dojo/node!leadfoot/Command'], function(Command) {
    'use strict';
    /**
     * Taken from not yet accepted pull request to leadfoot from here: https://github.com/theintern/leadfoot/pull/16
     *
