    ...
    return {
      ...
      'Testing error nodes in cluster deploy': function() {
        ...
        return this.remote
          ...
          .assertElementDisappears('.dashboard-block .progress', 60000, 'Progress bar disappears ' +
            'after deployment')
          .assertElementAppears('.dashboard-tab .alert strong', 1000, 'Error message is shown ' +
            'when adding error node')
