        ...
        return {
            ...
            'Renaming cluster works': function() {
                ...
                return this.remote
                    ...
                    .then(function() {
                        return common.assertIsElementTextEqualTo(dashboardPage.nameSelector, initialName,
                    ...
                    .then(function() {
                        return common.assertIsElementTextEqualTo(dashboardPage.nameSelector, newName, 'New name is applied');
                    })
                    .then(function() {
            ...
            'Provision button availability': function() {
                return this.remote
                    ...
                    .then(function() {
                        return common.assertIsElementTextEqualTo(dashboardPage.deployButtonSelector, 'Provision VMs',
            ...
            'Testing error nodes in cluster deploy': function() {
                return this.remote
                    ...
                    .then(function() {
                        return common.assertIsElementTextEqualTo('.statistics-block .cluster-info-value.error',
                    ...
                    .then(function() {
                        return common.assertIsElementTextEqualTo('.dashboard-tab .alert strong', 'Error',
