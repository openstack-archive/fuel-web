        ...
        return {
            ...
            'Network validation error warning': function() {
                return this.remote
                    ...
                    .clickOnElement('.verify-networks-btn')
                    .then(function() {
                    ...
                    .then(function() {
                        return common.doesCssSelectorContainText('.warnings-block',
            ...
            'Test statistics update': function() {
                ...
                return this.remote
                    ...
                    .then(function() {
                        return common.addNodesToCluster(operatingSystemNodes, ['Operating System']);
                    })
                    .then(function() {
                        return common.addNodesToCluster(virtualNodes, ['Virtual'], true);
                    })
                    .then(function() {
                        return clusterPage.goToTab('Dashboard');
                    })
            ...
            'Testing error nodes in cluster deploy': function() {
                return this.remote
                    ...
                    .clickOnElement('button.btn-apply')
                    .then(function() {
                        return clusterPage.goToTab('Dashboard');
                    })
                    .then(function() {
                        ...
                        return common.createCluster(
                            tempName,
                            {
                                Compute: function() {
                                    // Selecting VCenter
                                    return this.remote
                                        .clickOnElement('.custom-tumbler input[name=vcenter]');
                                }
                            }
                        );
                    })
