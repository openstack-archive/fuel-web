            ...
            'Test tabs locking after deployment completed': function() {
                ...
                return this.remote
                    ...
                    .findByCssSelector('div.horizon a.btn-success')
                        .getAttribute('href')
                        .then(function(value) {
                            return assert.isTrue(_.contains(value, 'http://'), 'Link to Horizon is formed');
                        })
                        .end()
                    .then(function() {
                    ...
                    .findByCssSelector('.cluster-info-value.ready')
                        .getVisibleText()
                        .then(function(text) {
                            return assert.isTrue(parseInt(text) > 0, 'Deployed nodes are present');
                        })
                    .then(function() {
                        return clusterPage.isTabLocked('Networks');
                    })
