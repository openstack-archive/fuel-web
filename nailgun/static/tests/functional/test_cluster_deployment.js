...
define([
    ...
    'tests/functional/pages/deployment',
    'tests/functional/pages/modal'
], function(_, registerSuite, assert, Common, ClusterPage, DeploymentPage, ModalWindow) {
    'use strict';
    ...
    registerSuite(function() {
        ...
        return {
            ...
            setup: function() {
                ...
                deploymentPage = new DeploymentPage(this.remote);
            ...
            'No deployment button when there are no nodes added': function() {
                return this.remote
                    .then(function() {
                        return deploymentPage.isDeploymentButtonVisible();
                    })
            ...
            'Start/stop deployment': function() {
                return this.remote
                    ...
                    .then(function() {
                        return modal.checkTitle('Deploy Changes');
                    })
                    .then(function() {
                        return modal.clickFooterButton('Deploy');
                    })
                    .then(function() {
                        return modal.waitToClose();
                    })
                    .setFindTimeout(10000)
                    .findByCssSelector('div.deploy-process div.progress')
                        .then(null, function() {
                            throw new Error('Deployment progress expected to appear');
                        })
                        .end()
                    ...
                    .then(function() {
                        return modal.checkTitle('Stop Deployment');
                    })
                    .then(function() {
                        return modal.clickFooterButton('Stop');
                    })
                    .then(function() {
                        return modal.waitToClose();
                    });
