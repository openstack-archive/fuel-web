                ...
                return this.remote
                        ...
                        .then(function(button) {
                            ...
                            return showLogsButton
                                ...
                                .then(function(isEnabled) {
                                    assert.isFalse(isEnabled, '"Show" button should be disabled until source change');
                                });
                        })
                        .end()
                    .findByCssSelector('.sticker select[name=source] option[value=app]')
                    ...
                    .then(function() {
                        ...
                        return showLogsButton
                            .isEnabled()
                            .then(function(isEnabled) {
                                assert.isTrue(isEnabled, '"Show" button should be enabled after source change');
                            });
                    })
                        .end()
                    .then(function() {
                    ...
                    .findAllByCssSelector('.log-entries tr:first-child td:last-child')
                        .then(function(elements) {
                            assert.isTrue(elements.length > 0, 'Log tab entries are not present');
                        })
                        .end()
                    ...
                    .findAllByCssSelector('.sticker select[name=node] > option')
                        .then(function(elements) {
                            assert.isTrue(elements.length > 0, '"Node" dropdown is not present');
                        });
            }
        };
    });
