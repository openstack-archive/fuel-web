    ...
    return {
      ...
      'Network Tab is rendered correctly': function() {
        return this.remote
          ...
          .getCurrentUrl()
            .then(function(url) {
              assert.include(url, 'network/1', 'Subtab url exists in the page location string');
            })
      ...
      'Testing cluster networks: data validation on invalid settings': function() {
        return this.remote
          ...
          .assertElementsExist(
            '.node-network-groups-list i.glyphicon-danger-sign',
            2,
          ...
          .assertElementNotExists('.node-network-groups-list i.glyphicon-danger-sign',
    ...
    return {
      ...
      'Node network group creation': function() {
        return this.remote
          ...
          .assertElementsExist('.node-network-groups-list a', 6, 'New subtab is shown')
      ...
      'Node network group deletion': function() {
        return this.remote
          ...
          .assertElementsExist(
            '.node-network-groups-list a',
            5,
            'Node network groups was successfully removed'
          );
      },
