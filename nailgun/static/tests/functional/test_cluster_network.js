...
define([
    ...
    registerSuite(function() {
        ...
        return {
            name: 'Networks page Neutron Network tunneling tests',
            setup: function() {
                common = new Common(this.remote);
                networksPage = new NetworksPage(this.remote);
                clusterPage = new ClusterPage(this.remote);
            ...
            'Neutron title is present': function() {
                return this.remote
                    .findByCssSelector('.neutron-title')
                        .end()
                    .then(function() {
                        return common.assertElementTextEqualTo('.neutron-title', 'Neutron with tunneling segmentation',
                            'Neutron title is shown with appropriate text');
                    })
            },
