    ...
    registerSuite(function() {
        ...
        return {
            ...
            'Network Tab is rendered correctly': function() {
                return this.remote
                    .assertElementsExist('.nova-managers .radio-group', 'Nova Network manager radiogroup is present')
            ...
            'Testing cluster networks: change network manager': function() {
                ...
                return this.remote
                    ...
                    .assertElementsExist(amountSelector, 'Amount field for a fixed network is present in VLAN mode')
