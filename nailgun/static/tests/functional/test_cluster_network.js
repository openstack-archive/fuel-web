    ...
    registerSuite(function() {
        ...
        return {
            ...
            'Network Tab is rendered correctly': function() {
                return this.remote
                    .assertElementDisplayed('.network-tab', 'Network tab is present')
                    .assertElementDisplayed('.nova-managers .radio-group', 'Nova Network manager radiogroup is present')
            ...
            'Testing cluster networks: change network manager': function() {
                ...
                return this.remote
                    ...
                    .assertElementDisplayed(amountSelector, 'Amount field for a fixed network is present in VLAN mode')
            ...
            'Testing cluster networks: save changes': function() {
                return this.remote
                    ...
                    .assertElementAppears('input:not(:disabled)', 2000, 'Inputs are not disabled')
