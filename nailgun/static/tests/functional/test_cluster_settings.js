                ...
                return this.remote
                    .findByCssSelector('.btn-load-defaults')
                        .then(function(element) {
                            return element.assert.enabled('Load defaults button is enabled');
                        })
                        .end()
                    .findByCssSelector('.btn-revert-changes')
                        .then(function(element) {
                            return element.assert.disabled('Cancel Changes button is disabled');
                        })
                        .end()
                    .findByCssSelector('.btn-apply-changes')
                        .then(function(element) {
                            return element.assert.disabled('Save Settings button is disabled');
                        })
                        .end();
            },
