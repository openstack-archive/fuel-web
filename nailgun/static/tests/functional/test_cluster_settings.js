        ...
        return {
            ...
            'The choice of subgroup is preserved when user navigates through the cluster tabs': function() {
                return this.remote
                    ...
                    .then(function() {
                        return common.doesElementExist('.nav-pills li.active a.subtab-link-syslog', 'The choice of subgroup is preserved when user navigates through the cluster tabs');
                    });
            },
            'The page reacts on invalid input': function() {
                return this.remote
                    ...
                    .then(function() {
                        return common.doesElementExist('.access .form-group.has-error', 'Invalid field marked as error');
                    })
                    .then(function() {
                        return common.doesElementExist('.subtab-link-access i.glyphicon-danger-sign', 'Subgroup with invalid field marked as invalid');
                    })
                    .then(function() {
                    ...
                    .findByCssSelector('.btn-revert-changes')
                        ...
                        .end()
                    .then(function() {
                        return common.doesntElementExist('.access .form-group.has-error', 'Validation error is cleared after resetting changes');
                    })
                    .then(function() {
                        return common.doesntElementExist('.subtab-link-access i.glyphicon-danger-sign', 'Subgroup menu has default layout after resetting changes');
                    });
            },
            'Test repositories custom control': function() {
                ...
                return this.remote
                    ...
                    .findAllByCssSelector('.repos .form-inline')
                        ...
                        .end()
                    .then(function() {
                        return common.doesntElementExist('.repos .form-inline:nth-of-type(1) .btn-link', 'The first repo can not be deleted');
                    })
                    // delete some repo
                    ...
                    .findAllByCssSelector('.repos .form-inline')
                        ...
                        .end()
                    .then(function() {
                        return common.doesElementExist('.repos .form-inline .repo-name.has-error', 'Empty repo marked as imnvalid');
                    })
                    // revert the change
                    .findByCssSelector('.btn-revert-changes')
                        .click()
