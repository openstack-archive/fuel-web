        ...
        return {
            ...
            'Check Save Settings button': function() {
                return this.remote
                    ...
                    .findByCssSelector('input[type=checkbox]')
                        ...
                        .click()
                        .then(function() {
                            return common.assertElementEnabled('.btn-apply-changes', 'Save Settings button is enabled');
                        })
                        // reset the change
                        .click()
                        .then(function() {
            ...
            'The page reacts on invalid input': function() {
                return this.remote
                    ...
                    .then(function() {
                        return common.assertElementExists('.access .form-group.has-error', 'Invalid field marked as error');
                    })
                    .then(function() {
