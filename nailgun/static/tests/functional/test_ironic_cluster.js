...
], function(registerSuite, assert, helpers, Common, ClusterPage, NetworksLib) {
    'use strict';
    ...
    registerSuite(function() {
        ...
        return {
            ...
            setup: function() {
                ...
                return this.remote
                    // T2199259: Enabling Ironic when create environment
                    .then(function() {
                        return common.getIn();
                    })
                    .then(function() {
                    ...
                    // T2199263: Check Ironic item on Settings tab
                    .then(function() {
                    ...
                    .then(function() {
                        return networksLib.checkBaremetalInitialState();
                    });
            },
            ...
            'T2199265: Baremetal Network "IP Ranges" adding and deletion additional fields': function() {
                ...
                return this.remote
                    // Change network settings
                    .setInputValue('div.baremetal div.ip_ranges input[name*="range-start"]', '192.168.3.1')
                    .setInputValue('div.baremetal div.ip_ranges input[name*="range-end"]', '192.168.3.50')
                    // Add new IP range
                    ...
                    .setInputValue('div.baremetal div.ip_ranges div.range-row[data-reactid$="$1"] input[name*="range-start"]', '192.168.3.55')
            ...
            'T2199266: Baremetal and other networks intersections': function() {
                ...
                return this.remote
                    ...
                    /*
                    FIXME: Update and uncomment after bugfix.
                    // Bug: https://bugs.launchpad.net/fuel/+bug/1517445
