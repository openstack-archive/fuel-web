            ...
            'Check SDA disk graph': function() {
                return this.remote
                    ...
                    .findByCssSelector(disks.sdaDiskImage)
                        ...
                        .end()
                    .then(function() {
                        return common.isElementPresent(disks.sdaDisk + ' .disk-visual [data-volume=image] .close-btn', 'Button Close for Image Storage volume is present');
                    })
                    .then(function() {
                        return common.isElementAbsent(disks.sdaDisk + ' .disk-visual [data-volume=os] .close-btn', 'Button Close for Base system volume is not present');
                    });
            },
