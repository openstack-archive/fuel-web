        ...
        return {
            ...
            'Testing volume group deletion and Cancel button': function() {
                return this.remote
                    ...
                    .findByCssSelector(sdaDisk + ' .disk-visual [data-volume=unallocated]')
                        ...
                        .end()
                    .clickOnElement('.btn-revert-changes')
                    .then(function() {
            ...
            'Test volume size validation': function() {
                return this.remote
                    ...
                    .then(function() {
                        return common.isElementDisabled('.btn-apply', 'Apply button is disabled in case of validation error');
                    })
                    .clickOnElement('.btn-revert-changes');
            }
        };
