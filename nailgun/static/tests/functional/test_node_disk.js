        ...
        return {
            ...
            setup: function() {
                ...
                return this.remote
                    ...
                    .then(function() {
                        return common.doesElementExist('.edit-node-disks-screen', 'Disk configuration screen opened ');
                    })
            ...
            'Check SDA disk graph': function() {
                return this.remote
                    ...
                    .findByCssSelector(sdaDisk + ' .disk-utility-box [data-volume=image] input')
                        ...
                        .end()
                    .then(function() {
                        return common.doesElementExist(sdaDisk + ' .disk-visual [data-volume=image] .close-btn', 'Button Close for Image Storage volume is present');
                    })
                    .then(function() {
                        return common.doesntElementExist(sdaDisk + ' .disk-visual [data-volume=os] .close-btn', 'Button Close for Base system volume is not present');
                    });
            },
