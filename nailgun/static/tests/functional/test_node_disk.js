...
define([
    ...
    registerSuite(function() {
        var common,
            ...
            initialImageSize,
            sdaDisk,
            applyButton, cancelButton, loadDefaultsButton;
        ...
        return {
            ...
            setup: function() {
                ...
                cancelButton = '.btn-defaults';
                loadDefaultsButton = '.btn-revert-changes';
                ...
                return this.remote
                    .findAllByCssSelector('.node-disks > .disk-box')
                        ...
                        .then(function(elements) {
                            assert.ok(elements.length > 0, 'There are more the 0 disks');
                        })
                        .end()
                    .then(function() {
                        return common.isElementDisabled(loadDefaultsButton, 'Cancel button is disabled');
                    })
                    .then(function() {
                        return common.isElementDisabled(applyButton, 'Apply button is disabled');
                    })
                    .then(function() {
                        return common.isElementEnabled(cancelButton, 'Load Defaults button is enabled');
                    });
            },
            ...
            'Testing Apply and Load Defaults buttons behaviour': function() {
                return this.remote
                    ...
                    .then(function() {
                        return common.isElementEnabled(loadDefaultsButton, 'Cancel button is enabled');
                    })
                    .then(function() {
                        return common.isElementEnabled(applyButton, 'Apply button is enabled');
                    })
                    .then(function() {
                        return common.isElementEnabled(cancelButton, 'Load Defaults button is enabled');
                    })
            ...
            'Testing volume group deletion and Cancel button': function() {
                return this.remote
                    ...
                    .findByCssSelector(sdaDisk + ' .disk-visual [data-volume=unallocated]')
                        ...
                        .end()
                    .clickOnElement(loadDefaultsButton)
                    .then(function() {
            ...
            'Test volume size validation': function() {
                return this.remote
                    ...
                    .then(function() {
                        return common.isElementDisabled(applyButton, 'Apply button is disabled in case of validation error');
                    })
                    .clickOnElement(loadDefaultsButton);
            }
        };
