        ...
        return {
            ...
            'Check SDA disk graph': function() {
                return this.remote
                    ...
                    .findByCssSelector(disks.sdaDisk + ' .disk-visual [data-volume=os] .toggle')
                        ...
                        .click()
                        .end()
                    .findByCssSelector(disks.sdaDisk + ' .disk-utility-box [data-volume=os] input')
                        .then(function(input) {
                            return input.getAttribute('value')
                                .then(function(value) {
                        ...
                        .end()
                    .findByCssSelector(disks.sdaDisk + ' .disk-utility-box [data-volume=image] input')
                        .then(function(input) {
                            return input.getAttribute('value')
                                .then(function(value) {
                        ...
                        .end()
                    .then(function() {
                        common.doesElementExist(disks.sdaDisk + ' .disk-visual [data-volume=image] .close-btn', 'Button Close for Image Storage volume is present');
                    })
                    .then(function() {
                        common.doesntElementExist(disks.sdaDisk + ' .disk-visual [data-volume=os] .close-btn', 'Button Close for Base system volume is not present');
                    });
            },
            'Testing Apply and Load Defaults buttons: interractions': function() {
                return this.remote
                    ...
                    .then(function() {
                        return common.clickButton('.btn-apply');
                    })
                    .then(function() {
                    ...
                    .then(function() {
                        return common.clickButton('.btn-defaults');
                    })
                    .findByCssSelector(disks.sdaDisk + ' input[type=number][name=image]')
            ...
            'Testing volume group deletion and Cancel button': function() {
                return this.remote
                    ...
                    .then(function() {
                        ...
                        return common.clickButton('.btn-revert-changes');
                    })
                    .findByCssSelector(disks.sdaDisk + ' input[type=number][name=image]')
                        // Get Image Storage size after load default
                        .then(function(input) {
