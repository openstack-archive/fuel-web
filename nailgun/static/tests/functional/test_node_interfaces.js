        ...
        return {
            ...
            'Check that two bonds cannot be bonded': function() {
                return this.remote
                    ...
                    .assertElementContainsText('.alert.alert-warning', 'This network interface is already bonded with other network inteface.', 'Warning message should appear when intended to bond bonds');
            }
        }
    });
});
