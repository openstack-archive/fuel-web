...
define([
    ...
    registerSuite(function() {
        var common,
            modal,
            saveButton, sendStatisticsCheckbox;
        ...
        return {
            ...
            'Support page is rendered correctly': function() {
                return this.remote
                    ...
                    .then(function() {
                        return common.assertElementExists(sendStatisticsCheckbox + ':checked', 'Save Statistics checkbox is checked by default');
                    })
                    .then(function() {
                        return common.assertElementDisabled(saveButton, '"Save changes" button is disabled until statistics checkbox uncheck');
                    });
            },
            ...
            'Usage statistics option saving': function() {
                return this.remote
                    ...
                    .then(function() {
                        return common.assertElementEnabled(saveButton, '"Save changes" button is enabled after changing "Send usage statistics" checkbox value');
                    })
                    .clickByCssSelector(saveButton)
                    // Button "Save changes" becomes disabled after saving the changes
                    .then(function() {
                        return common.assertElementDisabled(saveButton, '"Save changes" button is disabled after saving changes');
                    });
            },
            'Discard changes': function() {
                return this.remote
                    ...
                    .clickByCssSelector(sendStatisticsCheckbox)
                    .then(function() {
                        return common.assertElementEnabled(saveButton, '"Save changes" button is enabled');
                    })
