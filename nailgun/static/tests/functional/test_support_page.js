        ...
        return {
            ...
            'Usage statistics option saving': function() {
                return this.remote
                    ...
                    .then(function() {
                        return common.assertElementDisabled('.tracking .btn', '"Save changes" button is disabled after saving changes');
                    });
            },
            'Discard changes': function() {
                var sendStatisticsCheckbox = '.tracking input[name=send_anonymous_statistic]';
                return this.remote
