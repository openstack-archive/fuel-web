define([
    ...
    registerSuite({
        ...
        Initialization: function() {
            ...
            assert.equal(initialState.size, '11.0 bytes', 'Content size should be calculated properly');
        },
        ...
        'File selection': function() {
            ...
            input.pickFile();
            assert.ok(clickSpy.calledOnce, 'When icon clicked input control should be be clicked too to open select file dialog');
        },
        ...
        'File saving': function() {
            ...
            input.saveFile('dummy.ext', 'Lorem ipsum dolores');
