...
var ClusterPage = React.createClass({
  ...
  checkSubtab(props = {}) {
    var getSubtabs = _.find(this.constructor.getTabs(), {url: props.activeTab}).tab.getSubtabs;
    var subtabs = getSubtabs && getSubtabs(_.pick(props, 'cluster', 'nodeNetworkGroups'));
