        ...
        validations: [
            ...
            function(cluster) {
                ...
                if (!sslSettings.horizon.value && !sslSettings.services.value) {
                    return {warning: [i18n(this.ns + 'tsl_not_enabled')]};
                }
                if (!sslSettings.horizon.value) {
                    return {warning: [i18n(this.ns + 'tsl_for_horizon_not_enabled')]};
                }
                if (!sslSettings.services.value) {
                    return {warning: [i18n(this.ns + 'tsl_for_services_not_enabled')]};
                }
            },
            // VCenter
            function(cluster) {
