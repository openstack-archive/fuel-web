...
function(_, i18n, $, React, utils, models, dispatcher, dialogs, componentMixins, controls) {
        ...
        render: function() {
            ...
            return (
                <div>
                    ...
                    /* @FIXME: !hasNodes condition is not clear here - it requires decoupling DeployReadinessBlock component*/
    ...
    // it should be refactored to provide proper logics separation
