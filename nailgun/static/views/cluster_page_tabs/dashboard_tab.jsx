    ...
    var DeploymentResult = React.createClass({
        ...
        render: function() {
            ...
            var error = task.match({status: 'error'}),
                ...
                warning = task.match(['reset_environment', 'stop_deployment']),
                classes = {
                    alert: true,
                        ...
                        <div className='col-xs-6'>
                            <div className='row'>
                                ...
                                <div className='col-xs-12 dashboard-actions-wrapper'>
                                    <DeleteEnvironmentAction cluster={cluster} disabled={task} />
                                    {!this.props.isNew &&
                                        <ResetEnvironmentAction cluster={cluster} task={task} disabled={!!task} />
                                    }
                                </div>
                            </div>
                        </div>
