                        ...
                        :
                            hasNodes &&
                                <div className='col-xs-12'>
                                    <DeploymentImpossibleBlock cluster={cluster}/>
                                </div>
                        }
                    </div>
                    <ClusterInfo
                    ...
                    {(this.props.isInvalid || cluster.needsRedeployment()) ?
                        [
                            <div>
                                ...
                                <span>{i18n(this.ns + (this.props.isInvalid ? 'warnings.no_deployment' : 'redeployment_needed'))}</span>
                            </div>,
                            <hr />
                        ]
        ...
        render: function() {
            var cluster = this.props.cluster,
                ...
                isDeploymentImpossible = cluster.get('release').get('state') == 'unavailable' ||
                    (!cluster.get('nodes').hasChanges() && !cluster.needsRedeployment()) || !!this.state.alerts.blocker.length;
            return (
    ...
    var ClusterInfo = React.createClass({
        ...
        renderStatistics: function() {
            ...
            var rolesToColors = {
                    ...
                    offline: '#ccc',
                    error: '#c94b4b',
                    'pending_addition': '#54a854',
                    'pending_deletion': '#c94b4b',
                    operational: '#688db4'
                },
                chartWidth = 100,
                chartHeight = 110,
                    ...
                    {hasNodes ?
                        ...
                        <div className='col-xs-6'>
                            <div className='row'>
                                ...
                                {_.map(fieldRoles, function(field) {
                        ...
                        <div className='col-xs-6'>
                            <div clasName='row'>
                                ...
                                {_.map(fieldStatuses, function(field) {
                                    var numberOfNodesWithRole = this.getNumberOfNodesWithRole(field) || this.getNumberOfNodesWithStatus(field);
                                    return numberOfNodesWithRole ?
                                        <div>
                                            <div className='col-xs-10'>
