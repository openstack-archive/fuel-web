        ...
        render: function() {
            ...
            return (
                <div>
                    {isOperational &&
                        <div className='row'>
                            <div className='col-xs-12 plugin-entry'>
                                ...
                                <div className='description pull-left'>{i18n(namespace + 'horizon_description')}</div>
                    ...
                    {(failedDeploymentTask || !isNew || stopDeploymentTask) &&
                        ...
                        <div key={field}>
                            <div className='col-xs-10'>
                                <div className='cluster-info-title'>
                                    ...
                                    {field !== 'total' && i18n(namespace + 'cluster_info_fields.total')}
                                </div>
                            </div>
