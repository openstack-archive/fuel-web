...
function(_, i18n, $, React, utils, models, dispatcher, dialogs, componentMixins, controls) {
    ...
    var DashboardTab = React.createClass({
        ...
        render: function() {
            var cluster = this.props.cluster,
                ...
                title = this.getTitle(),
                runningDeploymentTask = cluster.getDeployingTask(),
                        ...
                        <div className='col-xs-6'>
                            <div className='row'>
                                ...
                                <div className='col-xs-12 dashboard-actions-wrapper'>
                                    ...
                                    {!this.props.isNew &&
                                        <ResetEnvironmentAction cluster={cluster} task={runningDeploymentTask} disabled={runningDeploymentTask} />
                                    }
                                </div>
                            </div>
                        </div>
    ...
    var AddNodesButton = React.createClass({
        render: function() {
            var disabled = !!this.props.cluster.getDeployingTask();
            return (
                    <a
