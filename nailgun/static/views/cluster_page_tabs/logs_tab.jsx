...
function($, _, i18n, React, utils, models, componentMixins, controls) {
    ...
    var LogsTab = React.createClass({
        ...
        getInitialState: function() {
            ...
            logOptions.level = logOptions.level ? logOptions.level.toUpperCase() : null;
            return {
                selectedLogs: logOptions,
        ...
        fetchLogs: function(data) {
            return $.ajax({
                url: '/api/logs',
                dataType: 'json',
                data: _.extend(_.omit(this.state.selectedLogs, 'type'), data),
                headers: {
        ...
        showLogs: function(params) {
            this.stopPolling();
            var logOptions = this.state.selectedLogs.type == 'remote' ? this.state.selectedLogs : _.omit(this.state.selectedLogs, 'node');
        ...
        onShowButtonClick: function(states) {
            this.setState({selectedLogs: states, loading: 'loading'}, this.showLogs);
        },
                ...
                <div className='row'>
                    ...
                    <div className='col-xs-12 content-elements'>
                        <LogFilterBar
                            ...
                            changeLogSelection={this.props.changeLogSelection}
    ...
    var LogFilterBar = React.createClass({
        ...
        handleShowButtonClick: function() {
            this.setState({locked: true});
            var states = _.pick(this.state, 'type', 'node', 'source', 'level');
            this.props.changeLogSelection(states);
