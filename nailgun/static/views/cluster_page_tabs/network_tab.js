    ...
    var NetworkTab = React.createClass({
        ...
        render: function() {
            var isLocked = this.isLocked(),
                ...
                isNodeNetworkGroupSectionSelected = !_.contains(defaultNetworkGroups, activeNetworkGroupName);
            ...
            var currentNodeNetworkGroup = nodeNetworkGroups.findWhere({name: activeNetworkGroupName}),
                ...
                validationErrors = networkConfiguration.validate(networkConfiguration, nodeNetworkGroups);
