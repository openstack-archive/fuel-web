        ...
        render: function() {
            ...
            return (
                <div className='forms-box network'>
                    {_.map(sortedNetworkSections, (sectionName) => {
                        var settingsToDisplay = _.compact(_.map(settings.get(sectionName), (setting, settingName) => {
                            if (
                                (settings.get(sectionName).metadata.group || !settings.get(sectionName).metadata.group && setting.group == 'network') &&
