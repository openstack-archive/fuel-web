...
function($, _, i18n, Backbone, React, utils, models, ComponentMixins, controls) {
    ...
    var EditNodeDisksScreen = React.createClass({
        ...
        getVolumesInfo: function(disk) {
            ...
            disk.get('volumes').each(function(volume) {
                ...
                if (volume.validationError) volumes[name].error = volume.validationError;
            }, this);
            volumes.unallocated = {
    ...
    var NodeDisk = React.createClass({
        ...
        render: function() {
            ...
            diskError = diskError || disk.get('size') < this.props.volumes.reduce(function(total, volume) {return total + volume.get('min_size');}, 0);
            return (
