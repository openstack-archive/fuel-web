    ...
    var EditNodeInterfacesScreen = React.createClass({
        ...
        getInitialState: function() {
            return {
                ...
                interfaceErrors: {},
                interfacesMap: _.range(0, this.getNumberOfNotBondedInterfaces())
            };
        },
        ...
        getNumberOfNotBondedInterfaces: function() {
            return this.props.interfaces.filter((ifc) => !ifc.isBond()).length;
        },
            ...
            var getIfcSpeed = function(index) {
                    return _.compact(_.unique(nodes.map(function(node) {
                        ...
                        var ifcIndex = interfacesMap[index],
                            nodeBondsCount = node.interfaces.length - interfacesMap.length;
                        if (nodeBondsCount > 0) {
                            ifcIndex = ifcIndex + nodeBondsCount;
                        }
