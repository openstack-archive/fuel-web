        ...
        statics: {
            target: {
                drop: function(props, monitor) {
                    ...
                    var sourceNetwork = sourceInterface.get('assigned_networks').findWhere({name: monitor.getItem().networkName});
                    sourceInterface.get('assigned_networks').remove(sourceNetwork);
