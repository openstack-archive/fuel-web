    ...
    var NodeInterface = React.createClass({
        ...
        render: function() {
            var ifc = this.props.interface,
                ...
                availableBondingModes = this.getAvailableBondingModes(),
                ...
                isPossibleToModify = this.props.bondingAvailable && !locked;
                                        ...
                                        return (
                                            <div key={'info-' + slaveInterface.get('name')} className='ifc-info-block clearfix'>
                                                ...
                                                <div className='ifc-info pull-left'>
                                                    ...
                                                    {(isPossibleToModify && slaveInterfaces.length >= 3) &&
