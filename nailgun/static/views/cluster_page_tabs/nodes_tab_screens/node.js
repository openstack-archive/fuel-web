...
var Node = React.createClass({
  ...
  renderCompactNode(ns, node, isSelectable, status, roles, nodePanelClasses, logoClasses, statusClasses) {
    return (
  ...
  render() {
    ...
    if (this.props.viewMode == 'compact') return this.renderCompactNode(ns, node, isSelectable, status, roles, nodePanelClasses, logoClasses, statusClasses);
