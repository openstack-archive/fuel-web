...
var Node = React.createClass({
  ...
  renderCompactNode(options) {
    ...
    var {ns, isSelectable, status, roles, nodePanelClasses, logoClasses, statusClasses} = options;
    return (
  ...
  render() {
    ...
    return this.renderStandardNode({ns, status, roles, nodePanelClasses, logoClasses, statusClasses});
  }
});
