...
var Node = React.createClass({
                      ...
                      <div className='node-buttons'>
                        ...
                        {[
                          ...
                          this.props.renderActionButtons && node.hasChanges() &&
                            ...
                            >
                              {i18n(ns + (node.get('pending_deletion') ? 'discard_deletion' :
                                  'delete_node'))}
                            </button>
                        ]}
                      </div>
  ...
  render() {
    ...
    return renderMethod({ns, status, roles, nodePanelClasses, logoClasses, statusClasses,
      isSelectable});
  }
});
