...
var Node = React.createClass({
  ...
  render() {
    ...
    var renderOptions = {ns, status, roles, nodePanelClasses, logoClasses, statusClasses, isSelectable};

    var render = this.props.viewMode == 'compact' ? this.renderCompactNode : this.renderStandardNode;
