...
function($, _, i18n, Backbone, React, utils, models, dispatcher, controls, dialogs, componentMixins) {
    ...
    var Node = React.createClass({
        mixins: [componentMixins.renamingMixin],
        ...
        onNodeNameInputKeydown: function(e) {
            if (e.key == 'Enter') {
                this.applyNewNodeName(this.refs[this.state.refname].getInputDOMNode().value);
        ...
        renderNameControl: function() {
            if (this.state.isRenaming) return (
                <controls.Input
                    ...
                    inputClassName='form-control node-name-input renaming'
