    ...
    var groupingMethod = (node) => {
      return _.compact(_.map(this.props.activeSorters, (sorter) => {
        ...
        var sorterNameFormatter = {
          ...
          cluster: () => cluster && i18n(ns + 'cluster', {cluster: cluster.get('name')})
            || i18n(ns + 'unallocated'),
        ...
        return sorterNameFormatter[sorter.name] ? sorterNameFormatter[sorter.name]() : sorterNameFormatter.default();
      })).join('; ');
    };
    ...
    return groups.sort((group1, group2) => {
      ...
      _.each(this.props.activeSorters, (sorter) => {
        ...
        if (sorter.isLabel) {
          ...
          if (rolesOrderMap[sorter.name]) rolesOrderMap[sorter.name]();
          else rolesOrderMap.default();
        }
