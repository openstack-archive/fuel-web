...
ManagementPanel = React.createClass({
  ...
  render() {
    ...
    if (this.props.mode != 'edit') {
      var checkSorter = (sorter, isLabel) => !_.any(this.props.activeSorters,
        {name: sorter.name, isLabel: isLabel});
              ...
              this.state.activeSearch && (
                <div className='search pull-left' key='search'>
                  ...
                  {this.state.isSearchButtonVisible &&
                    <button
                      className='close btn-clear-search' onClick={this.clearSearchField}
                    >
                      &times;
                    </button>
                  }
