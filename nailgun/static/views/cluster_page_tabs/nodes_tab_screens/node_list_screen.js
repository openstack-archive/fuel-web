...
MultiSelectControl = React.createClass({
  ...
  render() {
    ...
    return (
      <div className={classNames(classNames)} tabIndex='-1' onKeyDown={this.closeOnEscapeKey}>
        <button
              ...
              !this.state.activeSearch && (
                <Tooltip wrap key='search-btn' text={i18n(ns + 'search_tooltip')}>
                  <button
                    ...
                    className={classNames(managementButtonClasses(false, 'btn-search'))}
                  >
        ...
        <div className='well clearfix'>
          ...
          <div className='forms-box form-inline'>
            ...
            {_.map(this.state.labels, (labelData, index) => {
              ...
              return (
                <div
                  className={classNames({clearfix: true, 'has-label': showControlLabels})}
                  key={index}
                >
                  <Input
                    type='checkbox'
