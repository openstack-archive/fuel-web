    ...
    NodeLabelsPanel = React.createClass({
        ...
        addLabel: function() {
            ...
            labels.push({
                ...
                values: [null],
                checked: true,
                error: i18n('cluster_page.nodes_tab.node_management_panel.labels.empty_label_key')
            });
        ...
        changeLabelState: function(index, key, checked) {
            ...
            labelData.error = this.validateLabelKey(labelData.key, labelData);
            this.setState({labels: labels});
        },
        changeLabelValue: function(index, key, value) {
            var labels = this.state.labels;
            labels[index].values = [_.trim(value) || null];
            this.setState({labels: labels});
        },
