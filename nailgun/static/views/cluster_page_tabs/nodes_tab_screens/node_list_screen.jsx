                ...
                <div className='row'>
                    <div className='sticker node-management-panel'>
                        <div className='node-list-management-buttons col-xs-6'>
                            ...
                            {this.props.mode != 'edit' && [
                                <controls.Tooltip key='labels-btn' text={i18n(ns + 'labels_tooltip')} wrap={true}>
                                    <button
                                ...
                                <controls.Tooltip key='sorters-btn' text={i18n(ns + 'sort_tooltip')} wrap={true}>
                                    <button
                                ...
                                <controls.Tooltip key='filters-btn' text={i18n(ns + 'filter_tooltip')} wrap={true}>
                                    <button
                                        disabled={!this.props.screenNodes.length}
                                ...
                                !this.state.activeSearch && (
                                    <controls.Tooltip key='search-btn' text={i18n(ns + 'search_tooltip')} wrap={true}>
                                        <button
                                            disabled={!this.props.screenNodes.length}
