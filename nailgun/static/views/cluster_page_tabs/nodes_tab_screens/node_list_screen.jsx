...
function($, _, i18n, Backbone, React, utils, models, dispatcher, controls, dialogs, componentMixins, Node) {
    ...
    NodeListScreen = React.createClass({
        ...
        updatePageUrl: function() {
            var parameters = encodeURIComponent(JSON.stringify({
                filter: _.omit(this.state.activeFilters, function(values) {return !values.length;}),
            ...
            return (
                <div>
                    ...
                    <NodeList
                        ...
                        {... _.pick(this.props, 'cluster', 'mode')}
        ...
        render: function() {
            var valuesAmount = this.props.values.length,
                label = (this.props.dynamicValues || !valuesAmount) ? this.props.label : valuesAmount > 3 ?
                        i18n('cluster_page.nodes_tab.node_management_panel.selected_options', {count: valuesAmount})
                    :
            ...
            return (
                <div className={utils.classNames({'btn-group multiselect': true, open: this.state.isOpen})}>
                    ...
                    {this.state.isOpen &&
                        <controls.Popover toggle={this.toggle} closeOnRoute={false}>
    ...
    ManagementPanel = React.createClass({
        ...
        render: function() {
            ...
            var filtersToDisplay, inactiveFilters, filtersWithValues;
            if (this.props.mode != 'edit') {
                ...
                filtersWithValues = _.omit(this.props.activeFilters, function(values) {return !values.length;});
            }
                    ...
                    <div className='sticker node-management-panel'>
                            ...
                            {this.props.mode != 'edit' && [
                                ...
                                !this.state.activeSearch && (
                                    <button
                                        ...
                                        className={utils.classNames(managementButtonClasses())}
                                    >
                        ...
                        {this.props.mode != 'edit' && !!this.props.screenNodes.length &&
                            <div className='col-xs-12'>
                                {(!this.state.areSortersVisible || !this.state.areFiltersVisible && !_.isEmpty(filtersWithValues)) &&
                                    <div className='active-sorters-filters'>
                                        {!this.state.areFiltersVisible && !_.isEmpty(filtersWithValues) &&
        ...
        groupNodes: function() {
            ...
            var groupingMethod = _.bind(function(node) {
                return (_.map(activeNotSpecialSorters, function(sorter) {
                    ...
                    return i18n('node_details.' + sorter, {count: node.resource(sorter)});
                })).join('; ');
            }, this);
