...
function($, _, i18n, Backbone, React, utils, models, dispatcher, controls, dialogs, componentMixins, Node) {
    ...
    NodeListScreen = React.createClass({
        ...
        render: function() {
            ...
            var filteredNodes = nodes.filter(function(node) {
                // search field
                if (this.state.search && !_.contains(
    ...
    NodeList = React.createClass({
        ...
        groupNodes: function() {
            ...
            var activeuniqValueSorters = _.intersection(activeSorters, uniqValueSorters);
            if (activeuniqValueSorters.length) {
            ...
            // TODO: need support 'desc' sorting order
