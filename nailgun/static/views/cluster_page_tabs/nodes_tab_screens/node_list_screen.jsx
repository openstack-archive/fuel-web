                                ...
                                <div className='col-xs-12 labels' key='labels'>
                                    <div className='well clearfix'>
                                        ...
                                        <div className='forms-box form-inline' key={this.state.labelsKey}>
                                            {_.map(labelsToDisplay, function(label) {
                                            ...
                                            {!this.props.nodes.length && !this.props.labels.length &&
                                                <p>{i18n(ns + 'no_labels')}</p>
                                            }
                                            {!!this.props.nodes.length &&
                                                <div>
                                                    ...
                                                    />
                                                    <i
                                                        className='btn btn-link glyphicon glyphicon-plus-sign'
