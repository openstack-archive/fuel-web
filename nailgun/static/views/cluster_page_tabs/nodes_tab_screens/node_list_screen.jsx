...
function($, _, i18n, Backbone, React, utils, models, dispatcher, controls, dialogs, componentMixins) {
    ...
    Node = React.createClass({
        ...
        toggleExtendedNodePanel: function(e) {
            ...
            if (this.props.viewMode == 'compact') return (
                <div className='compact-node'>
                    <div className={utils.classNames(nodePanelClasses)}>
                        <label className='node-box' onClick={node.isSelectable() && _.partial(this.props.onNodeSelection, null, !this.props.checked)}>
                            ...
                            <div className='node-hardware'>
                                <p onClick={this.toggleExtendedNodePanel}>
                                    <span>
                                    ...
                                    <div className={utils.classNames(statusClasses)}>
                                        ...
                                        :
                                            <div>
                                                ...
                                                {!!node.get('cluster') &&
                                                    (node.hasChanges() ?
                                                        <button className='btn btn-discard' onClick={this.discardNodeChanges}>
