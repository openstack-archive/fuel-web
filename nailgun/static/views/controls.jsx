...
define(['i18n', 'jquery', 'underscore', 'react', 'utils', 'jsx!component_mixins'],
    ...
    controls.Input = React.createClass({
        ...
        renderDescription: function() {
            var text = '';
            if (!_.isUndefined(this.props.error) && !_.isNull(this.props.error)) {
                text = this.props.error;
            } else if (this.props.description) {
                text = utils.urlify(this.props.description);
            }
            return <span key='description' className='help-block' dangerouslySetInnerHTML={{__html: text}} />;
        },
