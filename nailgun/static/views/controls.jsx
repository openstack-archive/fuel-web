...
define(['jquery', 'underscore', 'react', 'utils', 'jsx!component_mixins', 'filesize'],
    function($, _, React, utils, componentMixins, filesize) {
    'use strict';
    ...
    controls.Input = React.createClass({
        ...
        getInitialState: function() {
            return {
                visible: false,
                fileName: this.props.value && this.props.value.fileName ? this.props.value.fileName : null,
                size: this.props.value && this.props.value.content ?
                    filesize(this.props.value.content.length) :
                    0
            };
        },
        ...
        renderInput: function() {
            ...
            if (this.props.type == 'range') {
                ...
                props.onChange = (_.isUndefined(this.props.value) && _.isUndefined(this.props.сhecked)) ?
                    this.onChange :
                    ...
                    {this.props.type == 'file' &&
                        <div className='input-group'>
                            <input
                                ...
                                value={this.state.fileName && this.state.fileName + ' (' + this.state.size + ')'}
                                onClick={this.pickAFile}
                                readOnly />
                            {
                                <div className='input-group-addon' onClick={this.state.fileName ? this.removeFile : this.pickAFile}>
