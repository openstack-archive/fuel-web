...
define(['i18n', 'jquery', 'underscore', 'react', 'utils', 'jsx!component_mixins'],
    ...
    controls.Tooltip = React.createClass({
        ...
        render: function() {
            var content = !this.props.wrap ? React.Children.only(this.props.children) : <div className={this.props.wrapperClassName}>{React.Children.only(this.props.children)}</div>;
            return React.cloneElement(content, {ref: 'tooltip'});
        }
    });
