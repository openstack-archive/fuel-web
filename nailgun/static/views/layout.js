          ...
          <div className='row'>
            ...
            <div className='col-xs-4'>
              <ul className={cx({
                ...
                >
                  <span
                    className={cx({badge: true, visible: unreadNotificationsCount})}
                  >
      ...
      <Popover {...this.props} className='language-popover'>
        <ul className='nav nav-pills nav-stacked'>
          {_.map(i18n.getAvailableLocales(), (locale) => {
            return (
              <li key={locale} className={cx({active: locale == currentLocale})}>
...
var NotificationsPopover = React.createClass({
  ...
  renderNotification(notification) {
    ...
    return (
      <div key={notification.id} className={cx(notificationClasses)}>
