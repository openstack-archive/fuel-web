          ...
          <div className='row'>
            ...
            <div className='col-xs-6'>
              <ul className='nav navbar-nav pull-left'>
                {_.map(this.props.elements, (element) => {
                  return (
                    <li className={utils.classNames({active:
                      this.props.activeElement == element.url.slice(1)})} key={element.label}>
                      <a href={element.url}>
            ...
            <div className='col-xs-4'>
              <ul className={utils.classNames({
                ...
                >
                  <span className={utils.classNames({badge: true, visible:
    ...
    return (
      <Popover {...this.props} className='user-popover'>
        ...
        <div className='clearfix'>
          <button className='btn btn-default btn-sm pull-left'
    ...
    return (
      <div className='footer'>
        {_.contains(version.get('feature_groups'), 'mirantis') && [
          <a key='logo' className='mirantis-logo-white' href='http://www.mirantis.com/'
            target='_blank'></a>,
