...
var NFVComponent = React.createClass({
  ...
  //  var changesConfig = _.clone(node.get('meta'));
  //  if (_.startsWith(name, 'dpdk')) {
  //   changesConfig.nfv_attributes.dpdk_hugepages.value = value;
  //  }
  //  if (_.startsWith(name, 'nova')) {
  //    changesConfig = changesConfig.nfv_attributes.nova_hugepages.value = value;
  //  }
  //  node.set('meta', changesConfig);
  //},
  render() {
