                            ...
                            <div className='col-xs-12 content-elements'>
                                ...
                                :
                                    <div>
                                        ...
                                        <ul>
                                            <li><a href={isMirantisIso ? links.mirantis.catalog : links.experimental.catalog} target='_blank'>{i18n('plugins_page.plugins_catalog')}</a></li>
                                            <li><a href={isMirantisIso ? links.mirantis.documentation : links.experimental.documentation} target='_blank'>{i18n('plugins_page.plugins_documentation')}</a></li>
                                        </ul>
                                    </div>
                                }
                            </div>
