                        ...
                        <div className='row'>
                            <div className='col-xs-12'>
                                ...
                                <div className={utils.classNames({'plugin-links': !!this.props.plugins.length, 'text-center': true})}>
                                    ...
                                    <span> {i18n('plugins_page.more_info')} <a href={links.catalog} target='_blank'>{i18n('plugins_page.plugins_catalog')}</a> {i18n('common.or')} <a href={links.documentation} target='_blank'>{i18n('plugins_page.plugins_documentation')}</a></span>
                                </div>
                            </div>
                        </div>
                    </div>
