...
var SupportPage = React.createClass({
  ...
  render() {
    var elements = [
      ...
      <DiagnosticSnapshot key='DiagnosticSnapshot' tasks={this.props.tasks}
...
var DocumentationLink = React.createClass({
  render() {
    ...
    return (
      ...
      >
        <p>
          <a className='btn btn-default documentation-link'
            href='https://www.mirantis.com/openstack-documentation/' target='_blank'
          >
    ...
    return (
      ...
      >
        <div className='tracking'>
          ...
          <p>
            <button className='btn btn-default' onClick={this.connectToMirantis}
  ...
  render() {
    return (
      ...
      >
        ...
        <p>
          <a className='btn btn-default' href='http://support.mirantis.com/requests/new'
            target='_blank'
          >
