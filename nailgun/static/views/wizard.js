...
function($, _, i18n, React, Backbone, utils, models, componentMixins, dialogs, controls) {
    ...
    var ClusterWizardPanesMixin = {
        ...
        processRequires: function(paneComponents, types) {
            ...
            _.each(paneComponents, (component) => {
                //console.log('processRequires', component);
    ...
    var Network = React.createClass({
        ...
        renderMonolithControls: function(components) {
            ...
            var hasMl2 = _.any(components, (component) => component.isML2Driver());
            if (!hasMl2) {
    ...
    var Storage = React.createClass({
        ...
        render: function() {
            ...
            this.processRestrictions(storages, ['hypervisor', 'network', 'storage']);
            this.processCompatible(this.props.components, storages, ['hypervisor', 'network', 'storage']);
            return (
