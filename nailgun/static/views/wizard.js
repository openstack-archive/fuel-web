...
function($, _, i18n, React, Backbone, utils, models, componentMixins, dialogs, controls) {
    ...
    var ClusterWizardPanesMixin = {
        componentWillMount: function() {
            if (this.props.components) {
                this.components = this.props.components.getComponentsByType(this.constructor.componentType, {sorted: true});
        ...
        processCompatible: function(allComponents, paneComponents, types) {
            ...
            _.each(paneComponents, (component) => {
                ...
                component.set({
                    ...
                    warnings: isCompatible ? 'ok' : warnings.join(', '),
        ...
        render: function() {
            ...
            return (
                <div className='wizard-compute-pane'>
                    {this.renderControls(this.components, false, this.props.onChange)}
                </div>
            );
        }
    });
    ...
    var Network = React.createClass({
        ...
        componentWillMount: function() {
            ...
            this.processRestrictions(networks, ['hypervisor', 'network']);
            this.processCompatible(this.props.components, networks, ['hypervisor', 'network']);
            this.selectActiveComponent(networks);
        ...
        renderMonolithControls: function() {
            ...
            if (!hasMl2) {
                monolith = _.filter(monolith, (component) => component.id != 'network:neutron:core:ml2');
            }
            return this.renderControls(monolith, true, this.onChangeNetwork);
        },
        renderML2Controls: function() {
            var ml2 = _.filter(this.components, (component) => component.isML2Driver());
            return this.renderControls(ml2, false, this.onChangeNetwork);
        },
        render: function() {
            this.processRestrictions(this.components, ['hypervisor', 'network']);
            this.processCompatible(this.props.components, this.components, ['hypervisor', 'network']);
            return (
    ...
    var Storage = React.createClass({
        ...
        render: function() {
            this.processRestrictions(this.components, ['hypervisor', 'network', 'storage']);
            this.processCompatible(this.props.components, this.components, ['hypervisor', 'network', 'storage']);
            return (
    ...
    var AdditionalServices = React.createClass({
        ...
        render: function() {
            this.processRestrictions(this.components, ['hypervisor', 'network', 'storage', 'additional_service']);
            this.processCompatible(this.props.components, this.components, ['hypervisor', 'network', 'storage', 'additional_service']);
            return (
                <div className='wizard-compute-pane'>
                    {this.renderControls(this.components, false, this.props.onChange)}
                </div>
