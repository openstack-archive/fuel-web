...
function($, _, i18n, React, Backbone, utils, models, componentMixins, dialogs, controls) {
    ...
    var NameRelease = React.createClass({
        ...
        render: function() {
            ...
            return (
                <div className='form-horizontal create-cluster-form name-and-release'
                    ...
                    <fieldset>
                        <controls.Input
                            ...
                            onChange={_.bind(_.partial(this.props.onChange, 'NameAndRelease'), this)}
                        />
                        <controls.Input
                            type='select'
                            name='release'
                        ...
                        >
                            {
                                releases.map(function(release) {
                                    ...
                                    return <option key={release.id} value={release.get('id')}>{release.get('name')}</option>
                                })
                            }
                        </controls.Input>
                        {
                            connectivityAlert && <div className='alert alert-warning alert-nailed'>{connectivityAlert}</div>
                        }
    ...
    clusterWizardPanes.push(NameRelease);
    ...
    var Compute = React.createClass({
        ...
        render: function() {
            ...
            return (
                <div className='form-horizontal wizard-compute-pane'
                    onSubmit={function() {return false;}}>
                    <fieldset>
    ...
    clusterWizardPanes.push(Compute);
    ...
    var Network = React.createClass({
        ...
        render: function() {
            ...
            return (
                <div className='form-horizontal wizard-network-pane'
                    onSubmit={function() {return false;}}>
                    <fieldset>
                        {
                            false &&
    ...
    clusterWizardPanes.push(Network);
    ...
    var Storage = React.createClass({
        ...
        render: function() {
            ...
            return (
                <div className='form-horizontal' oonSubmit={function() {return false;}}>
                    <fieldset>
    ...
    clusterWizardPanes.push(Storage);
    ...
    var AdditionalServices = React.createClass({
        ...
        render: function() {
            ...
            return (
                <div className='form-horizontal wizard-additional-pane'
                    onSubmit={function() {return false;}}>
                    <fieldset>
                        <div className='form-group'>
                            {this.renderWarnings(warnings)}
    ...
    clusterWizardPanes.push(AdditionalServices);
    ...
    clusterWizardPanes.push(Finish);
                ...
                <div className='wizard-body'>
                    <div className='wizard-steps-box'>
                                    ...
                                    this.state.panes.map(function(pane, index) {
                                        ...
                                        return (
                                            <li key={pane.title} role='wizard-step'
                                                className={classes}>
                                                <a onClick={_.bind(_.partial(this.goToPane, index), this)}>{pane.title}</a>
                                            </li>
                                        );
                                    }, this)
                                }
                        ...
                        <div className='pane-content col-xs-9 forms-box access'>
                            {
                                React.createElement(this.getActivePane(),
                                    {
                                        ref: 'pane',
