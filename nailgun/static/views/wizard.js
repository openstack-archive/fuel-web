...
function($, _, i18n, React, Backbone, utils, models, componentMixins, dialogs, controls) {
    ...
    var Network = React.createClass({
        ...
        render: function() {
            ...
            this.processCompatible(this.props.allComponents, this.components, ['hypervisor', 'network']);
    ...
    var Storage = React.createClass({
        ...
        renderSection: function(components, type) {
            ...
            this.processRestrictions(sectionComponents, ['hypervisor', 'network', 'storage'], (isRadio ? sectionComponents : []));
            this.processCompatible(this.props.allComponents, sectionComponents, ['hypervisor', 'network', 'storage']);
            return (
        ...
        render: function() {
            ...
            this.processCompatible(this.props.allComponents, this.components, ['hypervisor', 'network', 'storage']);
            return (
    ...
    var AdditionalServices = React.createClass({
        ...
        render: function() {
            ...
            this.processCompatible(this.props.allComponents, this.components, ['hypervisor', 'network', 'storage', 'additional_service']);
            return (
                <div className='wizard-compute-pane'>
                    <ComponentCheckboxGroup
