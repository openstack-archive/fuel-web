...
function($, _, i18n, React, Backbone, utils, models, componentMixins, dialogs, controls) {
    ...
    var ClusterWizardPanesMixin = {
        ...
        processCompatible: function(allComponents, paneComponents, types) {
            ...
            _.each(paneComponents, (component) => {
                ...
                component.set({isCompatible: isCompatible});
            });
        },
            ...
            return (
                <div>
                {
                    _.map(components, (component) => {
                        var isDisabled = component.get('disabled'),
                            isCompatible = component.get('isCompatible');
                        return (
                            <controls.Input
                                key={component.id}
                                ...
                                wrapperClassName={!isDisabled && isCompatible ? 'compatible' : null}
                                onChange={onChange}
                            />
                        );
                    })
        ...
        render: function() {
            ...
            return (
                <div className='wizard-network-pane'>
                    {this.renderControls(networks, true, this.onChange)}
                </div>
            );
        }
    });
        ...
        render: function() {
            ...
            return (
                <div className='wizard-compute-pane'>
                    ...
                    {this.renderControls(storages, true, this.onChange)}
                </div>
            );
        }
    });
    ...
    var CreateClusterWizard = React.createClass({
        ...
        onChange: function(name, value) {
            ...
            this.updateState({paneHasErrors: false, maxAvailablePaneIndex: maxAvailablePaneIndex});
        },
