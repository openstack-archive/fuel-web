...
define(
    ...
    function($, _, i18n, React, Backbone, utils, models, componentMixins, dialogs, controls) {
        ...
        var ComponentsModel = Backbone.Model.extend({
            url: function() {
                return '/api/v1/releases/' + this.id + '/components';
            }
        });
        ...
        var Compute = React.createClass({
            ...
            render: function() {
                ...
                var hypervisors = this.props.components.get('hypervisor');
                return (
        ...
        var Network = React.createClass({
            ...
            processNetworks: function(networks) {
                ...
                _.each(networks, (network) => {
                    if (network.name.match(/^network\:neutron\:core\:ml2/)) {
            ...
            render: function() {
                ...
                var networks = this.processNetworks(this.props.components.get('network'));
                return (
        ...
        var Storage = React.createClass({
            ...
            render: function() {
                ...
                var storages = this.props.components.get('storage');
                return (
                    <div className='wizard-compute-pane'>
                        {
        ...
        var AdditionalServices = React.createClass({
            ...
            render: function() {
                ...
                var additionalServices = this.props.components.get('additional_service');
                return (
                    <div className='wizard-compute-pane'>
                        {
        ...
        var CreateClusterWizard = React.createClass({
            ...
            selectRelease: function(releaseId) {
                ...
                // components
                this.components = new ComponentsModel({id: releaseId});
                this.components.fetch().done((res) => {
                    var componentsByType = {hypervisor: [], network: [], storage: [], additional_service: []};
                    //console.log('res =', res);
                    _.each(res.components, (component) => {
                        ...
                        componentsByType[type].push({
                            ...
                            description: i18n(component.description)
                        });
                    });
                    this.components.set(componentsByType);
                    //console.log('components are', this.components);
                });
            },
