        ...
        var CreateClusterWizard = React.createClass({
            ...
            getInitialState: function() {
                return {
                    ...
                    hypervisors: [
                        {name: 'Oppa Hypervisor 1', desc: 'Oppa Hypervisor 1 Description'},
                        {name: 'Oppa Hypervisor 2', desc: 'Oppa Hypervisor 2 Description'},
                        {name: 'Oppa Hypervisor 3', desc: 'Oppa Hypervisor 3 Description'}
                    ],
                    networks: [
                        {
                            name: 'Neutron with VLAN segmentation',
                            desc: 'The networking equipment must be configured for VLAN segmentation. This option supports up to 4095 networks'
                        },
                        {name: 'Neutron plugin 2', desc: 'Neutron Plugin 2 Description'},
                        {
                            name: 'Oppa Neutron ML2', desc: 'Oppa Neutron ML2 Description',
                            drivers: [
                                {name: 'Oppa ML2 Driver 1', desc: 'Oppa ML2 Description'},
                                {name: 'Oppa ML2 Driver 2', desc: 'Oppa ML2 Description'}
                            ]
                        }
                    ],
                    addons: [
            ...
            getActivePane: function() {
                var res = this.getEnabledPanes().filter(function(pane, i) {
                                    ...
                                    <div className="wizard-steps-box">
                                        <div className="wizard-steps-nav col-xs-3">
                                            <ul className="wizard-step-nav-item nav nav-pills nav-stacked">
                                                {
                                                    this.getEnabledPanes().map(function(pane, i) {
