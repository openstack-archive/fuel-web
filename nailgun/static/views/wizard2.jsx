    ...
    var CreateClusterWizard = React.createClass({
        ...
        onKeyDown: function(e) {
            if (e.which == 13) {
                ...
                //    console.log('finish');
                //}
                // TODO - refactor code using commented above
        ...
        renderBody: function() {
            ...
            //    nextStyle = this.state.nextVisible ? {display: 'inline-block'} : {display: 'none'},
                            ...
                            <ul className='wizard-step-nav-item nav nav-pills nav-stacked'>
                                {
                                    this.state.panes.map(function(pane, i) {
                                        var classes = utils.classNames('wizard-step', {
                                            ...
                                            available: i <= this.state.maxAvailablePaneIndex,
