...
define(
    ...
    function(require, $, _, i18n, React, utils, models, componentMixins /*, dialogs */) {
        ...
        var ClusterWizardPanesMixin = {
            processRestrictions: function(paneName, restrictions) {
                return [paneName, restrictions];
                //console.log('processRestrictions', paneName, restrictions);
            },
            renderControls: function(paneName, metadata, data, restrictions) {
                this.processRestrictions(paneName, restrictions);
        ...
        // TODO wipe the pane out, we have HA only
        /*
        var Mode = React.createClass({
            mixins: [ClusterWizardPanesMixin],
            render: function() {
                return (
                    <form className='form-horizontal wizard-mode-pane'
                          onSubmit={function() {return false;}}>
                        <fieldset>
                            <div className='form-group'>
                                <span>Not yet</span>
        ...
        */
        //clusterWizardPanes.push({view: Mode,, name: 'Mode' title: i18n('dialog.create_cluster_wizard.mode.title'), hidden: true});
                        ...
                        <fieldset>
                            <div className='form-group'>
                                {this.renderControls('Compute', this.props.wizard.config.Compute,
                                    this.props.wizard.get('Compute'), this.props.wizard.restrictions.Compute)}
                            </div>
                        </fieldset>
                    </form>
                );
                        ...
                        <fieldset>
                            ...
                            <div className='form-group'>
                                {this.renderControls('Network', this.props.wizard.config.Network,
                                    this.props.wizard.get('Network'), this.props.wizard.restrictions.Network)}
                            </div>
                        </fieldset>
                    </form>
                );
                        ...
                        <fieldset>
                            ...
                            <div className='form-group'>
                                {this.renderControls('Storage', this.props.wizard.config.Storage,
                                    this.props.wizard.get('Storage'), this.props.wizard.restrictions.Storage)}
                            </div>
                        </fieldset>
                    </form>
                );
                        ...
                        <fieldset>
                            <div className='form-group'>
                                {this.renderControls('AdditionalServices', this.props.wizard.config.AdditionalServices,
                                    this.props.wizard.get('AdditionalServices'), this.props.wizard.restrictions.AdditionalServices)}
                            </div>
                        </fieldset>
                    </form>
                );
        ...
        var CreateClusterWizard = React.createClass({
            ...
            handleTrackedAttributeChange: function() {
                var maxIndex = this.state.maxAvailablePaneIndex;
            ...
            onChange: function(paneName, field, event) {
                //console.log('onChange', paneName, field, event);
                ...
                //var maxAvailablePaneIndex = _.findIndex(clusterWizardPanes, function(pane) { return pane.name == paneName; });
