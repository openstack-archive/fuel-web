...
define(
    ...
    function(require, $, _, i18n, React, Backbone, utils, models, componentMixins /*, dialogs */) {
        'use strict';
        ...
        var CreateCluster = React.createClass({
            ...
            setFocus: function() {
                if (this.getActivePane().name == 'Finish') {
                    this.refs.finish.getDOMNode().focus();
                } else {
                    this.refs.pane.setFocus();
                }
            },
            ...
            render: function() {
                var activeIndex = this.props.activePaneIndex,
                    ...
                    releaseId = this.props.wizard && this.props.wizard.get('NameAndRelease.release.id');
                return (
                    <div className='modal fade create-cluster-modal' onKeyDown={this.props.onKeyDown}>
                            ...
                            <div className='modal-content'>
                                ...
                                <div className='modal-footer wizard-footer'>
                                    ...
                                    <button ref='finish' className='btn btn-default btn-success finish-btn'
                                            style={createStyle} onClick={this.props.onSave}>
        ...
        var NameRelease = React.createClass({
            ...
            componentDidMount: function() {
                //_.delay(_.once(this.setFocus), 300);
            },
            render: function() {
                        ...
                        <fieldset>
                            <div className={utils.classNames('form-group', {'has-error': !!nameAndRelease.name_error})}>
                                ...
                                <div className='controls col-xs-9'>
                                    <input type='text' className='form-control' name='name' maxLength='50'
                                        ...
                                        onChange={_.bind(function(val) {this.props.onChange('NameAndRelease', 'name', val)}, this)}
                                    />
                            ...
                            <div className='form-group'>
                                ...
                                <div className='controls col-xs-9 has-warning'>
                                    <select className='form-control' name='release' value={nameAndRelease.release && nameAndRelease.release.id}
                                            onChange={_.bind(function(val) {this.props.onChange('NameAndRelease', 'release', val)}, this)}>
                                        {
                                            releases.map(function(release) {
                                                if (false && !release.get('is_deployable')) {
                                                    return null;
                                                }
        ...
        var CreateClusterWizard = React.createClass({
            ...
            componentDidMount: function() {
                ...
                $el.on('shown.bs.modal', this.handleShown);
                $el.modal(_.defaults(
                    {keyboard: false},
            ...
            componentDidUpdate: function() {
                if (this.getCurrentPaneName() == 'Finish') {
            ...
            handleShown: function() {
                this.refs.createCluster.setFocus();
            },
            ...
            getCurrentPaneName: function() {
                var panes = this.getEnabledPanes();
                return panes[this.state.activePaneIndex].name;
            },
            prevPane: function() {
                this.processBinds('wizard', this.getCurrentPaneName());
            ...
            onKeyDown: function(e) {
                if (e.which == 13) {
                    ...
                    var finishButton = $(this.getDOMNode()).find('.finish-btn').get(0);
