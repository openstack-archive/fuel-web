            ...
            render: function() {
                ...
                return (
                    <form className="form-horizontal create-cluster-form"
                          ...
                          autoComplete="off">
                        <fieldset>
                            <div className={utils.classNames("form-group", {'has-error':nameAndRelease.name_error?true:false})}>
                                <label
            ...
            componentDidMount: function() {
                ...
                this.setState(_.pick(this, 'wizard', 'cluster', 'settings', 'releases'), function() {
                    this.releases.fetch().done(_.bind(function() {
                        ...
                        this.wizard.set('NameAndRelease.release', defaultRelease);
                    }, this));
                });
            ...
            onChange(pane, field, event) {
                ...
                if(pane="NameAndRelease") {
                    if(field=='name') {
                        ...
                        this.wizard.set('NameAndRelease.id', event.target.value);
                    }
                }
