                ...
                return (
                    <form className='form-horizontal wizard-network-pane'
                        ...
                        <fieldset>
                            ...
                            <div className='form-group'>
                                {this.renderControls(this.props.wizard.config.Network, this.props.wizard.get('Network'))}
                            </div>
                        </fieldset>
                    </form>
                );
                ...
                return (
                    <form className='form-horizontal' oonSubmit={function() {return false;}}>
                        <fieldset>
                            ...
                            <div className='form-group'>
                                {this.renderControls(this.props.wizard.config.Storage, this.props.wizard.get('Storage'))}
                            </div>
                        </fieldset>
                    </form>
                );
            ...
            render: function() {
                return (
                    <form className='form-horizontal wizard-additional-pane'
                        ...
                        <fieldset>
                            <div className='form-group'>
                                {this.renderControls(this.props.wizard.config.AdditionalServices, this.props.wizard.get('AdditionalServices'))}
                            </div>
                        </fieldset>
                    </form>
                );
