...
casper.then(function() {
    ...
    this.test.assertEvalEquals(function() {return $('.networks-table legend').length}, 4, 'All networks are presented');
...
casper.then(function() {
    ...
    this.each(fixtures, function(self, fixture) {
        self.then(function() {
            this.fill('.fixed', {'fixed_networks_amount': fixture.amount});
            if (fixture.vlanStart != '') {
                this.fill('.fixed', {'fixed_networks_vlan_start': fixture.vlanStart});
            }
            this.evaluate(function() {
...
casper.then(function() {
    ...
    this.click('input[name=net-manager]:not(:checked)');
    this.fill('.fixed', {'fixed_networks_amount': '10'});
    this.evaluate(function() {
        $('input[name=fixed_networks_amount]').keyup();
    });
    this.then(function() {
