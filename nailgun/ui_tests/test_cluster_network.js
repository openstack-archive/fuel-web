...
casper.then(function() {
    ...
    var initialValue = this.evaluate(function(initialValue) {
            return __utils__.getFieldValue('cidr', {formSelector: '.management'});
        });
...
casper.then(function() {
    ...
    var initialAmountValue = this.evaluate(function(initialValue) {
        return __utils__.getFieldValue('amount', {formSelector: '.fixed'});
    });
...
casper.then(function() {
    ...
    var initialVlanIDValue = this.evaluate(function(initialValue) {
        return __utils__.getFieldValue('vlan_start', {formSelector: '.management'});
    });
