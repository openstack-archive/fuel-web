...
casper.then(function() {
    ...
    this.test.assertDoesntExist('.btn-configure-disks', 'Button Configure Disks is invisible cause no nodes checked');
    this.test.assertDoesntExist('.btn-configure-interfaces', 'Button Configure Interfaces is invisible cause no nodes checked');
...
casper.then(function() {
    ...
    this.then(function() {
        ...
        this.test.assertSelectorAppears('.btn-add-nodes', 'Return to nodes tab');
    });
    this.then(function() {
