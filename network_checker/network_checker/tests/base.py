...
class BaseMcollectActionTest(unittest.TestCase):
    ...
    def setUp(self):
        self.nailgun_uid_file = '/etc/nailgun_uid'
        self.node_uid = '101'
        with open(self.nailgun_uid_file, 'w') as f:
            f.write(self.node_uid)
    ...
    def tearDown(self):
        ...
        if os.path.exists(self.nailgun_uid_file):
            os.unlink(self.nailgun_uid_file)
