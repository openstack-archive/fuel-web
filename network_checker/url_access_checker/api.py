...
def check_urls(urls, proxies=None, timeout=300):
    ...
    timeout -- the max time to wait for a response, default 300 seconds
    """
...
def _get_response_tuple(url, proxies=None, timeout=300):
