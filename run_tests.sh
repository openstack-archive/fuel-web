...
function run_flake8 {
  ...
  flake_status=0
  flake8 --exclude=__init__.py,docs,fuelmenu --ignore=H302,H802 --show-source --show-pep8 --count . || flake_status=1
  pep8 --exclude=welcome.py docs fuelmenu || flake_status=1
