...
class TestFile(base.BaseTestCase):
    ...
    @mock.patch('shotgun.driver.utils.remove_matched_files')
    @mock.patch('shotgun.driver.Driver.get')
    ...
    @mock.patch('shotgun.driver.utils.remove_sub_dirs')
    @mock.patch('shotgun.driver.Driver.get')
    def test_dir_exclude_path_called(self, mget, msubdirrm):
        data = {
            "type": "dir",
            "path": "/remote_dir/",
        ...
        mget.assert_called_with(data["path"], target_path)
        msubdirrm.assert_called_with(dir_driver.full_dst_path,
                                     data['exclude_subdirs'])
